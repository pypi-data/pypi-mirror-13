...
class AgentServer extends Server
{
    ...
    public function OnWhatsAppConnectError ($phoneNumber, $socket, $error)
    {
        ...
        $this->_debug_print("Fail to connect to remote server");
        $this->_debug_print($socket);
    ...
    function BindEvents ()
    {
        ...
        $this->wa->eventManager()->bind("onConnect", array($this, "OnWhatsAppConnectSuccess"));
        ...
        $this->wa->eventManager()->bind("onGroupMessageComposing", array($this, "OnGroupMessageComposing"));
        $this->wa->eventManager()->bind("onGroupMessagePaused", array($this, "OnGroupMessagePaused"));
