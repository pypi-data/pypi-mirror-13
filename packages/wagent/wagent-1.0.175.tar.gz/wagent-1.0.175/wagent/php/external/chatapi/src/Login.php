...
class Login
{
  ...
  public function doLogin()
  {
      ...
      $this->parent->setMessageId(strtoupper(substr(bin2hex(mcrypt_create_iv(64, MCRYPT_DEV_URANDOM)), 0, 22))); // 11 char hex

      if (extension_loaded('curve25519') && extension_loaded('protobuf')) {
        if (file_exists( getcwd() . DIRECTORY_SEPARATOR . Constants::DATA_FOLDER . DIRECTORY_SEPARATOR . "axolotl-" . $this->phoneNumber . ".db"))
        {
