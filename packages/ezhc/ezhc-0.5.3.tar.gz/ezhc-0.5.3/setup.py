...
setup(
  ...
  download_url = 'https://github.com/oscar6echo/ezhc/tarball/0.5.3', # tag number at the end
  ...
  package_data={
    ...
    'script':
        ['script/financial_time_series_table_options.js',
         'script/financial_time_series_table.js',
         'script/financial_time_series_table.js',
         'script/formatter_other.js',
         'script/formatter_percent.js',
         'script/json_parse.js',
         'script/tooltip_positioner.js'
        ],
    'samples':
