...
/* #########################################################################
 * [2015-12-22 11:30:35.083000] THIS FILE IS AUTOGENERATED - DO NOT EDIT!
 * ######################################################################### */
...
typedef struct __attribute__((packed)) {
} LightOverrideRequest;

typedef struct __attribute__((packed)) {
  bool result;
} LightOverrideResponse;
...
typedef struct __attribute__((packed)) {
  uint32_t new_value;
} OnConfigLightPinChangedRequest;

typedef struct __attribute__((packed)) {
  bool result;
} OnConfigLightPinChangedResponse;
...
typedef struct __attribute__((packed)) {
} _LightEnableResponse;

typedef struct __attribute__((packed)) {
} _LightDisableRequest;

typedef struct __attribute__((packed)) {
} _LightDisableResponse;
...
static const int CMD_SERVO_DETACH = 0x700;
static const int CMD_SERVO_ATTACH = 0x701;
static const int CMD_MAGNET_ENGAGED = 0x702;
static const int CMD_LIGHT_OVERRIDE = 0x703;
static const int CMD_LIGHT_ENABLED = 0x704;
static const int CMD_LOOP = 0x705;
static const int CMD_ON_CONFIG_LIGHT_PIN_CHANGED = 0x706;
static const int CMD_ON_STATE_MAGNET_ENGAGED_CHANGED = 0x707;
static const int CMD_ON_STATE_LIGHT_ENABLED_CHANGED = 0x708;
static const int CMD__MAGNET_ENGAGE = 0x709;
static const int CMD__MAGNET_DISENGAGE = 0x70a;
static const int CMD__LIGHT_ENABLE = 0x70b;
static const int CMD__LIGHT_DISABLE = 0x70c;
