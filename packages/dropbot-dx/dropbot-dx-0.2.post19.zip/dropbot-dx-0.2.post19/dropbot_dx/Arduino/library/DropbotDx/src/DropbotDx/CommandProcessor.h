...
/* #########################################################################
 * [2015-12-22 11:30:32.730000] THIS FILE IS AUTOGENERATED - DO NOT EDIT!
 * ######################################################################### */
...
public:
  ...
  UInt8Array process_command(UInt8Array request_arr, UInt8Array buffer) {
    ...
    switch (command) {
        ...
        case CMD_SERVO_ATTACH:
          {
            ...
            ServoAttachRequest &request = *(reinterpret_cast
                                          <ServoAttachRequest *>
                                          (&request_arr.data[2]));
    
    
            obj_.servo_attach(request.servo_pin);
        ...
        case CMD_LIGHT_OVERRIDE:
          {
            /* Cast buffer as request. */
    
    
            LightOverrideResponse response;
            ...
            /* Copy result to output buffer. */
            /* Cast start of buffer as reference of result type and assign result. */
            LightOverrideResponse &output = *(reinterpret_cast
        ...
        case CMD_LIGHT_ENABLED:
          {
            /* Cast buffer as request. */
    
    
            LightEnabledResponse response;
            ...
            /* Copy result to output buffer. */
            /* Cast start of buffer as reference of result type and assign result. */
            LightEnabledResponse &output = *(reinterpret_cast
        ...
        case CMD_ON_CONFIG_LIGHT_PIN_CHANGED:
          {
            /* Cast buffer as request. */
    
            OnConfigLightPinChangedRequest &request = *(reinterpret_cast
                                          <OnConfigLightPinChangedRequest *>
                                          (&request_arr.data[2]));
    
    
            OnConfigLightPinChangedResponse response;

            response.result =
            obj_.on_config_light_pin_changed(request.new_value);
    
            /* Copy result to output buffer. */
            /* Cast start of buffer as reference of result type and assign result. */
            OnConfigLightPinChangedResponse &output = *(reinterpret_cast
