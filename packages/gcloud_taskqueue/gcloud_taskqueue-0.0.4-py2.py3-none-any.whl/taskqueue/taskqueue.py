...
class Taskqueue(object):
    ...
    def lease(self, lease_time, num_tasks, group_by_tag=False, tag=None, client=None):
        ...
        query_params = {"leaseSecs": lease_time, "numTasks": num_tasks, "groupByTag": group_by_tag, "tags": tag}
    ...
    def insert_task(self, description, lease_time, tag=None, client=None):
        ...
        :type lease_time: int
        :param lease_time: New lease time, in seconds.
