...
class WebDriverFinalizer:
    ...
    def finalise_saucelabs_driver(driver, test_failed, test_context):
        ...
        try:
            ...
            test_context.logger.info(
                "SauceLabs report: <a href=\"{}\" target=\"_blank\">Saucelabs Report</a>".format(report_url))
        ...
        if driver is not None:
            if test_failed:
                ...
                try:
                    ...
                    logger.info(
                            "Screenshot can be found here: <a href=\"{}\" target=\"_blank\">Screenshot File</a>".format(
                                screenshot_dir))
                except Exception as e:
    ...
    def finalise_skygrid_driver_failure(driver, test_context):
        ...
        test_context.logger.info(
            "This test report: <a href=\"{}\" target=\"_blank\">Test Report</a>".format(test_report))
        test_context.logger.info(
