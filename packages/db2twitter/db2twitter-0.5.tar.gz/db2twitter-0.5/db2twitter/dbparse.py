            ...
            for table in cfgvalues['rows']:
                ...
                if tableobj:
                    for tweetindb in tableobj:
                        ...
                        self.tweets.append([getattr(tweetindb, i) for i in cfgvalues['rows'][table]])
            ...
            for table in cfgvalues['rows']:
                ...
                if tableobj:
                    for tweetdb in tableobj:
                        # split the different fields we need
                        self.tweets.append([getattr(tweetdb, i) for i in cfgvalues['rows'][table]])

            # avoid to add an empty list
            #if self.allfields:
            #    self.tweets.append(self.allfields)
            #    self.allfields = []
