...
def decode_named(input: io.BufferedIOBase, errors: str='strict'):
    ...
    .. note::
        ...
        to use non-blocking I/O here, consider using
        :func:`asyncio.run_in_executor` to run the blocking I/O on a separate
        thread or in a separate process.
...
class TagMixin(metaclass=abc.ABCMeta):
    ...
    def encode_named(self, name: str, output: io.BufferedIOBase,
        ...
        .. note::
           ...
           non-blocking I/O here, consider using
           :func:`asyncio.run_in_executor` to run the blocking I/O on a
           separate thread or in a separate process.
