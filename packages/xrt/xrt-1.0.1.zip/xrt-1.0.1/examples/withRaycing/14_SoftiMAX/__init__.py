...
The beam improvement can also be viewed via the coherence properties by three
...
eigen-mode method is a simple definition of the coherent fraction as the
eigenvalue of the zeroth mode; this eigenvalue appears to be invariant around
the focal point, see below.
...
.. |st_hS80m3| image:: _images/stxm-Modes-mutual_intensity-2D-2-hybr-non0e-0enSpread-monoE.swf
   :width: 400
   :height: 400
.. |st_hS80m3Z| image:: _images/zoomIcon.png
   :width: 20
   :target: _images/stxm-Modes-mutual_intensity-2D-2-hybr-non0e-0enSpread-monoE.swf
.. |st_hS20m3| image:: _images/stxm-Modes-mutual_intensity-2D-2-hybr-non0e-0enSpread-monoE-025H.swf
   :width: 400
   :height: 400
.. |st_hS20m3Z| image:: _images/zoomIcon.png
   :width: 20
   :target: _images/stxm-Modes-mutual_intensity-2D-2-hybr-non0e-0enSpread-monoE-025H.swf
...
The curvature of the calculated wave fronts vary across the focus position. The
wave fronts become more flat as one approaches the focus, see the figure below.
This is in contrast to *ray* propagation, where the angular ray distribution is
invariant at any position between two optical elements.
