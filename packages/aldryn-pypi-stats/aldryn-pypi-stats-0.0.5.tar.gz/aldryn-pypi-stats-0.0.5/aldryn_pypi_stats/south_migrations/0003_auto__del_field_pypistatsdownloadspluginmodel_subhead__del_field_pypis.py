...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PyPIStatsDownloadsPluginModel.subhead'
        db.delete_column(u'aldryn_pypi_stats_pypistatsdownloadspluginmodel', 'subhead')

        # Deleting field 'PyPIStatsDownloadsPluginModel.subhead_link'
        db.delete_column(u'aldryn_pypi_stats_pypistatsdownloadspluginmodel', 'subhead_link')


    def backwards(self, orm):
        # Adding field 'PyPIStatsDownloadsPluginModel.subhead'
        db.add_column(u'aldryn_pypi_stats_pypistatsdownloadspluginmodel', 'subhead',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'PyPIStatsDownloadsPluginModel.subhead_link'
        db.add_column(u'aldryn_pypi_stats_pypistatsdownloadspluginmodel', 'subhead_link',
