...
from pex import BaseAPI, PEXCardAPI, SANDBOX_BASE_URL, JsonEncoder
...
class CardValidateTest(CardTest):
    def test_success(self):
        r_data = PEXCardAPI.validate(self.valid_data)
        self.assertEqual(self.valid_data, r_data)

    def test_fail(self):
        with self.assertRaises(ValueError):
            PEXCardAPI.validate(self.invalid_data)
