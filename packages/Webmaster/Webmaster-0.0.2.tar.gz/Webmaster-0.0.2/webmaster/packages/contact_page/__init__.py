...
from webmaster import (View, flash, abort, register_package)
from webmaster.decorators import menu, template, route
from webmaster.ext import (mailer, recaptcha)
...
def contact_page(view, **kwargs):
    ...
    template_dir = kwargs.pop("template_dir", "Webmaster/Package/ContactPage")
