...
class WMSQLAlchemyError(object):

    error = 500
    description = "SQLAlchemy Error"

    def __init2__(self, *args, **kwargs):
        super(WMSQLAlchemyError, self).__init__(*args, **kwargs)
        pass
    ...
    def wrap(cls, exception, name=None):
        ...
        """
        httpexc = exceptions.HTTPException("SQLAlchemy Error")
        httpexc.code = 500
        return httpexc
        ...
        def register(cls, app, **kwargs):
            ...
            def register_error(error):
                ...
                if isinstance(error, SQLAlchemyError):
                    ...
                    setattr(error, "description", "SQLAlchemyError")
                    error = WMSQLAlchemyError.wrap(error)
