...
from flask import (Flask, render_template, flash, session, url_for, request,
...
__all__ = [
           ...
           # For convenience when importing from webmaster, but can use
           # the flask one
           "flash",
           "session",
           "url_for",
...
# Webmaster: Alias to View for reading and branding purposes
Webmaster = View
