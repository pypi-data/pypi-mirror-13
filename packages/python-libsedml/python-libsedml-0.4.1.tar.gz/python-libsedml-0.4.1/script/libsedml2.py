...
def writeMathMLToStdString(node):
    """writeMathMLToStdString(ASTNode node) -> string"""
    return _libsedml.writeMathMLToStdString(node)
...
class SBase(_object):
    ...
    def getElementBySId(self, id):
        ...
        return _libsedml.SBase_getElementBySId(self, id)


    def getElementByMetaId(self, metaid):
        """getElementByMetaId(SBase self, string metaid) -> SBase"""
        return _libsedml.SBase_getElementByMetaId(self, metaid)
...
class Model(SBase):
    ...
    def convertL1ToL3(self):
        ...
        return _libsedml.Model_convertL1ToL3(self)
    ...
    def convertL2ToL3(self, strict=False):
        ...
        """
        return _libsedml.Model_convertL2ToL3(self, strict)
...
class XMLOutputStream(_object):
    ...
    def writeComment(self, programName, programVersion):
        ...
        return _libsedml.XMLOutputStream_writeComment(self, programName, programVersion)
