...
class Inventory(object):
    ...
    def __init__(
        ...
        # Loop groups and build map of hostname -> groups
        hostnames_to_groups = {}
        ...
        for hostname in hostnames:
            ...
            host = Host(self, hostname, hostnames_to_groups.get(hostname))
            hosts[hostname] = host

            # Push into any groups
            for groupname in hostnames_to_groups.get(hostname, []):
    ...
    def __getitem__(self, key):
        '''
        Get individual hosts from the inventory by hostname.
        '''
