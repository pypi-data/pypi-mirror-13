...
from ..database.ufo_base import UfoBase, BaseField, custom_decoder, custom_encoder
...
class Archivable(UfoBase):
    ...
    def get_dated(self, attr, date, strict=False):
        ...
        try:
            return date, field.from_json(json.loads(value, cls=custom_decoder))
        except TypeError:
    ...
    def set_dated(self, attr, date, value, overwrite=False):
        ...
        # --- serialize value
        value = json.dumps(field.to_json(value), cls=custom_encoder)
