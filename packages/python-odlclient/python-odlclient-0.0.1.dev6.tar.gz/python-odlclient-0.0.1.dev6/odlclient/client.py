...
class FlowManager(ResourceManager):
    ...
    def create(self, node_id, table_id, flow_id, priority=None, match=None, instructions=None):
        ...
        data = '<?xml version="1.0" encoding="utf-8"?><flow xmlns="urn:opendaylight:flow:inventory">' + xmltodict.unparse(body, full_document=False) + '</flow>'
        return super(FlowManager, self).create(flow_id, data, node_id, table_id)
