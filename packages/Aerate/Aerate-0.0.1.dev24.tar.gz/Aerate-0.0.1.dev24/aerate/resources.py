...
class Resource(object):
    ...
    def __init__(
        ...
        # setattr(self, 'validate_on_post', _default_POST_validator)
        # setattr(self, 'validate_on_put', _default_POST_validator)
        # setattr(self, 'validate_on_patch', _default_PATCH_validator)
