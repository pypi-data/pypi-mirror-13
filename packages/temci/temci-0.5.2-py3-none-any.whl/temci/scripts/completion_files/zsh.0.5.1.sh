...
_temci(){
	...
	--stats_properties"[Properties to use for reporting and null hypothesis tests]: :(ov-time cache-misses cycles task-clock instructions branch-misses cache-references all)"
	--stats_properties"[Properties to use for reporting and null hypothesis tests]: :(ov-time cache-misses cycles task-clock instructions branch-misses cache-references all)"
	--stats_properties"[Properties to use for reporting and null hypothesis tests]: :(ov-time cache-misses cycles task-clock instructions branch-misses cache-references all)"
	--stats_properties"[Properties to use for reporting and null hypothesis tests]: :(ov-time cache-misses cycles task-clock instructions branch-misses cache-references all)"
	--stats_properties"[Properties to use for reporting and null hypothesis tests]: :(ov-time cache-misses cycles task-clock instructions branch-misses cache-references all)"
	...
	--properties"[Properties to use for reporting and null hypothesis tests]: :(ov-time cache-misses cycles task-clock instructions branch-misses cache-references all)"
	--properties"[Properties to use for reporting and null hypothesis tests]: :(ov-time cache-misses cycles task-clock instructions branch-misses cache-references all)"
	--properties"[Properties to use for reporting and null hypothesis tests]: :(ov-time cache-misses cycles task-clock instructions branch-misses cache-references all)"
	--properties"[Properties to use for reporting and null hypothesis tests]: :(ov-time cache-misses cycles task-clock instructions branch-misses cache-references all)"
	--properties"[Properties to use for reporting and null hypothesis tests]: :(ov-time cache-misses cycles task-clock instructions branch-misses cache-references all)"
