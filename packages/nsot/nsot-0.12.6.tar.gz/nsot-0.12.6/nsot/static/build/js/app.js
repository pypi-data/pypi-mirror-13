...
(function() {
    ...
    app.controller("SiteController",
            ["$scope", "$route", "$location", "$q", "$routeParams", "Site", "User", "Device", "Network", "Change", function($scope, $route, $location, $q, $routeParams, Site, User,
