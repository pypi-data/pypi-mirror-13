...
argparser.add_argument('--ignore-own-messages', default=False, action='store_true',
    help='Do not emit messages to the sender')
...
def main():
    ...
    settings = {
        ...
        "debug": args.debug,
        "ignore_own_messages": args.ignore_own_messages
    }
    if args.debug:
