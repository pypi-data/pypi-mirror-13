...
try:
    ...
    import languages
    CodeReader.extra_subclasses.add(languages.JavaReader)
    CodeReader.extra_subclasses.add(languages.JavaScriptReader)
    CodeReader.extra_subclasses.add(languages.PythonReader)
    CodeReader.extra_subclasses.add(languages.ObjCReader)
    CodeReader.extra_subclasses.add(languages.TTCNReader)
    CodeReader.extra_subclasses.add(languages.SwiftReader)
except ImportError:
    pass
