...
proc vunit_load {{vsim_extra_args ""}} {
    set vsim_failed [catch {
        eval vsim ${vsim_extra_args} {-modelsimini d:/Programming/github/vunit/vunit/vhdl/check/vunit_out/modelsim/modelsim.ini -wlf {d:/Programming/github/vunit/vunit/vhdl/check/vunit_out/tests/lib.tb_basic_check_functionality/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_basic_check_functionality/output_path=d:/Programming/github/vunit/vunit/vhdl/check/vunit_out/tests/lib.tb_basic_check_functionality/ -g/tb_basic_check_functionality/runner_cfg={"enabled_test_cases : Verify default checker basic functionality,,Verify default check_passed and check_failed,,Verify default checker initialization,,Verify custom checker basic functionality,,Verify check_passed and check_failed with custom checker,,Verify custom checker initialization,,Verify checker_stat_t functions and operators,,Verify export of configuration,active python runner : true,output path : d::/Programming/github/vunit/vunit/vhdl/check/vunit_out/tests/lib.tb_basic_check_functionality/"} lib.tb_basic_check_functionality(test_fixture)   -L lib -L vunit_lib}
    }]
    if {${vsim_failed}} {
       echo Command 'vsim ${vsim_extra_args} -modelsimini d:/Programming/github/vunit/vunit/vhdl/check/vunit_out/modelsim/modelsim.ini -wlf {d:/Programming/github/vunit/vunit/vhdl/check/vunit_out/tests/lib.tb_basic_check_functionality/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_basic_check_functionality/output_path=d:/Programming/github/vunit/vunit/vhdl/check/vunit_out/tests/lib.tb_basic_check_functionality/ -g/tb_basic_check_functionality/runner_cfg={"enabled_test_cases : Verify default checker basic functionality,,Verify default check_passed and check_failed,,Verify default checker initialization,,Verify custom checker basic functionality,,Verify check_passed and check_failed with custom checker,,Verify custom checker initialization,,Verify checker_stat_t functions and operators,,Verify export of configuration,active python runner : true,output path : d::/Programming/github/vunit/vunit/vhdl/check/vunit_out/tests/lib.tb_basic_check_functionality/"} lib.tb_basic_check_functionality(test_fixture)   -L lib -L vunit_lib' failed
