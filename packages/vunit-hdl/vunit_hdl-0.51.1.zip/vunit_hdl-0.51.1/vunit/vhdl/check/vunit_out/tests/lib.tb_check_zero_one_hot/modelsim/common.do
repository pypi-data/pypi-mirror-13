...
proc vunit_load {{vsim_extra_args ""}} {
    set vsim_failed [catch {
        eval vsim ${vsim_extra_args} {-modelsimini d:/Programming/github/vunit/vunit/vhdl/check/vunit_out/modelsim/modelsim.ini -wlf {d:/Programming/github/vunit/vunit/vhdl/check/vunit_out/tests/lib.tb_check_zero_one_hot/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_check_zero_one_hot/runner_cfg={"enabled_test_cases : Test should pass on zero or one high bit,,Test should fail on more than one high bit,,Test should fail on unknowns,,Test should be possible to use concurrently,,Test should be possible to use concurrently with negative active clock edge,,Test should be possible to use concurrently with custom checker,,Test should pass on unknowns when not enabled,,Test should handle reversed and or offset expressions,active python runner : true,output path : d::/Programming/github/vunit/vunit/vhdl/check/vunit_out/tests/lib.tb_check_zero_one_hot/"} lib.tb_check_zero_one_hot(test_fixture)   -L lib -L vunit_lib}
    }]
    if {${vsim_failed}} {
       echo Command 'vsim ${vsim_extra_args} -modelsimini d:/Programming/github/vunit/vunit/vhdl/check/vunit_out/modelsim/modelsim.ini -wlf {d:/Programming/github/vunit/vunit/vhdl/check/vunit_out/tests/lib.tb_check_zero_one_hot/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_check_zero_one_hot/runner_cfg={"enabled_test_cases : Test should pass on zero or one high bit,,Test should fail on more than one high bit,,Test should fail on unknowns,,Test should be possible to use concurrently,,Test should be possible to use concurrently with negative active clock edge,,Test should be possible to use concurrently with custom checker,,Test should pass on unknowns when not enabled,,Test should handle reversed and or offset expressions,active python runner : true,output path : d::/Programming/github/vunit/vunit/vhdl/check/vunit_out/tests/lib.tb_check_zero_one_hot/"} lib.tb_check_zero_one_hot(test_fixture)   -L lib -L vunit_lib' failed
