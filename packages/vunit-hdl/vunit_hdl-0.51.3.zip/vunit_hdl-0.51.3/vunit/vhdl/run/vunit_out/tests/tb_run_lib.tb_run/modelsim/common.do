...
proc vunit_load {{vsim_extra_args ""}} {
    set vsim_failed [catch {
        eval vsim ${vsim_extra_args} {-modelsimini d:/Programming/github/vunit/vunit/vhdl/run/vunit_out/modelsim/modelsim.ini -wlf {d:/Programming/github/vunit/vunit/vhdl/run/vunit_out/tests/tb_run_lib.tb_run/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_run/output_path=d:/Programming/github/vunit/vunit/vhdl/run/vunit_out/tests/tb_run_lib.tb_run/ tb_run_lib.tb_run(test_fixture)   -L vunit_lib -L tb_run_lib}
    }]
    if {${vsim_failed}} {
       echo Command 'vsim ${vsim_extra_args} -modelsimini d:/Programming/github/vunit/vunit/vhdl/run/vunit_out/modelsim/modelsim.ini -wlf {d:/Programming/github/vunit/vunit/vhdl/run/vunit_out/tests/tb_run_lib.tb_run/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_run/output_path=d:/Programming/github/vunit/vunit/vhdl/run/vunit_out/tests/tb_run_lib.tb_run/ tb_run_lib.tb_run(test_fixture)   -L vunit_lib -L tb_run_lib' failed
