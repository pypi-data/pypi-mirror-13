...
proc vunit_load {{vsim_extra_args ""}} {
    set vsim_failed [catch {
        eval vsim ${vsim_extra_args} {-modelsimini d:/Programming/github/vunit/vunit/vhdl/logging/vunit_out/modelsim/modelsim.ini -wlf {d:/Programming/github/vunit/vunit/vhdl/logging/vunit_out/tests/lib.tb_logging/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_logging/output_path=d:/Programming/github/vunit/vunit/vhdl/logging/vunit_out/tests/lib.tb_logging/ lib.tb_logging(test_fixture)   -L lib -L vunit_lib}
    }]
    if {${vsim_failed}} {
       echo Command 'vsim ${vsim_extra_args} -modelsimini d:/Programming/github/vunit/vunit/vhdl/logging/vunit_out/modelsim/modelsim.ini -wlf {d:/Programming/github/vunit/vunit/vhdl/logging/vunit_out/tests/lib.tb_logging/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_logging/output_path=d:/Programming/github/vunit/vunit/vhdl/logging/vunit_out/tests/lib.tb_logging/ lib.tb_logging(test_fixture)   -L lib -L vunit_lib' failed
