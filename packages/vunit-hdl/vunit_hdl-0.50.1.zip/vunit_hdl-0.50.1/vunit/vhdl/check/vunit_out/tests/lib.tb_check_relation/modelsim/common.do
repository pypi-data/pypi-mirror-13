...
proc vunit_load {{vsim_extra_args ""}} {
    set vsim_failed [catch {
        eval vsim ${vsim_extra_args} {-modelsimini d:/Programming/github/vunit/vunit/vhdl/check/vunit_out/modelsim/modelsim.ini -wlf {d:/Programming/github/vunit/vunit/vhdl/check/vunit_out/tests/lib.tb_check_relation/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_check_relation/runner_cfg={"enabled_test_cases : Test that a true relation does not generate an error,,Test that generated message is combined with a custom message,,Test that all pre VHDL 2008 relational operators are supported,,Test that all matching relational operators are supported,,Test that a generated message can contain string containing operands,,Test that custom types can be used,active python runner : true,output path : d::/Programming/github/vunit/vunit/vhdl/check/vunit_out/tests/lib.tb_check_relation/"} lib.tb_check_relation(test_fixture)   -L lib -L vunit_lib}
    }]
    if {${vsim_failed}} {
       echo Command 'vsim ${vsim_extra_args} -modelsimini d:/Programming/github/vunit/vunit/vhdl/check/vunit_out/modelsim/modelsim.ini -wlf {d:/Programming/github/vunit/vunit/vhdl/check/vunit_out/tests/lib.tb_check_relation/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_check_relation/runner_cfg={"enabled_test_cases : Test that a true relation does not generate an error,,Test that generated message is combined with a custom message,,Test that all pre VHDL 2008 relational operators are supported,,Test that all matching relational operators are supported,,Test that a generated message can contain string containing operands,,Test that custom types can be used,active python runner : true,output path : d::/Programming/github/vunit/vunit/vhdl/check/vunit_out/tests/lib.tb_check_relation/"} lib.tb_check_relation(test_fixture)   -L lib -L vunit_lib' failed
