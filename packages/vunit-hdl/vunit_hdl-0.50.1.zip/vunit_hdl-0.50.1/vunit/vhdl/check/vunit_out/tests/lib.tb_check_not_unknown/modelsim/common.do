...
proc vunit_load {{vsim_extra_args ""}} {
    set vsim_failed [catch {
        eval vsim ${vsim_extra_args} {-modelsimini d:/Programming/github/vunit/vunit/vhdl/check/vunit_out/modelsim/modelsim.ini -wlf {d:/Programming/github/vunit/vunit/vhdl/check/vunit_out/tests/lib.tb_check_not_unknown/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_check_not_unknown/runner_cfg={"enabled_test_cases : Test should pass on zeros and ones,,Test should fail on all std logic values except zero and one,,Test should be possible to use concurrently,,Test should be possible to use concurrently with negative active clock edge,,Test should be possible to use concurrently with custom checker,,Test should handle reversed and or offset expressions,active python runner : true,output path : d::/Programming/github/vunit/vunit/vhdl/check/vunit_out/tests/lib.tb_check_not_unknown/"} lib.tb_check_not_unknown(test_fixture)   -L lib -L vunit_lib}
    }]
    if {${vsim_failed}} {
       echo Command 'vsim ${vsim_extra_args} -modelsimini d:/Programming/github/vunit/vunit/vhdl/check/vunit_out/modelsim/modelsim.ini -wlf {d:/Programming/github/vunit/vunit/vhdl/check/vunit_out/tests/lib.tb_check_not_unknown/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_check_not_unknown/runner_cfg={"enabled_test_cases : Test should pass on zeros and ones,,Test should fail on all std logic values except zero and one,,Test should be possible to use concurrently,,Test should be possible to use concurrently with negative active clock edge,,Test should be possible to use concurrently with custom checker,,Test should handle reversed and or offset expressions,active python runner : true,output path : d::/Programming/github/vunit/vunit/vhdl/check/vunit_out/tests/lib.tb_check_not_unknown/"} lib.tb_check_not_unknown(test_fixture)   -L lib -L vunit_lib' failed
