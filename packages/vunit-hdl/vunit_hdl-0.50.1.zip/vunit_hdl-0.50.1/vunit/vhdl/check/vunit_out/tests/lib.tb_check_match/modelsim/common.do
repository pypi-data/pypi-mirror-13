...
proc vunit_load {{vsim_extra_args ""}} {
    set vsim_failed [catch {
        eval vsim ${vsim_extra_args} {-modelsimini d:/Programming/github/vunit/vunit/vhdl/check/vunit_out/modelsim/modelsim.ini -wlf {d:/Programming/github/vunit/vunit/vhdl/check/vunit_out/tests/lib.tb_check_match/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_check_match/runner_cfg={"enabled_test_cases : Test should pass on unsigned matching unsigned,,Test should fail on unsigned not matching unsigned,,Test should pass on std_logic_vector matching std_logic_vector,,Test should fail on std_logic_vector not matching std_logic_vector,,Test should pass on signed matching signed,,Test should fail on signed not matching signed,,Test should pass on std_logic matching std_logic,,Test should fail on std_logic not matching std_logic,active python runner : true,output path : d::/Programming/github/vunit/vunit/vhdl/check/vunit_out/tests/lib.tb_check_match/"} lib.tb_check_match(test_fixture)   -L lib -L vunit_lib}
    }]
    if {${vsim_failed}} {
       echo Command 'vsim ${vsim_extra_args} -modelsimini d:/Programming/github/vunit/vunit/vhdl/check/vunit_out/modelsim/modelsim.ini -wlf {d:/Programming/github/vunit/vunit/vhdl/check/vunit_out/tests/lib.tb_check_match/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_check_match/runner_cfg={"enabled_test_cases : Test should pass on unsigned matching unsigned,,Test should fail on unsigned not matching unsigned,,Test should pass on std_logic_vector matching std_logic_vector,,Test should fail on std_logic_vector not matching std_logic_vector,,Test should pass on signed matching signed,,Test should fail on signed not matching signed,,Test should pass on std_logic matching std_logic,,Test should fail on std_logic not matching std_logic,active python runner : true,output path : d::/Programming/github/vunit/vunit/vhdl/check/vunit_out/tests/lib.tb_check_match/"} lib.tb_check_match(test_fixture)   -L lib -L vunit_lib' failed
