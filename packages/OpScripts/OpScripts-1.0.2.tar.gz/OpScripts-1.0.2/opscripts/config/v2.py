...
class OpsHelpFormatter(configargparse.ArgumentDefaultsHelpFormatter,
                       configargparse.HelpFormatter,
                       configargparse.DescriptionHelpFormatter,
                       configargparse.format_values):
...
def OpsConfigArgParse(**kwargs):
    ...
    if "formatter_class" not in kwargs:
        kwargs["formatter_class"] = OpsHelpFormatter
