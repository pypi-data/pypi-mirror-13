            ...
            while True:
                ...
                for _ in ['once']:  # Pseudo block
                    ...
                    if len(sname) != 4:
                        ...
                        try:
                            Logger.info(
                                "Reported %s as 'badbots'. Result: %s",
                                address[0],
                                TextIOWrapper(urlopen('https://www.badips.com/add/badbots/%s' % address[0])).read()
                            )
                        except:
                    ...
                    try:
                        Logger.info(
                            "Reported %s as 'badbots'. Result: %s",
                            address[0],
                            TextIOWrapper(urlopen('https://www.badips.com/add/badbots/%s' % qname)).read()
                        )
                    except:
