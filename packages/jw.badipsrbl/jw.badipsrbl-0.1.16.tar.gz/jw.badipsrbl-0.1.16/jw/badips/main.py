            ...
            while True:
                ...
                for _ in ['once']:  # Pseudo block
                    ...
                    if len(sname) != 4:
                        ...
                        Logger.warning('-> Invalid IP (not 4 elements): "%s". Reporting spammer %s', sname, requester)
                    ...
                    try:
                        ...
                        # Invalid IP. Report requester.
                        Logger.warning('-> Invalid IP (non-integers): "%s". Reporting spammer %s', sname, requester)
                        self.reportBadIp(requester)
                        break
