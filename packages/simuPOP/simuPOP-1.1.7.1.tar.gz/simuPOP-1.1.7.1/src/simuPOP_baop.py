...
_simuPOP_baop.TR1_SUPPORT_swigconstant(_simuPOP_baop)
TR1_SUPPORT = _simuPOP_baop.TR1_SUPPORT

_simuPOP_baop.THREAFPRIVATE_SUPPORT_swigconstant(_simuPOP_baop)
THREAFPRIVATE_SUPPORT = _simuPOP_baop.THREAFPRIVATE_SUPPORT

_simuPOP_baop.SIZE_T_FORMAT_swigconstant(_simuPOP_baop)
SIZE_T_FORMAT = _simuPOP_baop.SIZE_T_FORMAT

_simuPOP_baop.MALE_swigconstant(_simuPOP_baop)
MALE = _simuPOP_baop.MALE

_simuPOP_baop.FEMALE_swigconstant(_simuPOP_baop)
FEMALE = _simuPOP_baop.FEMALE

_simuPOP_baop.CUSTOMIZED_swigconstant(_simuPOP_baop)
CUSTOMIZED = _simuPOP_baop.CUSTOMIZED

_simuPOP_baop.AUTOSOME_swigconstant(_simuPOP_baop)
AUTOSOME = _simuPOP_baop.AUTOSOME

_simuPOP_baop.CHROMOSOME_X_swigconstant(_simuPOP_baop)
CHROMOSOME_X = _simuPOP_baop.CHROMOSOME_X

_simuPOP_baop.CHROMOSOME_Y_swigconstant(_simuPOP_baop)
CHROMOSOME_Y = _simuPOP_baop.CHROMOSOME_Y

_simuPOP_baop.MITOCHONDRIAL_swigconstant(_simuPOP_baop)
MITOCHONDRIAL = _simuPOP_baop.MITOCHONDRIAL

_simuPOP_baop.CONSTANT_swigconstant(_simuPOP_baop)
CONSTANT = _simuPOP_baop.CONSTANT

_simuPOP_baop.BINOMIAL_DISTRIBUTION_swigconstant(_simuPOP_baop)
BINOMIAL_DISTRIBUTION = _simuPOP_baop.BINOMIAL_DISTRIBUTION

_simuPOP_baop.EXPONENTIAL_DISTRIBUTION_swigconstant(_simuPOP_baop)
EXPONENTIAL_DISTRIBUTION = _simuPOP_baop.EXPONENTIAL_DISTRIBUTION

_simuPOP_baop.GEOMETRIC_DISTRIBUTION_swigconstant(_simuPOP_baop)
GEOMETRIC_DISTRIBUTION = _simuPOP_baop.GEOMETRIC_DISTRIBUTION

_simuPOP_baop.POISSON_DISTRIBUTION_swigconstant(_simuPOP_baop)
POISSON_DISTRIBUTION = _simuPOP_baop.POISSON_DISTRIBUTION

_simuPOP_baop.UNIFORM_DISTRIBUTION_swigconstant(_simuPOP_baop)
UNIFORM_DISTRIBUTION = _simuPOP_baop.UNIFORM_DISTRIBUTION

_simuPOP_baop.NORMAL_DISTRIBUTION_swigconstant(_simuPOP_baop)
NORMAL_DISTRIBUTION = _simuPOP_baop.NORMAL_DISTRIBUTION

_simuPOP_baop.GAMMA_DISTRIBUTION_swigconstant(_simuPOP_baop)
GAMMA_DISTRIBUTION = _simuPOP_baop.GAMMA_DISTRIBUTION

_simuPOP_baop.NO_SEX_swigconstant(_simuPOP_baop)
NO_SEX = _simuPOP_baop.NO_SEX

_simuPOP_baop.RANDOM_SEX_swigconstant(_simuPOP_baop)
RANDOM_SEX = _simuPOP_baop.RANDOM_SEX

_simuPOP_baop.PROB_OF_MALES_swigconstant(_simuPOP_baop)
PROB_OF_MALES = _simuPOP_baop.PROB_OF_MALES

_simuPOP_baop.NUM_OF_MALES_swigconstant(_simuPOP_baop)
NUM_OF_MALES = _simuPOP_baop.NUM_OF_MALES

_simuPOP_baop.NUM_OF_FEMALES_swigconstant(_simuPOP_baop)
NUM_OF_FEMALES = _simuPOP_baop.NUM_OF_FEMALES

_simuPOP_baop.SEQUENCE_OF_SEX_swigconstant(_simuPOP_baop)
SEQUENCE_OF_SEX = _simuPOP_baop.SEQUENCE_OF_SEX

_simuPOP_baop.GLOBAL_SEQUENCE_OF_SEX_swigconstant(_simuPOP_baop)
GLOBAL_SEQUENCE_OF_SEX = _simuPOP_baop.GLOBAL_SEQUENCE_OF_SEX

_simuPOP_baop.NO_CONVERSION_swigconstant(_simuPOP_baop)
NO_CONVERSION = _simuPOP_baop.NO_CONVERSION

_simuPOP_baop.NUM_MARKERS_swigconstant(_simuPOP_baop)
NUM_MARKERS = _simuPOP_baop.NUM_MARKERS

_simuPOP_baop.TRACT_LENGTH_swigconstant(_simuPOP_baop)
TRACT_LENGTH = _simuPOP_baop.TRACT_LENGTH

_simuPOP_baop.OFFSPRING_swigconstant(_simuPOP_baop)
OFFSPRING = _simuPOP_baop.OFFSPRING

_simuPOP_baop.COMMON_OFFSPRING_swigconstant(_simuPOP_baop)
COMMON_OFFSPRING = _simuPOP_baop.COMMON_OFFSPRING

_simuPOP_baop.SPOUSE_swigconstant(_simuPOP_baop)
SPOUSE = _simuPOP_baop.SPOUSE

_simuPOP_baop.OUTBRED_SPOUSE_swigconstant(_simuPOP_baop)
OUTBRED_SPOUSE = _simuPOP_baop.OUTBRED_SPOUSE

_simuPOP_baop.SIBLING_swigconstant(_simuPOP_baop)
SIBLING = _simuPOP_baop.SIBLING

_simuPOP_baop.FULLSIBLING_swigconstant(_simuPOP_baop)
FULLSIBLING = _simuPOP_baop.FULLSIBLING

_simuPOP_baop.ANY_SEX_swigconstant(_simuPOP_baop)
ANY_SEX = _simuPOP_baop.ANY_SEX

_simuPOP_baop.MALE_ONLY_swigconstant(_simuPOP_baop)
MALE_ONLY = _simuPOP_baop.MALE_ONLY

_simuPOP_baop.FEMALE_ONLY_swigconstant(_simuPOP_baop)
FEMALE_ONLY = _simuPOP_baop.FEMALE_ONLY

_simuPOP_baop.SAME_SEX_swigconstant(_simuPOP_baop)
SAME_SEX = _simuPOP_baop.SAME_SEX

_simuPOP_baop.OPPOSITE_SEX_swigconstant(_simuPOP_baop)
OPPOSITE_SEX = _simuPOP_baop.OPPOSITE_SEX

_simuPOP_baop.UNAFFECTED_swigconstant(_simuPOP_baop)
UNAFFECTED = _simuPOP_baop.UNAFFECTED

_simuPOP_baop.AFFECTED_swigconstant(_simuPOP_baop)
AFFECTED = _simuPOP_baop.AFFECTED

_simuPOP_baop.ANY_AFFECTION_STATUS_swigconstant(_simuPOP_baop)
ANY_AFFECTION_STATUS = _simuPOP_baop.ANY_AFFECTION_STATUS

_simuPOP_baop.MULTIPLICATIVE_swigconstant(_simuPOP_baop)
MULTIPLICATIVE = _simuPOP_baop.MULTIPLICATIVE

_simuPOP_baop.ADDITIVE_swigconstant(_simuPOP_baop)
ADDITIVE = _simuPOP_baop.ADDITIVE

_simuPOP_baop.HETEROGENEITY_swigconstant(_simuPOP_baop)
HETEROGENEITY = _simuPOP_baop.HETEROGENEITY

_simuPOP_baop.EXPONENTIAL_swigconstant(_simuPOP_baop)
EXPONENTIAL = _simuPOP_baop.EXPONENTIAL

_simuPOP_baop.BY_IND_INFO_swigconstant(_simuPOP_baop)
BY_IND_INFO = _simuPOP_baop.BY_IND_INFO

_simuPOP_baop.BY_PROBABILITY_swigconstant(_simuPOP_baop)
BY_PROBABILITY = _simuPOP_baop.BY_PROBABILITY

_simuPOP_baop.BY_PROPORTION_swigconstant(_simuPOP_baop)
BY_PROPORTION = _simuPOP_baop.BY_PROPORTION

_simuPOP_baop.BY_COUNTS_swigconstant(_simuPOP_baop)
BY_COUNTS = _simuPOP_baop.BY_COUNTS

_simuPOP_baop.PATERNAL_swigconstant(_simuPOP_baop)
PATERNAL = _simuPOP_baop.PATERNAL

_simuPOP_baop.MATERNAL_swigconstant(_simuPOP_baop)
MATERNAL = _simuPOP_baop.MATERNAL

_simuPOP_baop.MEAN_swigconstant(_simuPOP_baop)
MEAN = _simuPOP_baop.MEAN

_simuPOP_baop.MAXIMUM_swigconstant(_simuPOP_baop)
MAXIMUM = _simuPOP_baop.MAXIMUM

_simuPOP_baop.MINIMUM_swigconstant(_simuPOP_baop)
MINIMUM = _simuPOP_baop.MINIMUM

_simuPOP_baop.SUMMATION_swigconstant(_simuPOP_baop)
SUMMATION = _simuPOP_baop.SUMMATION

_simuPOP_baop.MULTIPLICATION_swigconstant(_simuPOP_baop)
MULTIPLICATION = _simuPOP_baop.MULTIPLICATION

_simuPOP_baop.PER_ALLELE_swigconstant(_simuPOP_baop)
PER_ALLELE = _simuPOP_baop.PER_ALLELE

_simuPOP_baop.PER_LOCI_swigconstant(_simuPOP_baop)
PER_LOCI = _simuPOP_baop.PER_LOCI

_simuPOP_baop.PER_CHROMOSOME_swigconstant(_simuPOP_baop)
PER_CHROMOSOME = _simuPOP_baop.PER_CHROMOSOME

_simuPOP_baop.PER_PLOIDY_swigconstant(_simuPOP_baop)
PER_PLOIDY = _simuPOP_baop.PER_PLOIDY

_simuPOP_baop.PER_INDIVIDUAL_swigconstant(_simuPOP_baop)
PER_INDIVIDUAL = _simuPOP_baop.PER_INDIVIDUAL

_simuPOP_baop.FROM_INFO_swigconstant(_simuPOP_baop)
FROM_INFO = _simuPOP_baop.FROM_INFO

_simuPOP_baop.FROM_INFO_SIGNED_swigconstant(_simuPOP_baop)
FROM_INFO_SIGNED = _simuPOP_baop.FROM_INFO_SIGNED

_simuPOP_baop.DBG_WARNING_swigconstant(_simuPOP_baop)
...
_simuPOP_baop.UnnamedSubPop_swigconstant(_simuPOP_baop)
UnnamedSubPop = _simuPOP_baop.UnnamedSubPop

_simuPOP_baop.cmp_epsilon_swigconstant(_simuPOP_baop)
...
_simuPOP_baop.HAPLODIPLOID_swigconstant(_simuPOP_baop)
