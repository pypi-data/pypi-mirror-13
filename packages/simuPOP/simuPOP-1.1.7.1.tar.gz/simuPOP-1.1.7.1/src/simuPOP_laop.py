...
_simuPOP_laop.TR1_SUPPORT_swigconstant(_simuPOP_laop)
TR1_SUPPORT = _simuPOP_laop.TR1_SUPPORT

_simuPOP_laop.THREAFPRIVATE_SUPPORT_swigconstant(_simuPOP_laop)
THREAFPRIVATE_SUPPORT = _simuPOP_laop.THREAFPRIVATE_SUPPORT

_simuPOP_laop.SIZE_T_FORMAT_swigconstant(_simuPOP_laop)
SIZE_T_FORMAT = _simuPOP_laop.SIZE_T_FORMAT

_simuPOP_laop.MALE_swigconstant(_simuPOP_laop)
MALE = _simuPOP_laop.MALE

_simuPOP_laop.FEMALE_swigconstant(_simuPOP_laop)
FEMALE = _simuPOP_laop.FEMALE

_simuPOP_laop.CUSTOMIZED_swigconstant(_simuPOP_laop)
CUSTOMIZED = _simuPOP_laop.CUSTOMIZED

_simuPOP_laop.AUTOSOME_swigconstant(_simuPOP_laop)
AUTOSOME = _simuPOP_laop.AUTOSOME

_simuPOP_laop.CHROMOSOME_X_swigconstant(_simuPOP_laop)
CHROMOSOME_X = _simuPOP_laop.CHROMOSOME_X

_simuPOP_laop.CHROMOSOME_Y_swigconstant(_simuPOP_laop)
CHROMOSOME_Y = _simuPOP_laop.CHROMOSOME_Y

_simuPOP_laop.MITOCHONDRIAL_swigconstant(_simuPOP_laop)
MITOCHONDRIAL = _simuPOP_laop.MITOCHONDRIAL

_simuPOP_laop.CONSTANT_swigconstant(_simuPOP_laop)
CONSTANT = _simuPOP_laop.CONSTANT

_simuPOP_laop.BINOMIAL_DISTRIBUTION_swigconstant(_simuPOP_laop)
BINOMIAL_DISTRIBUTION = _simuPOP_laop.BINOMIAL_DISTRIBUTION

_simuPOP_laop.EXPONENTIAL_DISTRIBUTION_swigconstant(_simuPOP_laop)
EXPONENTIAL_DISTRIBUTION = _simuPOP_laop.EXPONENTIAL_DISTRIBUTION

_simuPOP_laop.GEOMETRIC_DISTRIBUTION_swigconstant(_simuPOP_laop)
GEOMETRIC_DISTRIBUTION = _simuPOP_laop.GEOMETRIC_DISTRIBUTION

_simuPOP_laop.POISSON_DISTRIBUTION_swigconstant(_simuPOP_laop)
POISSON_DISTRIBUTION = _simuPOP_laop.POISSON_DISTRIBUTION

_simuPOP_laop.UNIFORM_DISTRIBUTION_swigconstant(_simuPOP_laop)
UNIFORM_DISTRIBUTION = _simuPOP_laop.UNIFORM_DISTRIBUTION

_simuPOP_laop.NORMAL_DISTRIBUTION_swigconstant(_simuPOP_laop)
NORMAL_DISTRIBUTION = _simuPOP_laop.NORMAL_DISTRIBUTION

_simuPOP_laop.GAMMA_DISTRIBUTION_swigconstant(_simuPOP_laop)
GAMMA_DISTRIBUTION = _simuPOP_laop.GAMMA_DISTRIBUTION

_simuPOP_laop.NO_SEX_swigconstant(_simuPOP_laop)
NO_SEX = _simuPOP_laop.NO_SEX

_simuPOP_laop.RANDOM_SEX_swigconstant(_simuPOP_laop)
RANDOM_SEX = _simuPOP_laop.RANDOM_SEX

_simuPOP_laop.PROB_OF_MALES_swigconstant(_simuPOP_laop)
PROB_OF_MALES = _simuPOP_laop.PROB_OF_MALES

_simuPOP_laop.NUM_OF_MALES_swigconstant(_simuPOP_laop)
NUM_OF_MALES = _simuPOP_laop.NUM_OF_MALES

_simuPOP_laop.NUM_OF_FEMALES_swigconstant(_simuPOP_laop)
NUM_OF_FEMALES = _simuPOP_laop.NUM_OF_FEMALES

_simuPOP_laop.SEQUENCE_OF_SEX_swigconstant(_simuPOP_laop)
SEQUENCE_OF_SEX = _simuPOP_laop.SEQUENCE_OF_SEX

_simuPOP_laop.GLOBAL_SEQUENCE_OF_SEX_swigconstant(_simuPOP_laop)
GLOBAL_SEQUENCE_OF_SEX = _simuPOP_laop.GLOBAL_SEQUENCE_OF_SEX

_simuPOP_laop.NO_CONVERSION_swigconstant(_simuPOP_laop)
NO_CONVERSION = _simuPOP_laop.NO_CONVERSION

_simuPOP_laop.NUM_MARKERS_swigconstant(_simuPOP_laop)
NUM_MARKERS = _simuPOP_laop.NUM_MARKERS

_simuPOP_laop.TRACT_LENGTH_swigconstant(_simuPOP_laop)
TRACT_LENGTH = _simuPOP_laop.TRACT_LENGTH

_simuPOP_laop.OFFSPRING_swigconstant(_simuPOP_laop)
OFFSPRING = _simuPOP_laop.OFFSPRING

_simuPOP_laop.COMMON_OFFSPRING_swigconstant(_simuPOP_laop)
COMMON_OFFSPRING = _simuPOP_laop.COMMON_OFFSPRING

_simuPOP_laop.SPOUSE_swigconstant(_simuPOP_laop)
SPOUSE = _simuPOP_laop.SPOUSE

_simuPOP_laop.OUTBRED_SPOUSE_swigconstant(_simuPOP_laop)
OUTBRED_SPOUSE = _simuPOP_laop.OUTBRED_SPOUSE

_simuPOP_laop.SIBLING_swigconstant(_simuPOP_laop)
SIBLING = _simuPOP_laop.SIBLING

_simuPOP_laop.FULLSIBLING_swigconstant(_simuPOP_laop)
FULLSIBLING = _simuPOP_laop.FULLSIBLING

_simuPOP_laop.ANY_SEX_swigconstant(_simuPOP_laop)
ANY_SEX = _simuPOP_laop.ANY_SEX

_simuPOP_laop.MALE_ONLY_swigconstant(_simuPOP_laop)
MALE_ONLY = _simuPOP_laop.MALE_ONLY

_simuPOP_laop.FEMALE_ONLY_swigconstant(_simuPOP_laop)
FEMALE_ONLY = _simuPOP_laop.FEMALE_ONLY

_simuPOP_laop.SAME_SEX_swigconstant(_simuPOP_laop)
SAME_SEX = _simuPOP_laop.SAME_SEX

_simuPOP_laop.OPPOSITE_SEX_swigconstant(_simuPOP_laop)
OPPOSITE_SEX = _simuPOP_laop.OPPOSITE_SEX

_simuPOP_laop.UNAFFECTED_swigconstant(_simuPOP_laop)
UNAFFECTED = _simuPOP_laop.UNAFFECTED

_simuPOP_laop.AFFECTED_swigconstant(_simuPOP_laop)
AFFECTED = _simuPOP_laop.AFFECTED

_simuPOP_laop.ANY_AFFECTION_STATUS_swigconstant(_simuPOP_laop)
ANY_AFFECTION_STATUS = _simuPOP_laop.ANY_AFFECTION_STATUS

_simuPOP_laop.MULTIPLICATIVE_swigconstant(_simuPOP_laop)
MULTIPLICATIVE = _simuPOP_laop.MULTIPLICATIVE

_simuPOP_laop.ADDITIVE_swigconstant(_simuPOP_laop)
ADDITIVE = _simuPOP_laop.ADDITIVE

_simuPOP_laop.HETEROGENEITY_swigconstant(_simuPOP_laop)
HETEROGENEITY = _simuPOP_laop.HETEROGENEITY

_simuPOP_laop.EXPONENTIAL_swigconstant(_simuPOP_laop)
EXPONENTIAL = _simuPOP_laop.EXPONENTIAL

_simuPOP_laop.BY_IND_INFO_swigconstant(_simuPOP_laop)
BY_IND_INFO = _simuPOP_laop.BY_IND_INFO

_simuPOP_laop.BY_PROBABILITY_swigconstant(_simuPOP_laop)
BY_PROBABILITY = _simuPOP_laop.BY_PROBABILITY

_simuPOP_laop.BY_PROPORTION_swigconstant(_simuPOP_laop)
BY_PROPORTION = _simuPOP_laop.BY_PROPORTION

_simuPOP_laop.BY_COUNTS_swigconstant(_simuPOP_laop)
BY_COUNTS = _simuPOP_laop.BY_COUNTS

_simuPOP_laop.PATERNAL_swigconstant(_simuPOP_laop)
PATERNAL = _simuPOP_laop.PATERNAL

_simuPOP_laop.MATERNAL_swigconstant(_simuPOP_laop)
MATERNAL = _simuPOP_laop.MATERNAL

_simuPOP_laop.MEAN_swigconstant(_simuPOP_laop)
MEAN = _simuPOP_laop.MEAN

_simuPOP_laop.MAXIMUM_swigconstant(_simuPOP_laop)
MAXIMUM = _simuPOP_laop.MAXIMUM

_simuPOP_laop.MINIMUM_swigconstant(_simuPOP_laop)
MINIMUM = _simuPOP_laop.MINIMUM

_simuPOP_laop.SUMMATION_swigconstant(_simuPOP_laop)
SUMMATION = _simuPOP_laop.SUMMATION

_simuPOP_laop.MULTIPLICATION_swigconstant(_simuPOP_laop)
MULTIPLICATION = _simuPOP_laop.MULTIPLICATION

_simuPOP_laop.PER_ALLELE_swigconstant(_simuPOP_laop)
PER_ALLELE = _simuPOP_laop.PER_ALLELE

_simuPOP_laop.PER_LOCI_swigconstant(_simuPOP_laop)
PER_LOCI = _simuPOP_laop.PER_LOCI

_simuPOP_laop.PER_CHROMOSOME_swigconstant(_simuPOP_laop)
PER_CHROMOSOME = _simuPOP_laop.PER_CHROMOSOME

_simuPOP_laop.PER_PLOIDY_swigconstant(_simuPOP_laop)
PER_PLOIDY = _simuPOP_laop.PER_PLOIDY

_simuPOP_laop.PER_INDIVIDUAL_swigconstant(_simuPOP_laop)
PER_INDIVIDUAL = _simuPOP_laop.PER_INDIVIDUAL

_simuPOP_laop.FROM_INFO_swigconstant(_simuPOP_laop)
FROM_INFO = _simuPOP_laop.FROM_INFO

_simuPOP_laop.FROM_INFO_SIGNED_swigconstant(_simuPOP_laop)
FROM_INFO_SIGNED = _simuPOP_laop.FROM_INFO_SIGNED

_simuPOP_laop.DBG_WARNING_swigconstant(_simuPOP_laop)
...
_simuPOP_laop.UnnamedSubPop_swigconstant(_simuPOP_laop)
UnnamedSubPop = _simuPOP_laop.UnnamedSubPop

_simuPOP_laop.cmp_epsilon_swigconstant(_simuPOP_laop)
...
_simuPOP_laop.HAPLODIPLOID_swigconstant(_simuPOP_laop)
