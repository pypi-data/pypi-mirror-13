...
_simuPOP_muop.TR1_SUPPORT_swigconstant(_simuPOP_muop)
TR1_SUPPORT = _simuPOP_muop.TR1_SUPPORT

_simuPOP_muop.THREAFPRIVATE_SUPPORT_swigconstant(_simuPOP_muop)
THREAFPRIVATE_SUPPORT = _simuPOP_muop.THREAFPRIVATE_SUPPORT

_simuPOP_muop.SIZE_T_FORMAT_swigconstant(_simuPOP_muop)
SIZE_T_FORMAT = _simuPOP_muop.SIZE_T_FORMAT

_simuPOP_muop.MALE_swigconstant(_simuPOP_muop)
MALE = _simuPOP_muop.MALE

_simuPOP_muop.FEMALE_swigconstant(_simuPOP_muop)
FEMALE = _simuPOP_muop.FEMALE

_simuPOP_muop.CUSTOMIZED_swigconstant(_simuPOP_muop)
CUSTOMIZED = _simuPOP_muop.CUSTOMIZED

_simuPOP_muop.AUTOSOME_swigconstant(_simuPOP_muop)
AUTOSOME = _simuPOP_muop.AUTOSOME

_simuPOP_muop.CHROMOSOME_X_swigconstant(_simuPOP_muop)
CHROMOSOME_X = _simuPOP_muop.CHROMOSOME_X

_simuPOP_muop.CHROMOSOME_Y_swigconstant(_simuPOP_muop)
CHROMOSOME_Y = _simuPOP_muop.CHROMOSOME_Y

_simuPOP_muop.MITOCHONDRIAL_swigconstant(_simuPOP_muop)
MITOCHONDRIAL = _simuPOP_muop.MITOCHONDRIAL

_simuPOP_muop.CONSTANT_swigconstant(_simuPOP_muop)
CONSTANT = _simuPOP_muop.CONSTANT

_simuPOP_muop.BINOMIAL_DISTRIBUTION_swigconstant(_simuPOP_muop)
BINOMIAL_DISTRIBUTION = _simuPOP_muop.BINOMIAL_DISTRIBUTION

_simuPOP_muop.EXPONENTIAL_DISTRIBUTION_swigconstant(_simuPOP_muop)
EXPONENTIAL_DISTRIBUTION = _simuPOP_muop.EXPONENTIAL_DISTRIBUTION

_simuPOP_muop.GEOMETRIC_DISTRIBUTION_swigconstant(_simuPOP_muop)
GEOMETRIC_DISTRIBUTION = _simuPOP_muop.GEOMETRIC_DISTRIBUTION

_simuPOP_muop.POISSON_DISTRIBUTION_swigconstant(_simuPOP_muop)
POISSON_DISTRIBUTION = _simuPOP_muop.POISSON_DISTRIBUTION

_simuPOP_muop.UNIFORM_DISTRIBUTION_swigconstant(_simuPOP_muop)
UNIFORM_DISTRIBUTION = _simuPOP_muop.UNIFORM_DISTRIBUTION

_simuPOP_muop.NORMAL_DISTRIBUTION_swigconstant(_simuPOP_muop)
NORMAL_DISTRIBUTION = _simuPOP_muop.NORMAL_DISTRIBUTION

_simuPOP_muop.GAMMA_DISTRIBUTION_swigconstant(_simuPOP_muop)
GAMMA_DISTRIBUTION = _simuPOP_muop.GAMMA_DISTRIBUTION

_simuPOP_muop.NO_SEX_swigconstant(_simuPOP_muop)
NO_SEX = _simuPOP_muop.NO_SEX

_simuPOP_muop.RANDOM_SEX_swigconstant(_simuPOP_muop)
RANDOM_SEX = _simuPOP_muop.RANDOM_SEX

_simuPOP_muop.PROB_OF_MALES_swigconstant(_simuPOP_muop)
PROB_OF_MALES = _simuPOP_muop.PROB_OF_MALES

_simuPOP_muop.NUM_OF_MALES_swigconstant(_simuPOP_muop)
NUM_OF_MALES = _simuPOP_muop.NUM_OF_MALES

_simuPOP_muop.NUM_OF_FEMALES_swigconstant(_simuPOP_muop)
NUM_OF_FEMALES = _simuPOP_muop.NUM_OF_FEMALES

_simuPOP_muop.SEQUENCE_OF_SEX_swigconstant(_simuPOP_muop)
SEQUENCE_OF_SEX = _simuPOP_muop.SEQUENCE_OF_SEX

_simuPOP_muop.GLOBAL_SEQUENCE_OF_SEX_swigconstant(_simuPOP_muop)
GLOBAL_SEQUENCE_OF_SEX = _simuPOP_muop.GLOBAL_SEQUENCE_OF_SEX

_simuPOP_muop.NO_CONVERSION_swigconstant(_simuPOP_muop)
NO_CONVERSION = _simuPOP_muop.NO_CONVERSION

_simuPOP_muop.NUM_MARKERS_swigconstant(_simuPOP_muop)
NUM_MARKERS = _simuPOP_muop.NUM_MARKERS

_simuPOP_muop.TRACT_LENGTH_swigconstant(_simuPOP_muop)
TRACT_LENGTH = _simuPOP_muop.TRACT_LENGTH

_simuPOP_muop.OFFSPRING_swigconstant(_simuPOP_muop)
OFFSPRING = _simuPOP_muop.OFFSPRING

_simuPOP_muop.COMMON_OFFSPRING_swigconstant(_simuPOP_muop)
COMMON_OFFSPRING = _simuPOP_muop.COMMON_OFFSPRING

_simuPOP_muop.SPOUSE_swigconstant(_simuPOP_muop)
SPOUSE = _simuPOP_muop.SPOUSE

_simuPOP_muop.OUTBRED_SPOUSE_swigconstant(_simuPOP_muop)
OUTBRED_SPOUSE = _simuPOP_muop.OUTBRED_SPOUSE

_simuPOP_muop.SIBLING_swigconstant(_simuPOP_muop)
SIBLING = _simuPOP_muop.SIBLING

_simuPOP_muop.FULLSIBLING_swigconstant(_simuPOP_muop)
FULLSIBLING = _simuPOP_muop.FULLSIBLING

_simuPOP_muop.ANY_SEX_swigconstant(_simuPOP_muop)
ANY_SEX = _simuPOP_muop.ANY_SEX

_simuPOP_muop.MALE_ONLY_swigconstant(_simuPOP_muop)
MALE_ONLY = _simuPOP_muop.MALE_ONLY

_simuPOP_muop.FEMALE_ONLY_swigconstant(_simuPOP_muop)
FEMALE_ONLY = _simuPOP_muop.FEMALE_ONLY

_simuPOP_muop.SAME_SEX_swigconstant(_simuPOP_muop)
SAME_SEX = _simuPOP_muop.SAME_SEX

_simuPOP_muop.OPPOSITE_SEX_swigconstant(_simuPOP_muop)
OPPOSITE_SEX = _simuPOP_muop.OPPOSITE_SEX

_simuPOP_muop.UNAFFECTED_swigconstant(_simuPOP_muop)
UNAFFECTED = _simuPOP_muop.UNAFFECTED

_simuPOP_muop.AFFECTED_swigconstant(_simuPOP_muop)
AFFECTED = _simuPOP_muop.AFFECTED

_simuPOP_muop.ANY_AFFECTION_STATUS_swigconstant(_simuPOP_muop)
ANY_AFFECTION_STATUS = _simuPOP_muop.ANY_AFFECTION_STATUS

_simuPOP_muop.MULTIPLICATIVE_swigconstant(_simuPOP_muop)
MULTIPLICATIVE = _simuPOP_muop.MULTIPLICATIVE

_simuPOP_muop.ADDITIVE_swigconstant(_simuPOP_muop)
ADDITIVE = _simuPOP_muop.ADDITIVE

_simuPOP_muop.HETEROGENEITY_swigconstant(_simuPOP_muop)
HETEROGENEITY = _simuPOP_muop.HETEROGENEITY

_simuPOP_muop.EXPONENTIAL_swigconstant(_simuPOP_muop)
EXPONENTIAL = _simuPOP_muop.EXPONENTIAL

_simuPOP_muop.BY_IND_INFO_swigconstant(_simuPOP_muop)
BY_IND_INFO = _simuPOP_muop.BY_IND_INFO

_simuPOP_muop.BY_PROBABILITY_swigconstant(_simuPOP_muop)
BY_PROBABILITY = _simuPOP_muop.BY_PROBABILITY

_simuPOP_muop.BY_PROPORTION_swigconstant(_simuPOP_muop)
BY_PROPORTION = _simuPOP_muop.BY_PROPORTION

_simuPOP_muop.BY_COUNTS_swigconstant(_simuPOP_muop)
BY_COUNTS = _simuPOP_muop.BY_COUNTS

_simuPOP_muop.PATERNAL_swigconstant(_simuPOP_muop)
PATERNAL = _simuPOP_muop.PATERNAL

_simuPOP_muop.MATERNAL_swigconstant(_simuPOP_muop)
MATERNAL = _simuPOP_muop.MATERNAL

_simuPOP_muop.MEAN_swigconstant(_simuPOP_muop)
MEAN = _simuPOP_muop.MEAN

_simuPOP_muop.MAXIMUM_swigconstant(_simuPOP_muop)
MAXIMUM = _simuPOP_muop.MAXIMUM

_simuPOP_muop.MINIMUM_swigconstant(_simuPOP_muop)
MINIMUM = _simuPOP_muop.MINIMUM

_simuPOP_muop.SUMMATION_swigconstant(_simuPOP_muop)
SUMMATION = _simuPOP_muop.SUMMATION

_simuPOP_muop.MULTIPLICATION_swigconstant(_simuPOP_muop)
MULTIPLICATION = _simuPOP_muop.MULTIPLICATION

_simuPOP_muop.PER_ALLELE_swigconstant(_simuPOP_muop)
PER_ALLELE = _simuPOP_muop.PER_ALLELE

_simuPOP_muop.PER_LOCI_swigconstant(_simuPOP_muop)
PER_LOCI = _simuPOP_muop.PER_LOCI

_simuPOP_muop.PER_CHROMOSOME_swigconstant(_simuPOP_muop)
PER_CHROMOSOME = _simuPOP_muop.PER_CHROMOSOME

_simuPOP_muop.PER_PLOIDY_swigconstant(_simuPOP_muop)
PER_PLOIDY = _simuPOP_muop.PER_PLOIDY

_simuPOP_muop.PER_INDIVIDUAL_swigconstant(_simuPOP_muop)
PER_INDIVIDUAL = _simuPOP_muop.PER_INDIVIDUAL

_simuPOP_muop.FROM_INFO_swigconstant(_simuPOP_muop)
FROM_INFO = _simuPOP_muop.FROM_INFO

_simuPOP_muop.FROM_INFO_SIGNED_swigconstant(_simuPOP_muop)
FROM_INFO_SIGNED = _simuPOP_muop.FROM_INFO_SIGNED

_simuPOP_muop.DBG_WARNING_swigconstant(_simuPOP_muop)
...
_simuPOP_muop.UnnamedSubPop_swigconstant(_simuPOP_muop)
UnnamedSubPop = _simuPOP_muop.UnnamedSubPop

_simuPOP_muop.cmp_epsilon_swigconstant(_simuPOP_muop)
...
_simuPOP_muop.HAPLODIPLOID_swigconstant(_simuPOP_muop)
