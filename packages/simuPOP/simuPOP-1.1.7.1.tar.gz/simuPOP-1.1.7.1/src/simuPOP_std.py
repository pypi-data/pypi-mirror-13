...
_simuPOP_std.TR1_SUPPORT_swigconstant(_simuPOP_std)
TR1_SUPPORT = _simuPOP_std.TR1_SUPPORT

_simuPOP_std.THREAFPRIVATE_SUPPORT_swigconstant(_simuPOP_std)
THREAFPRIVATE_SUPPORT = _simuPOP_std.THREAFPRIVATE_SUPPORT

_simuPOP_std.SIZE_T_FORMAT_swigconstant(_simuPOP_std)
SIZE_T_FORMAT = _simuPOP_std.SIZE_T_FORMAT

_simuPOP_std.MALE_swigconstant(_simuPOP_std)
MALE = _simuPOP_std.MALE

_simuPOP_std.FEMALE_swigconstant(_simuPOP_std)
FEMALE = _simuPOP_std.FEMALE

_simuPOP_std.CUSTOMIZED_swigconstant(_simuPOP_std)
CUSTOMIZED = _simuPOP_std.CUSTOMIZED

_simuPOP_std.AUTOSOME_swigconstant(_simuPOP_std)
AUTOSOME = _simuPOP_std.AUTOSOME

_simuPOP_std.CHROMOSOME_X_swigconstant(_simuPOP_std)
CHROMOSOME_X = _simuPOP_std.CHROMOSOME_X

_simuPOP_std.CHROMOSOME_Y_swigconstant(_simuPOP_std)
CHROMOSOME_Y = _simuPOP_std.CHROMOSOME_Y

_simuPOP_std.MITOCHONDRIAL_swigconstant(_simuPOP_std)
MITOCHONDRIAL = _simuPOP_std.MITOCHONDRIAL

_simuPOP_std.CONSTANT_swigconstant(_simuPOP_std)
CONSTANT = _simuPOP_std.CONSTANT

_simuPOP_std.BINOMIAL_DISTRIBUTION_swigconstant(_simuPOP_std)
BINOMIAL_DISTRIBUTION = _simuPOP_std.BINOMIAL_DISTRIBUTION

_simuPOP_std.EXPONENTIAL_DISTRIBUTION_swigconstant(_simuPOP_std)
EXPONENTIAL_DISTRIBUTION = _simuPOP_std.EXPONENTIAL_DISTRIBUTION

_simuPOP_std.GEOMETRIC_DISTRIBUTION_swigconstant(_simuPOP_std)
GEOMETRIC_DISTRIBUTION = _simuPOP_std.GEOMETRIC_DISTRIBUTION

_simuPOP_std.POISSON_DISTRIBUTION_swigconstant(_simuPOP_std)
POISSON_DISTRIBUTION = _simuPOP_std.POISSON_DISTRIBUTION

_simuPOP_std.UNIFORM_DISTRIBUTION_swigconstant(_simuPOP_std)
UNIFORM_DISTRIBUTION = _simuPOP_std.UNIFORM_DISTRIBUTION

_simuPOP_std.NORMAL_DISTRIBUTION_swigconstant(_simuPOP_std)
NORMAL_DISTRIBUTION = _simuPOP_std.NORMAL_DISTRIBUTION

_simuPOP_std.GAMMA_DISTRIBUTION_swigconstant(_simuPOP_std)
GAMMA_DISTRIBUTION = _simuPOP_std.GAMMA_DISTRIBUTION

_simuPOP_std.NO_SEX_swigconstant(_simuPOP_std)
NO_SEX = _simuPOP_std.NO_SEX

_simuPOP_std.RANDOM_SEX_swigconstant(_simuPOP_std)
RANDOM_SEX = _simuPOP_std.RANDOM_SEX

_simuPOP_std.PROB_OF_MALES_swigconstant(_simuPOP_std)
PROB_OF_MALES = _simuPOP_std.PROB_OF_MALES

_simuPOP_std.NUM_OF_MALES_swigconstant(_simuPOP_std)
NUM_OF_MALES = _simuPOP_std.NUM_OF_MALES

_simuPOP_std.NUM_OF_FEMALES_swigconstant(_simuPOP_std)
NUM_OF_FEMALES = _simuPOP_std.NUM_OF_FEMALES

_simuPOP_std.SEQUENCE_OF_SEX_swigconstant(_simuPOP_std)
SEQUENCE_OF_SEX = _simuPOP_std.SEQUENCE_OF_SEX

_simuPOP_std.GLOBAL_SEQUENCE_OF_SEX_swigconstant(_simuPOP_std)
GLOBAL_SEQUENCE_OF_SEX = _simuPOP_std.GLOBAL_SEQUENCE_OF_SEX

_simuPOP_std.NO_CONVERSION_swigconstant(_simuPOP_std)
NO_CONVERSION = _simuPOP_std.NO_CONVERSION

_simuPOP_std.NUM_MARKERS_swigconstant(_simuPOP_std)
NUM_MARKERS = _simuPOP_std.NUM_MARKERS

_simuPOP_std.TRACT_LENGTH_swigconstant(_simuPOP_std)
TRACT_LENGTH = _simuPOP_std.TRACT_LENGTH

_simuPOP_std.OFFSPRING_swigconstant(_simuPOP_std)
OFFSPRING = _simuPOP_std.OFFSPRING

_simuPOP_std.COMMON_OFFSPRING_swigconstant(_simuPOP_std)
COMMON_OFFSPRING = _simuPOP_std.COMMON_OFFSPRING

_simuPOP_std.SPOUSE_swigconstant(_simuPOP_std)
SPOUSE = _simuPOP_std.SPOUSE

_simuPOP_std.OUTBRED_SPOUSE_swigconstant(_simuPOP_std)
OUTBRED_SPOUSE = _simuPOP_std.OUTBRED_SPOUSE

_simuPOP_std.SIBLING_swigconstant(_simuPOP_std)
SIBLING = _simuPOP_std.SIBLING

_simuPOP_std.FULLSIBLING_swigconstant(_simuPOP_std)
FULLSIBLING = _simuPOP_std.FULLSIBLING

_simuPOP_std.ANY_SEX_swigconstant(_simuPOP_std)
ANY_SEX = _simuPOP_std.ANY_SEX

_simuPOP_std.MALE_ONLY_swigconstant(_simuPOP_std)
MALE_ONLY = _simuPOP_std.MALE_ONLY

_simuPOP_std.FEMALE_ONLY_swigconstant(_simuPOP_std)
FEMALE_ONLY = _simuPOP_std.FEMALE_ONLY

_simuPOP_std.SAME_SEX_swigconstant(_simuPOP_std)
SAME_SEX = _simuPOP_std.SAME_SEX

_simuPOP_std.OPPOSITE_SEX_swigconstant(_simuPOP_std)
OPPOSITE_SEX = _simuPOP_std.OPPOSITE_SEX

_simuPOP_std.UNAFFECTED_swigconstant(_simuPOP_std)
UNAFFECTED = _simuPOP_std.UNAFFECTED

_simuPOP_std.AFFECTED_swigconstant(_simuPOP_std)
AFFECTED = _simuPOP_std.AFFECTED

_simuPOP_std.ANY_AFFECTION_STATUS_swigconstant(_simuPOP_std)
ANY_AFFECTION_STATUS = _simuPOP_std.ANY_AFFECTION_STATUS

_simuPOP_std.MULTIPLICATIVE_swigconstant(_simuPOP_std)
MULTIPLICATIVE = _simuPOP_std.MULTIPLICATIVE

_simuPOP_std.ADDITIVE_swigconstant(_simuPOP_std)
ADDITIVE = _simuPOP_std.ADDITIVE

_simuPOP_std.HETEROGENEITY_swigconstant(_simuPOP_std)
HETEROGENEITY = _simuPOP_std.HETEROGENEITY

_simuPOP_std.EXPONENTIAL_swigconstant(_simuPOP_std)
EXPONENTIAL = _simuPOP_std.EXPONENTIAL

_simuPOP_std.BY_IND_INFO_swigconstant(_simuPOP_std)
BY_IND_INFO = _simuPOP_std.BY_IND_INFO

_simuPOP_std.BY_PROBABILITY_swigconstant(_simuPOP_std)
BY_PROBABILITY = _simuPOP_std.BY_PROBABILITY

_simuPOP_std.BY_PROPORTION_swigconstant(_simuPOP_std)
BY_PROPORTION = _simuPOP_std.BY_PROPORTION

_simuPOP_std.BY_COUNTS_swigconstant(_simuPOP_std)
BY_COUNTS = _simuPOP_std.BY_COUNTS

_simuPOP_std.PATERNAL_swigconstant(_simuPOP_std)
PATERNAL = _simuPOP_std.PATERNAL

_simuPOP_std.MATERNAL_swigconstant(_simuPOP_std)
MATERNAL = _simuPOP_std.MATERNAL

_simuPOP_std.MEAN_swigconstant(_simuPOP_std)
MEAN = _simuPOP_std.MEAN

_simuPOP_std.MAXIMUM_swigconstant(_simuPOP_std)
MAXIMUM = _simuPOP_std.MAXIMUM

_simuPOP_std.MINIMUM_swigconstant(_simuPOP_std)
MINIMUM = _simuPOP_std.MINIMUM

_simuPOP_std.SUMMATION_swigconstant(_simuPOP_std)
SUMMATION = _simuPOP_std.SUMMATION

_simuPOP_std.MULTIPLICATION_swigconstant(_simuPOP_std)
MULTIPLICATION = _simuPOP_std.MULTIPLICATION

_simuPOP_std.PER_ALLELE_swigconstant(_simuPOP_std)
PER_ALLELE = _simuPOP_std.PER_ALLELE

_simuPOP_std.PER_LOCI_swigconstant(_simuPOP_std)
PER_LOCI = _simuPOP_std.PER_LOCI

_simuPOP_std.PER_CHROMOSOME_swigconstant(_simuPOP_std)
PER_CHROMOSOME = _simuPOP_std.PER_CHROMOSOME

_simuPOP_std.PER_PLOIDY_swigconstant(_simuPOP_std)
PER_PLOIDY = _simuPOP_std.PER_PLOIDY

_simuPOP_std.PER_INDIVIDUAL_swigconstant(_simuPOP_std)
PER_INDIVIDUAL = _simuPOP_std.PER_INDIVIDUAL

_simuPOP_std.FROM_INFO_swigconstant(_simuPOP_std)
FROM_INFO = _simuPOP_std.FROM_INFO

_simuPOP_std.FROM_INFO_SIGNED_swigconstant(_simuPOP_std)
FROM_INFO_SIGNED = _simuPOP_std.FROM_INFO_SIGNED

_simuPOP_std.DBG_WARNING_swigconstant(_simuPOP_std)
...
_simuPOP_std.UnnamedSubPop_swigconstant(_simuPOP_std)
UnnamedSubPop = _simuPOP_std.UnnamedSubPop

_simuPOP_std.cmp_epsilon_swigconstant(_simuPOP_std)
...
_simuPOP_std.HAPLODIPLOID_swigconstant(_simuPOP_std)
