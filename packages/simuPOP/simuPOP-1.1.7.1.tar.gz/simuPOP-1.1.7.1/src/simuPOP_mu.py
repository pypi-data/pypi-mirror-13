...
_simuPOP_mu.TR1_SUPPORT_swigconstant(_simuPOP_mu)
TR1_SUPPORT = _simuPOP_mu.TR1_SUPPORT

_simuPOP_mu.THREAFPRIVATE_SUPPORT_swigconstant(_simuPOP_mu)
THREAFPRIVATE_SUPPORT = _simuPOP_mu.THREAFPRIVATE_SUPPORT

_simuPOP_mu.SIZE_T_FORMAT_swigconstant(_simuPOP_mu)
SIZE_T_FORMAT = _simuPOP_mu.SIZE_T_FORMAT

_simuPOP_mu.MALE_swigconstant(_simuPOP_mu)
MALE = _simuPOP_mu.MALE

_simuPOP_mu.FEMALE_swigconstant(_simuPOP_mu)
FEMALE = _simuPOP_mu.FEMALE

_simuPOP_mu.CUSTOMIZED_swigconstant(_simuPOP_mu)
CUSTOMIZED = _simuPOP_mu.CUSTOMIZED

_simuPOP_mu.AUTOSOME_swigconstant(_simuPOP_mu)
AUTOSOME = _simuPOP_mu.AUTOSOME

_simuPOP_mu.CHROMOSOME_X_swigconstant(_simuPOP_mu)
CHROMOSOME_X = _simuPOP_mu.CHROMOSOME_X

_simuPOP_mu.CHROMOSOME_Y_swigconstant(_simuPOP_mu)
CHROMOSOME_Y = _simuPOP_mu.CHROMOSOME_Y

_simuPOP_mu.MITOCHONDRIAL_swigconstant(_simuPOP_mu)
MITOCHONDRIAL = _simuPOP_mu.MITOCHONDRIAL

_simuPOP_mu.CONSTANT_swigconstant(_simuPOP_mu)
CONSTANT = _simuPOP_mu.CONSTANT

_simuPOP_mu.BINOMIAL_DISTRIBUTION_swigconstant(_simuPOP_mu)
BINOMIAL_DISTRIBUTION = _simuPOP_mu.BINOMIAL_DISTRIBUTION

_simuPOP_mu.EXPONENTIAL_DISTRIBUTION_swigconstant(_simuPOP_mu)
EXPONENTIAL_DISTRIBUTION = _simuPOP_mu.EXPONENTIAL_DISTRIBUTION

_simuPOP_mu.GEOMETRIC_DISTRIBUTION_swigconstant(_simuPOP_mu)
GEOMETRIC_DISTRIBUTION = _simuPOP_mu.GEOMETRIC_DISTRIBUTION

_simuPOP_mu.POISSON_DISTRIBUTION_swigconstant(_simuPOP_mu)
POISSON_DISTRIBUTION = _simuPOP_mu.POISSON_DISTRIBUTION

_simuPOP_mu.UNIFORM_DISTRIBUTION_swigconstant(_simuPOP_mu)
UNIFORM_DISTRIBUTION = _simuPOP_mu.UNIFORM_DISTRIBUTION

_simuPOP_mu.NORMAL_DISTRIBUTION_swigconstant(_simuPOP_mu)
NORMAL_DISTRIBUTION = _simuPOP_mu.NORMAL_DISTRIBUTION

_simuPOP_mu.GAMMA_DISTRIBUTION_swigconstant(_simuPOP_mu)
GAMMA_DISTRIBUTION = _simuPOP_mu.GAMMA_DISTRIBUTION

_simuPOP_mu.NO_SEX_swigconstant(_simuPOP_mu)
NO_SEX = _simuPOP_mu.NO_SEX

_simuPOP_mu.RANDOM_SEX_swigconstant(_simuPOP_mu)
RANDOM_SEX = _simuPOP_mu.RANDOM_SEX

_simuPOP_mu.PROB_OF_MALES_swigconstant(_simuPOP_mu)
PROB_OF_MALES = _simuPOP_mu.PROB_OF_MALES

_simuPOP_mu.NUM_OF_MALES_swigconstant(_simuPOP_mu)
NUM_OF_MALES = _simuPOP_mu.NUM_OF_MALES

_simuPOP_mu.NUM_OF_FEMALES_swigconstant(_simuPOP_mu)
NUM_OF_FEMALES = _simuPOP_mu.NUM_OF_FEMALES

_simuPOP_mu.SEQUENCE_OF_SEX_swigconstant(_simuPOP_mu)
SEQUENCE_OF_SEX = _simuPOP_mu.SEQUENCE_OF_SEX

_simuPOP_mu.GLOBAL_SEQUENCE_OF_SEX_swigconstant(_simuPOP_mu)
GLOBAL_SEQUENCE_OF_SEX = _simuPOP_mu.GLOBAL_SEQUENCE_OF_SEX

_simuPOP_mu.NO_CONVERSION_swigconstant(_simuPOP_mu)
NO_CONVERSION = _simuPOP_mu.NO_CONVERSION

_simuPOP_mu.NUM_MARKERS_swigconstant(_simuPOP_mu)
NUM_MARKERS = _simuPOP_mu.NUM_MARKERS

_simuPOP_mu.TRACT_LENGTH_swigconstant(_simuPOP_mu)
TRACT_LENGTH = _simuPOP_mu.TRACT_LENGTH

_simuPOP_mu.OFFSPRING_swigconstant(_simuPOP_mu)
OFFSPRING = _simuPOP_mu.OFFSPRING

_simuPOP_mu.COMMON_OFFSPRING_swigconstant(_simuPOP_mu)
COMMON_OFFSPRING = _simuPOP_mu.COMMON_OFFSPRING

_simuPOP_mu.SPOUSE_swigconstant(_simuPOP_mu)
SPOUSE = _simuPOP_mu.SPOUSE

_simuPOP_mu.OUTBRED_SPOUSE_swigconstant(_simuPOP_mu)
OUTBRED_SPOUSE = _simuPOP_mu.OUTBRED_SPOUSE

_simuPOP_mu.SIBLING_swigconstant(_simuPOP_mu)
SIBLING = _simuPOP_mu.SIBLING

_simuPOP_mu.FULLSIBLING_swigconstant(_simuPOP_mu)
FULLSIBLING = _simuPOP_mu.FULLSIBLING

_simuPOP_mu.ANY_SEX_swigconstant(_simuPOP_mu)
ANY_SEX = _simuPOP_mu.ANY_SEX

_simuPOP_mu.MALE_ONLY_swigconstant(_simuPOP_mu)
MALE_ONLY = _simuPOP_mu.MALE_ONLY

_simuPOP_mu.FEMALE_ONLY_swigconstant(_simuPOP_mu)
FEMALE_ONLY = _simuPOP_mu.FEMALE_ONLY

_simuPOP_mu.SAME_SEX_swigconstant(_simuPOP_mu)
SAME_SEX = _simuPOP_mu.SAME_SEX

_simuPOP_mu.OPPOSITE_SEX_swigconstant(_simuPOP_mu)
OPPOSITE_SEX = _simuPOP_mu.OPPOSITE_SEX

_simuPOP_mu.UNAFFECTED_swigconstant(_simuPOP_mu)
UNAFFECTED = _simuPOP_mu.UNAFFECTED

_simuPOP_mu.AFFECTED_swigconstant(_simuPOP_mu)
AFFECTED = _simuPOP_mu.AFFECTED

_simuPOP_mu.ANY_AFFECTION_STATUS_swigconstant(_simuPOP_mu)
ANY_AFFECTION_STATUS = _simuPOP_mu.ANY_AFFECTION_STATUS

_simuPOP_mu.MULTIPLICATIVE_swigconstant(_simuPOP_mu)
MULTIPLICATIVE = _simuPOP_mu.MULTIPLICATIVE

_simuPOP_mu.ADDITIVE_swigconstant(_simuPOP_mu)
ADDITIVE = _simuPOP_mu.ADDITIVE

_simuPOP_mu.HETEROGENEITY_swigconstant(_simuPOP_mu)
HETEROGENEITY = _simuPOP_mu.HETEROGENEITY

_simuPOP_mu.EXPONENTIAL_swigconstant(_simuPOP_mu)
EXPONENTIAL = _simuPOP_mu.EXPONENTIAL

_simuPOP_mu.BY_IND_INFO_swigconstant(_simuPOP_mu)
BY_IND_INFO = _simuPOP_mu.BY_IND_INFO

_simuPOP_mu.BY_PROBABILITY_swigconstant(_simuPOP_mu)
BY_PROBABILITY = _simuPOP_mu.BY_PROBABILITY

_simuPOP_mu.BY_PROPORTION_swigconstant(_simuPOP_mu)
BY_PROPORTION = _simuPOP_mu.BY_PROPORTION

_simuPOP_mu.BY_COUNTS_swigconstant(_simuPOP_mu)
BY_COUNTS = _simuPOP_mu.BY_COUNTS

_simuPOP_mu.PATERNAL_swigconstant(_simuPOP_mu)
PATERNAL = _simuPOP_mu.PATERNAL

_simuPOP_mu.MATERNAL_swigconstant(_simuPOP_mu)
MATERNAL = _simuPOP_mu.MATERNAL

_simuPOP_mu.MEAN_swigconstant(_simuPOP_mu)
MEAN = _simuPOP_mu.MEAN

_simuPOP_mu.MAXIMUM_swigconstant(_simuPOP_mu)
MAXIMUM = _simuPOP_mu.MAXIMUM

_simuPOP_mu.MINIMUM_swigconstant(_simuPOP_mu)
MINIMUM = _simuPOP_mu.MINIMUM

_simuPOP_mu.SUMMATION_swigconstant(_simuPOP_mu)
SUMMATION = _simuPOP_mu.SUMMATION

_simuPOP_mu.MULTIPLICATION_swigconstant(_simuPOP_mu)
MULTIPLICATION = _simuPOP_mu.MULTIPLICATION

_simuPOP_mu.PER_ALLELE_swigconstant(_simuPOP_mu)
PER_ALLELE = _simuPOP_mu.PER_ALLELE

_simuPOP_mu.PER_LOCI_swigconstant(_simuPOP_mu)
PER_LOCI = _simuPOP_mu.PER_LOCI

_simuPOP_mu.PER_CHROMOSOME_swigconstant(_simuPOP_mu)
PER_CHROMOSOME = _simuPOP_mu.PER_CHROMOSOME

_simuPOP_mu.PER_PLOIDY_swigconstant(_simuPOP_mu)
PER_PLOIDY = _simuPOP_mu.PER_PLOIDY

_simuPOP_mu.PER_INDIVIDUAL_swigconstant(_simuPOP_mu)
PER_INDIVIDUAL = _simuPOP_mu.PER_INDIVIDUAL

_simuPOP_mu.FROM_INFO_swigconstant(_simuPOP_mu)
FROM_INFO = _simuPOP_mu.FROM_INFO

_simuPOP_mu.FROM_INFO_SIGNED_swigconstant(_simuPOP_mu)
FROM_INFO_SIGNED = _simuPOP_mu.FROM_INFO_SIGNED

_simuPOP_mu.DBG_WARNING_swigconstant(_simuPOP_mu)
...
_simuPOP_mu.UnnamedSubPop_swigconstant(_simuPOP_mu)
UnnamedSubPop = _simuPOP_mu.UnnamedSubPop

_simuPOP_mu.cmp_epsilon_swigconstant(_simuPOP_mu)
...
_simuPOP_mu.HAPLODIPLOID_swigconstant(_simuPOP_mu)
