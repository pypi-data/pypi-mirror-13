...
_simuPOP_op.TR1_SUPPORT_swigconstant(_simuPOP_op)
TR1_SUPPORT = _simuPOP_op.TR1_SUPPORT

_simuPOP_op.THREAFPRIVATE_SUPPORT_swigconstant(_simuPOP_op)
THREAFPRIVATE_SUPPORT = _simuPOP_op.THREAFPRIVATE_SUPPORT

_simuPOP_op.SIZE_T_FORMAT_swigconstant(_simuPOP_op)
SIZE_T_FORMAT = _simuPOP_op.SIZE_T_FORMAT

_simuPOP_op.MALE_swigconstant(_simuPOP_op)
MALE = _simuPOP_op.MALE

_simuPOP_op.FEMALE_swigconstant(_simuPOP_op)
FEMALE = _simuPOP_op.FEMALE

_simuPOP_op.CUSTOMIZED_swigconstant(_simuPOP_op)
CUSTOMIZED = _simuPOP_op.CUSTOMIZED

_simuPOP_op.AUTOSOME_swigconstant(_simuPOP_op)
AUTOSOME = _simuPOP_op.AUTOSOME

_simuPOP_op.CHROMOSOME_X_swigconstant(_simuPOP_op)
CHROMOSOME_X = _simuPOP_op.CHROMOSOME_X

_simuPOP_op.CHROMOSOME_Y_swigconstant(_simuPOP_op)
CHROMOSOME_Y = _simuPOP_op.CHROMOSOME_Y

_simuPOP_op.MITOCHONDRIAL_swigconstant(_simuPOP_op)
MITOCHONDRIAL = _simuPOP_op.MITOCHONDRIAL

_simuPOP_op.CONSTANT_swigconstant(_simuPOP_op)
CONSTANT = _simuPOP_op.CONSTANT

_simuPOP_op.BINOMIAL_DISTRIBUTION_swigconstant(_simuPOP_op)
BINOMIAL_DISTRIBUTION = _simuPOP_op.BINOMIAL_DISTRIBUTION

_simuPOP_op.EXPONENTIAL_DISTRIBUTION_swigconstant(_simuPOP_op)
EXPONENTIAL_DISTRIBUTION = _simuPOP_op.EXPONENTIAL_DISTRIBUTION

_simuPOP_op.GEOMETRIC_DISTRIBUTION_swigconstant(_simuPOP_op)
GEOMETRIC_DISTRIBUTION = _simuPOP_op.GEOMETRIC_DISTRIBUTION

_simuPOP_op.POISSON_DISTRIBUTION_swigconstant(_simuPOP_op)
POISSON_DISTRIBUTION = _simuPOP_op.POISSON_DISTRIBUTION

_simuPOP_op.UNIFORM_DISTRIBUTION_swigconstant(_simuPOP_op)
UNIFORM_DISTRIBUTION = _simuPOP_op.UNIFORM_DISTRIBUTION

_simuPOP_op.NORMAL_DISTRIBUTION_swigconstant(_simuPOP_op)
NORMAL_DISTRIBUTION = _simuPOP_op.NORMAL_DISTRIBUTION

_simuPOP_op.GAMMA_DISTRIBUTION_swigconstant(_simuPOP_op)
GAMMA_DISTRIBUTION = _simuPOP_op.GAMMA_DISTRIBUTION

_simuPOP_op.NO_SEX_swigconstant(_simuPOP_op)
NO_SEX = _simuPOP_op.NO_SEX

_simuPOP_op.RANDOM_SEX_swigconstant(_simuPOP_op)
RANDOM_SEX = _simuPOP_op.RANDOM_SEX

_simuPOP_op.PROB_OF_MALES_swigconstant(_simuPOP_op)
PROB_OF_MALES = _simuPOP_op.PROB_OF_MALES

_simuPOP_op.NUM_OF_MALES_swigconstant(_simuPOP_op)
NUM_OF_MALES = _simuPOP_op.NUM_OF_MALES

_simuPOP_op.NUM_OF_FEMALES_swigconstant(_simuPOP_op)
NUM_OF_FEMALES = _simuPOP_op.NUM_OF_FEMALES

_simuPOP_op.SEQUENCE_OF_SEX_swigconstant(_simuPOP_op)
SEQUENCE_OF_SEX = _simuPOP_op.SEQUENCE_OF_SEX

_simuPOP_op.GLOBAL_SEQUENCE_OF_SEX_swigconstant(_simuPOP_op)
GLOBAL_SEQUENCE_OF_SEX = _simuPOP_op.GLOBAL_SEQUENCE_OF_SEX

_simuPOP_op.NO_CONVERSION_swigconstant(_simuPOP_op)
NO_CONVERSION = _simuPOP_op.NO_CONVERSION

_simuPOP_op.NUM_MARKERS_swigconstant(_simuPOP_op)
NUM_MARKERS = _simuPOP_op.NUM_MARKERS

_simuPOP_op.TRACT_LENGTH_swigconstant(_simuPOP_op)
TRACT_LENGTH = _simuPOP_op.TRACT_LENGTH

_simuPOP_op.OFFSPRING_swigconstant(_simuPOP_op)
OFFSPRING = _simuPOP_op.OFFSPRING

_simuPOP_op.COMMON_OFFSPRING_swigconstant(_simuPOP_op)
COMMON_OFFSPRING = _simuPOP_op.COMMON_OFFSPRING

_simuPOP_op.SPOUSE_swigconstant(_simuPOP_op)
SPOUSE = _simuPOP_op.SPOUSE

_simuPOP_op.OUTBRED_SPOUSE_swigconstant(_simuPOP_op)
OUTBRED_SPOUSE = _simuPOP_op.OUTBRED_SPOUSE

_simuPOP_op.SIBLING_swigconstant(_simuPOP_op)
SIBLING = _simuPOP_op.SIBLING

_simuPOP_op.FULLSIBLING_swigconstant(_simuPOP_op)
FULLSIBLING = _simuPOP_op.FULLSIBLING

_simuPOP_op.ANY_SEX_swigconstant(_simuPOP_op)
ANY_SEX = _simuPOP_op.ANY_SEX

_simuPOP_op.MALE_ONLY_swigconstant(_simuPOP_op)
MALE_ONLY = _simuPOP_op.MALE_ONLY

_simuPOP_op.FEMALE_ONLY_swigconstant(_simuPOP_op)
FEMALE_ONLY = _simuPOP_op.FEMALE_ONLY

_simuPOP_op.SAME_SEX_swigconstant(_simuPOP_op)
SAME_SEX = _simuPOP_op.SAME_SEX

_simuPOP_op.OPPOSITE_SEX_swigconstant(_simuPOP_op)
OPPOSITE_SEX = _simuPOP_op.OPPOSITE_SEX

_simuPOP_op.UNAFFECTED_swigconstant(_simuPOP_op)
UNAFFECTED = _simuPOP_op.UNAFFECTED

_simuPOP_op.AFFECTED_swigconstant(_simuPOP_op)
AFFECTED = _simuPOP_op.AFFECTED

_simuPOP_op.ANY_AFFECTION_STATUS_swigconstant(_simuPOP_op)
ANY_AFFECTION_STATUS = _simuPOP_op.ANY_AFFECTION_STATUS

_simuPOP_op.MULTIPLICATIVE_swigconstant(_simuPOP_op)
MULTIPLICATIVE = _simuPOP_op.MULTIPLICATIVE

_simuPOP_op.ADDITIVE_swigconstant(_simuPOP_op)
ADDITIVE = _simuPOP_op.ADDITIVE

_simuPOP_op.HETEROGENEITY_swigconstant(_simuPOP_op)
HETEROGENEITY = _simuPOP_op.HETEROGENEITY

_simuPOP_op.EXPONENTIAL_swigconstant(_simuPOP_op)
EXPONENTIAL = _simuPOP_op.EXPONENTIAL

_simuPOP_op.BY_IND_INFO_swigconstant(_simuPOP_op)
BY_IND_INFO = _simuPOP_op.BY_IND_INFO

_simuPOP_op.BY_PROBABILITY_swigconstant(_simuPOP_op)
BY_PROBABILITY = _simuPOP_op.BY_PROBABILITY

_simuPOP_op.BY_PROPORTION_swigconstant(_simuPOP_op)
BY_PROPORTION = _simuPOP_op.BY_PROPORTION

_simuPOP_op.BY_COUNTS_swigconstant(_simuPOP_op)
BY_COUNTS = _simuPOP_op.BY_COUNTS

_simuPOP_op.PATERNAL_swigconstant(_simuPOP_op)
PATERNAL = _simuPOP_op.PATERNAL

_simuPOP_op.MATERNAL_swigconstant(_simuPOP_op)
MATERNAL = _simuPOP_op.MATERNAL

_simuPOP_op.MEAN_swigconstant(_simuPOP_op)
MEAN = _simuPOP_op.MEAN

_simuPOP_op.MAXIMUM_swigconstant(_simuPOP_op)
MAXIMUM = _simuPOP_op.MAXIMUM

_simuPOP_op.MINIMUM_swigconstant(_simuPOP_op)
MINIMUM = _simuPOP_op.MINIMUM

_simuPOP_op.SUMMATION_swigconstant(_simuPOP_op)
SUMMATION = _simuPOP_op.SUMMATION

_simuPOP_op.MULTIPLICATION_swigconstant(_simuPOP_op)
MULTIPLICATION = _simuPOP_op.MULTIPLICATION

_simuPOP_op.PER_ALLELE_swigconstant(_simuPOP_op)
PER_ALLELE = _simuPOP_op.PER_ALLELE

_simuPOP_op.PER_LOCI_swigconstant(_simuPOP_op)
PER_LOCI = _simuPOP_op.PER_LOCI

_simuPOP_op.PER_CHROMOSOME_swigconstant(_simuPOP_op)
PER_CHROMOSOME = _simuPOP_op.PER_CHROMOSOME

_simuPOP_op.PER_PLOIDY_swigconstant(_simuPOP_op)
PER_PLOIDY = _simuPOP_op.PER_PLOIDY

_simuPOP_op.PER_INDIVIDUAL_swigconstant(_simuPOP_op)
PER_INDIVIDUAL = _simuPOP_op.PER_INDIVIDUAL

_simuPOP_op.FROM_INFO_swigconstant(_simuPOP_op)
FROM_INFO = _simuPOP_op.FROM_INFO

_simuPOP_op.FROM_INFO_SIGNED_swigconstant(_simuPOP_op)
FROM_INFO_SIGNED = _simuPOP_op.FROM_INFO_SIGNED

_simuPOP_op.DBG_WARNING_swigconstant(_simuPOP_op)
...
_simuPOP_op.UnnamedSubPop_swigconstant(_simuPOP_op)
UnnamedSubPop = _simuPOP_op.UnnamedSubPop

_simuPOP_op.cmp_epsilon_swigconstant(_simuPOP_op)
...
_simuPOP_op.HAPLODIPLOID_swigconstant(_simuPOP_op)
