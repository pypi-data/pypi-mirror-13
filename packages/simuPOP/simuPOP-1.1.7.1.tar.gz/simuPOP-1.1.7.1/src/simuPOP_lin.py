...
_simuPOP_lin.TR1_SUPPORT_swigconstant(_simuPOP_lin)
TR1_SUPPORT = _simuPOP_lin.TR1_SUPPORT

_simuPOP_lin.THREAFPRIVATE_SUPPORT_swigconstant(_simuPOP_lin)
THREAFPRIVATE_SUPPORT = _simuPOP_lin.THREAFPRIVATE_SUPPORT

_simuPOP_lin.SIZE_T_FORMAT_swigconstant(_simuPOP_lin)
SIZE_T_FORMAT = _simuPOP_lin.SIZE_T_FORMAT

_simuPOP_lin.MALE_swigconstant(_simuPOP_lin)
MALE = _simuPOP_lin.MALE

_simuPOP_lin.FEMALE_swigconstant(_simuPOP_lin)
FEMALE = _simuPOP_lin.FEMALE

_simuPOP_lin.CUSTOMIZED_swigconstant(_simuPOP_lin)
CUSTOMIZED = _simuPOP_lin.CUSTOMIZED

_simuPOP_lin.AUTOSOME_swigconstant(_simuPOP_lin)
AUTOSOME = _simuPOP_lin.AUTOSOME

_simuPOP_lin.CHROMOSOME_X_swigconstant(_simuPOP_lin)
CHROMOSOME_X = _simuPOP_lin.CHROMOSOME_X

_simuPOP_lin.CHROMOSOME_Y_swigconstant(_simuPOP_lin)
CHROMOSOME_Y = _simuPOP_lin.CHROMOSOME_Y

_simuPOP_lin.MITOCHONDRIAL_swigconstant(_simuPOP_lin)
MITOCHONDRIAL = _simuPOP_lin.MITOCHONDRIAL

_simuPOP_lin.CONSTANT_swigconstant(_simuPOP_lin)
CONSTANT = _simuPOP_lin.CONSTANT

_simuPOP_lin.BINOMIAL_DISTRIBUTION_swigconstant(_simuPOP_lin)
BINOMIAL_DISTRIBUTION = _simuPOP_lin.BINOMIAL_DISTRIBUTION

_simuPOP_lin.EXPONENTIAL_DISTRIBUTION_swigconstant(_simuPOP_lin)
EXPONENTIAL_DISTRIBUTION = _simuPOP_lin.EXPONENTIAL_DISTRIBUTION

_simuPOP_lin.GEOMETRIC_DISTRIBUTION_swigconstant(_simuPOP_lin)
GEOMETRIC_DISTRIBUTION = _simuPOP_lin.GEOMETRIC_DISTRIBUTION

_simuPOP_lin.POISSON_DISTRIBUTION_swigconstant(_simuPOP_lin)
POISSON_DISTRIBUTION = _simuPOP_lin.POISSON_DISTRIBUTION

_simuPOP_lin.UNIFORM_DISTRIBUTION_swigconstant(_simuPOP_lin)
UNIFORM_DISTRIBUTION = _simuPOP_lin.UNIFORM_DISTRIBUTION

_simuPOP_lin.NORMAL_DISTRIBUTION_swigconstant(_simuPOP_lin)
NORMAL_DISTRIBUTION = _simuPOP_lin.NORMAL_DISTRIBUTION

_simuPOP_lin.GAMMA_DISTRIBUTION_swigconstant(_simuPOP_lin)
GAMMA_DISTRIBUTION = _simuPOP_lin.GAMMA_DISTRIBUTION

_simuPOP_lin.NO_SEX_swigconstant(_simuPOP_lin)
NO_SEX = _simuPOP_lin.NO_SEX

_simuPOP_lin.RANDOM_SEX_swigconstant(_simuPOP_lin)
RANDOM_SEX = _simuPOP_lin.RANDOM_SEX

_simuPOP_lin.PROB_OF_MALES_swigconstant(_simuPOP_lin)
PROB_OF_MALES = _simuPOP_lin.PROB_OF_MALES

_simuPOP_lin.NUM_OF_MALES_swigconstant(_simuPOP_lin)
NUM_OF_MALES = _simuPOP_lin.NUM_OF_MALES

_simuPOP_lin.NUM_OF_FEMALES_swigconstant(_simuPOP_lin)
NUM_OF_FEMALES = _simuPOP_lin.NUM_OF_FEMALES

_simuPOP_lin.SEQUENCE_OF_SEX_swigconstant(_simuPOP_lin)
SEQUENCE_OF_SEX = _simuPOP_lin.SEQUENCE_OF_SEX

_simuPOP_lin.GLOBAL_SEQUENCE_OF_SEX_swigconstant(_simuPOP_lin)
GLOBAL_SEQUENCE_OF_SEX = _simuPOP_lin.GLOBAL_SEQUENCE_OF_SEX

_simuPOP_lin.NO_CONVERSION_swigconstant(_simuPOP_lin)
NO_CONVERSION = _simuPOP_lin.NO_CONVERSION

_simuPOP_lin.NUM_MARKERS_swigconstant(_simuPOP_lin)
NUM_MARKERS = _simuPOP_lin.NUM_MARKERS

_simuPOP_lin.TRACT_LENGTH_swigconstant(_simuPOP_lin)
TRACT_LENGTH = _simuPOP_lin.TRACT_LENGTH

_simuPOP_lin.OFFSPRING_swigconstant(_simuPOP_lin)
OFFSPRING = _simuPOP_lin.OFFSPRING

_simuPOP_lin.COMMON_OFFSPRING_swigconstant(_simuPOP_lin)
COMMON_OFFSPRING = _simuPOP_lin.COMMON_OFFSPRING

_simuPOP_lin.SPOUSE_swigconstant(_simuPOP_lin)
SPOUSE = _simuPOP_lin.SPOUSE

_simuPOP_lin.OUTBRED_SPOUSE_swigconstant(_simuPOP_lin)
OUTBRED_SPOUSE = _simuPOP_lin.OUTBRED_SPOUSE

_simuPOP_lin.SIBLING_swigconstant(_simuPOP_lin)
SIBLING = _simuPOP_lin.SIBLING

_simuPOP_lin.FULLSIBLING_swigconstant(_simuPOP_lin)
FULLSIBLING = _simuPOP_lin.FULLSIBLING

_simuPOP_lin.ANY_SEX_swigconstant(_simuPOP_lin)
ANY_SEX = _simuPOP_lin.ANY_SEX

_simuPOP_lin.MALE_ONLY_swigconstant(_simuPOP_lin)
MALE_ONLY = _simuPOP_lin.MALE_ONLY

_simuPOP_lin.FEMALE_ONLY_swigconstant(_simuPOP_lin)
FEMALE_ONLY = _simuPOP_lin.FEMALE_ONLY

_simuPOP_lin.SAME_SEX_swigconstant(_simuPOP_lin)
SAME_SEX = _simuPOP_lin.SAME_SEX

_simuPOP_lin.OPPOSITE_SEX_swigconstant(_simuPOP_lin)
OPPOSITE_SEX = _simuPOP_lin.OPPOSITE_SEX

_simuPOP_lin.UNAFFECTED_swigconstant(_simuPOP_lin)
UNAFFECTED = _simuPOP_lin.UNAFFECTED

_simuPOP_lin.AFFECTED_swigconstant(_simuPOP_lin)
AFFECTED = _simuPOP_lin.AFFECTED

_simuPOP_lin.ANY_AFFECTION_STATUS_swigconstant(_simuPOP_lin)
ANY_AFFECTION_STATUS = _simuPOP_lin.ANY_AFFECTION_STATUS

_simuPOP_lin.MULTIPLICATIVE_swigconstant(_simuPOP_lin)
MULTIPLICATIVE = _simuPOP_lin.MULTIPLICATIVE

_simuPOP_lin.ADDITIVE_swigconstant(_simuPOP_lin)
ADDITIVE = _simuPOP_lin.ADDITIVE

_simuPOP_lin.HETEROGENEITY_swigconstant(_simuPOP_lin)
HETEROGENEITY = _simuPOP_lin.HETEROGENEITY

_simuPOP_lin.EXPONENTIAL_swigconstant(_simuPOP_lin)
EXPONENTIAL = _simuPOP_lin.EXPONENTIAL

_simuPOP_lin.BY_IND_INFO_swigconstant(_simuPOP_lin)
BY_IND_INFO = _simuPOP_lin.BY_IND_INFO

_simuPOP_lin.BY_PROBABILITY_swigconstant(_simuPOP_lin)
BY_PROBABILITY = _simuPOP_lin.BY_PROBABILITY

_simuPOP_lin.BY_PROPORTION_swigconstant(_simuPOP_lin)
BY_PROPORTION = _simuPOP_lin.BY_PROPORTION

_simuPOP_lin.BY_COUNTS_swigconstant(_simuPOP_lin)
BY_COUNTS = _simuPOP_lin.BY_COUNTS

_simuPOP_lin.PATERNAL_swigconstant(_simuPOP_lin)
PATERNAL = _simuPOP_lin.PATERNAL

_simuPOP_lin.MATERNAL_swigconstant(_simuPOP_lin)
MATERNAL = _simuPOP_lin.MATERNAL

_simuPOP_lin.MEAN_swigconstant(_simuPOP_lin)
MEAN = _simuPOP_lin.MEAN

_simuPOP_lin.MAXIMUM_swigconstant(_simuPOP_lin)
MAXIMUM = _simuPOP_lin.MAXIMUM

_simuPOP_lin.MINIMUM_swigconstant(_simuPOP_lin)
MINIMUM = _simuPOP_lin.MINIMUM

_simuPOP_lin.SUMMATION_swigconstant(_simuPOP_lin)
SUMMATION = _simuPOP_lin.SUMMATION

_simuPOP_lin.MULTIPLICATION_swigconstant(_simuPOP_lin)
MULTIPLICATION = _simuPOP_lin.MULTIPLICATION

_simuPOP_lin.PER_ALLELE_swigconstant(_simuPOP_lin)
PER_ALLELE = _simuPOP_lin.PER_ALLELE

_simuPOP_lin.PER_LOCI_swigconstant(_simuPOP_lin)
PER_LOCI = _simuPOP_lin.PER_LOCI

_simuPOP_lin.PER_CHROMOSOME_swigconstant(_simuPOP_lin)
PER_CHROMOSOME = _simuPOP_lin.PER_CHROMOSOME

_simuPOP_lin.PER_PLOIDY_swigconstant(_simuPOP_lin)
PER_PLOIDY = _simuPOP_lin.PER_PLOIDY

_simuPOP_lin.PER_INDIVIDUAL_swigconstant(_simuPOP_lin)
PER_INDIVIDUAL = _simuPOP_lin.PER_INDIVIDUAL

_simuPOP_lin.FROM_INFO_swigconstant(_simuPOP_lin)
FROM_INFO = _simuPOP_lin.FROM_INFO

_simuPOP_lin.FROM_INFO_SIGNED_swigconstant(_simuPOP_lin)
FROM_INFO_SIGNED = _simuPOP_lin.FROM_INFO_SIGNED

_simuPOP_lin.DBG_WARNING_swigconstant(_simuPOP_lin)
...
_simuPOP_lin.UnnamedSubPop_swigconstant(_simuPOP_lin)
UnnamedSubPop = _simuPOP_lin.UnnamedSubPop

_simuPOP_lin.cmp_epsilon_swigconstant(_simuPOP_lin)
...
_simuPOP_lin.HAPLODIPLOID_swigconstant(_simuPOP_lin)
