...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.comboBox_2 = QtWidgets.QComboBox(self.scan)
        ...
        self.browse = QtWidgets.QPushButton(self.direct)
        self.browse.setObjectName("browse")
        self.horizontalLayout_5.addWidget(self.browse)
        self.direct_scan = QtWidgets.QPushButton(self.direct)
        self.direct_scan.setObjectName("direct_scan")
        self.horizontalLayout_5.addWidget(self.direct_scan)
        ...
        self.plainTextEdit_2.setPlainText("Format conseiller:\n"
"Documents/<entreprise> - <personne> - <N° client>/<categorie>/<nom> - <data> - <N° page>")
        ...
        self.config_yaml = QtWidgets.QPlainTextEdit(self.config)
        self.config_yaml.setObjectName("config_yaml")
        self.verticalLayout_3.addWidget(self.config_yaml)
        self.buttonBox = QtWidgets.QDialogButtonBox(self.config)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "EPaper - Simple and Productive Personal Documents Library"))
        ...
        self.direct_scan.setText(_translate("MainWindow", "Scan"))
        self.groupBox.setTitle(_translate("MainWindow", "Commentaire"))
