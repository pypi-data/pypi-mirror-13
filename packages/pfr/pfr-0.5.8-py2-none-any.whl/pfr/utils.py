...
def cleanFeatures(struct):
    ...
    # if given a bsID, create columns for tm (offense), opp (defense)
    # TODO: get columns for timeouts
    # TODO: get columns when penalty -> no play
    ...
    if (pd.notnull(struct.get('home_wp')) and pd.notnull(struct.get('team'))):
        ...
        struct['opp_wp'] = 100. - struct['team_wp']
