...
class TPT(object):
    '''
    This class use for controlling the load operation.
    '''
    ...
    def __init__(self):
       ...
       '''
        ...
        self.tpt_export_data_file = None
    ...
    def set_export_datafile_info(self, sql_stmt, sep=',', tpt_export_data_file=''):
        ...
        self.export_fs = sep
        if not tpt_export_data_file and tpt_export_data_file != '':
    ...
    def set_datafile_info(self, datafiles, column_names=None, sep=',', has_header=True):
        ...
        :param sep: Data file field delimiter. Single character.
    ...
    def set_driver(self, driver):
        '''
        Set the driver for load operation. In another word, the final table name.
