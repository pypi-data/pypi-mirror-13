...
Ext.define('HuRM.module.PersonDuties.Actions', {
...
Ext.define('HuRM.module.PersonDuties', {
    ...
    uses: [
        'HuRM.module.PersonDuties.Actions'
    ],
        ...
        if(!config.metadata) {
            MP.data.MetaData.fetch(config.dataURL, me, function(metadata) {
                ...
                Ext.apply(config, {
                    ...
                    plugins: [
                        Ext.create('HuRM.module.PersonDuties.Actions', { module: me }),
                    ]
                });
                callback(config);
