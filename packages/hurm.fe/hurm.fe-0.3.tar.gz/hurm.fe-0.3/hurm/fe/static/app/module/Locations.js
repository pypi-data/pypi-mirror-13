...
Ext.define('HuRM.module.Locations.Actions', {
    ...
    initActions: function() {
        ...
        me.tasksAction = me.addAction(new Ext.Action({
            ...
            handler: function() {
                var record = me.component.getSelectionModel().getSelection()[0],
                    idlocation = record.get('idlocation'),
                    location = record.get('description');
                me.module.showTasksWindow(idlocation, location);
            }
        }));
        ...
        me.dutiesAction = me.addAction(new Ext.Action({
            ...
            handler: function() {
                var record = me.component.getSelectionModel().getSelection()[0],
                    idlocation = record.get('idlocation'),
                    location = record.get('description');
                me.module.showDutiesWindow(idlocation, location);
            }
        }));
        ...
        me.printDutiesAction = me.addAction(new Ext.Action({
            ...
            handler: function() {
                var record = me.component.getSelectionModel().getSelection()[0],
                    idlocation = record.get('idlocation');
                me.module.printDuties(idlocation);
            }
        }));
    },
    ...
    showEditWindow: function(record) {
        ...
        var metadata = me.module.config.metadata,
            size = desktop.getReasonableWindowSize(1000, 550),
            orig_url,
...
Ext.define('HuRM.module.Locations', {
    ...
    showTasksWindow: function(idlocation, location) {
        var me = this;

        HuRM.module.Editions.selectEdition(me.app, function(idedition, edition) {
            me.app.getModule('tasks-win')
                .createOrShowWindow(idedition, edition, idlocation, location);
        });
    },

    showDutiesWindow: function(idlocation, location) {
        var me = this;
    ...
    printDuties: function(idlocation) {
        var me = this;

        HuRM.module.Editions.selectEdition(me.app, function(idedition, edition) {
            var url = '/pdf/duties/edition/' + idedition + '/location/' + idlocation;
