...
Ext.define('HuRM.module.Duties', {
    ...
    createOrShowWindow: function(idtask, location, activity, date, starttime, endtime, npersons) {
        var me = this,
        ...
        me.configure(
            [me.getConfig],
            function(done) {
                var size = desktop.getReasonableWindowSize(600, 400),
                    config = Ext.apply({
                        stickyFilters: [{
                            id: 'task',
                            property: 'idtask',
                    ...
                    npersonsmsg = Ext.String.format(ngettext('{0} person', '{0} persons',
                                                             npersons), npersons);
                ...
                win = desktop.createWindow({
                    ...
                    title: Ext.String.format(
                        ...
                        _("Activity “{0}” at “{1}” from {2} to {3} on {4}, {5}"),
                        activity, location,
                        Ext.Date.format(starttime, _('g:i A')),
                        Ext.Date.format(endtime, _('g:i A')),
                        Ext.Date.format(date, _('m/j/Y')),
                        npersonsmsg),
                    width: size.width,
                    height: size.height,
                    iconCls: me.iconCls,
