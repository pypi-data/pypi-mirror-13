...
Ext.define('HuRM.module.Availabilities.Actions', {
    ...
    showEditWindow: function(record) {
        ...
        var metadata = me.module.config.metadata,
            size = desktop.getReasonableWindowSize(800, 370),
...
Ext.define('HuRM.module.Availabilities', {
    ...
    createOrShowWindow: function(idedition, edition, idperson, person) {
        var me = this,
        ...
        if((me.single_person = Ext.isDefined(idperson))) {
            width = 460;
            height = 350;
        }
        ...
        me.configure(
            [me.getConfig],
            function(done) {
                var size = desktop.getReasonableWindowSize(width, height),
                    config = Ext.apply({
                        stickyFilters: [{
                            id: 'edition',
                            property: 'idedition',
                ...
                if(me.single_person) {
                    ...
                    config.newRecordData.idperson = idperson;
                    config.newRecordData.Person = person;
