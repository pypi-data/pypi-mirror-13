...
class GetFileMeta(BaseOperation):
    '''
...
class ListFileRevisions(BaseOperation):
    '''
...
class InitializeFile(BaseOperation):
    '''
    ...
    def _generate_body(self, volume, path, fileSize, fileData, fileMeta=None):
        ...
        assert isinstance(fileMeta, (types.NoneType, dict))
        return {
...
class InitializeAddChunk(BaseOperation):
    '''
...
class FlushUploadedFile(BaseOperation):
    '''
