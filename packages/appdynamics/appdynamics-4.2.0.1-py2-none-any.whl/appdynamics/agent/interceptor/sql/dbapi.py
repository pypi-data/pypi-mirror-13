...
class DbAPIConnectionInterceptor(ExitCallInterceptor):
    ...
    def attach(self, connect_func, *args, **kwargs):
    ...
    def get_backend(self, connection, *args, **kwargs):
        ...
        return self.agent.backend_registry.get_backend(EXIT_DB, EXIT_SUBTYPE_DB,
                                                       backend_properties,
    ...
    def _cursor(self, cursor, connection, *args, **kwargs):
        ...
        with self.log_exceptions():
            self.cursor_interceptor(self.agent,
                                    type(cursor_instance)).attach(['execute', 'executemany'],
    ...
    def get_backend_properties(self, conn, *args, **kwargs):
        """
        implementation should return (host, port, db)
