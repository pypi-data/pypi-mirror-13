...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.todo', 'sphinx.ext.coverage', 'sphinx.ext.pngmath', 'sphinx.ext.viewcode', 'sphinx.ext.inheritance_diagram', 'sphinxcontrib.seqdiag', 'sphinx.ext.intersphinx']
...
if fastr is not None:
    print('[conf.py] Generating IOPlugin reference')
