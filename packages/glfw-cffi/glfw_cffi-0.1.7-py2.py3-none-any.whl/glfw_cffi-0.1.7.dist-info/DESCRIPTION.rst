...
.. |PyPI version| image:: https://img.shields.io/pypi/v/glfw-cffi.svg
   :target: https://pypi.python.org/pypi/glfw-cffi
.. |Status| image:: https://img.shields.io/pypi/status/glfw-cffi.svg
   :target: https://pypi.python.org/pypi/glfw-cffi
.. |Python Compatibility| image:: https://img.shields.io/pypi/pyversions/glfw-cffi.svg
   :target: https://pypi.python.org/pypi/glfw-cffi
.. |Downloads| image:: https://img.shields.io/pypi/dm/glfw-cffi.svg?period=week
   :target: https://pypi.python.org/pypi/glfw-cffi
.. |Coverage Status| image:: https://coveralls.io/repos/brianbruggeman/glfw-cffi/badge.svg?branch=develop&service=github
   :target: https://coveralls.io/github/brianbruggeman/glfw-cffi?branch=develop
