...
class Sf2Info(object):
    def __init__(self, raw_info):
        ...
        # mandatory fields
        self.version = raw_info[b'ifil']
        self.sound_engine = from_cstr(raw_info[b'isng'])
        self.bank_name = from_cstr(raw_info[b'INAM'])
...
def main(argv=None):
    ...
    program_license = "LGPL v3+ 2016 Olivier Jolly"
