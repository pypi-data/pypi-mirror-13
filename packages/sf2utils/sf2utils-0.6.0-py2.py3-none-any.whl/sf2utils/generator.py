...
class Sf2Gen(object):
    ...
    def pretty_print(self, prefix=u''):
        if self.oper == self.OPER_START_ADDR_OFFSET:
            ...
            return prefix + "modulation LFO influence on pitch {}%".format(self.cents)
        elif self.oper == self.OPER_VIB_LFO_TO_PITCH:
            return prefix + "modulation vibrato influence on pitch {}%".format(self.cents)
        elif self.oper == self.OPER_MOD_ENV_TO_PITCH:
            return prefix + "modulation envelope influence on pitch {}%".format(self.cents)
            ...
            return prefix + "release modulation envelope {}%".format(self.cents)
