...
class Simulator(object):
    ...
    the simulator implements.  Since mosaik API version 2.2, the simulator's
    `major and `minor versions <http://semver.org/>`_ ("x.y", in the snippet
    above) has to be greater or equal than mosaik's. Mosaik will cancel the
    simulation if a version mismatch occurs.
