"""These are the Jingtum REST objects as defined in `the official schemata `
...
class AccountSettings(dict):
  ...
  def __init__(self, account, **kwargs):
    self.update(kwargs)
    self['account'] = JingtumAddress(account)

class Amount(dict):
  """An Amount on the Jingtum Protocol, used for IOUs and XRP
  ...
  :var issuer: The Jingtum account address of the currency's issuer or gateway,
    or an empty string if the currency is XRP
  :var counterparty: The Jingtum account address of the currency's issuer or
  ...
  def __init__(self, value, currency, issuer=None, counterparty=None,
    **kwargs):
    ...
    if issuer: self['issuer'] = JingtumAddress(issuer)
    if counterparty: self['counterparty'] = JingtumAddress(counterparty)
...
class Balance(dict):
  ...
  def __init__(self, value, currency, issuer=None, counterparty=None,
    **kwargs):
    ...
    self['value'] = value
    self['currency'] = Currency(currency)
    self['issuer'] = JingtumAddress(issuer) if issuer else None
    self['counterparty'] = JingtumAddress(counterparty) if counterparty else None
...
class Notification(dict):
  ...
  :var account: The Jingtum address of the account to which the notification
    pertains
  ...
  :var direction: The direction of the transaction, from the perspective of
    ...
    "passthrough"
  :var state: The state of the transaction from the perspective of the Jingtum
    Ledger. Possible values are "validated" and "failed"
  :var result: The code indicating the success or failure type of the
    transaction. The code "tesSUCCESS" indicates that the transaction was
    successfully validated and written into the Jingtum Ledger. All other codes
  ...
  :var ledger: The string representation of the index number of the ledger
    ...
    be written into the Jingtum Ledger if they fail after submission to 
    a Jingtum Network fee is claimed
  :var hash: The 256-bit hash of the transaction. This is used throughout the
    Jingtum protocol as the unique identifier for the transaction
  :var timestamp: The timestamp representing when the transaction was validated
    and written into the Jingtum ledger
...
class Payment(dict):
  ...
  :var timestamp: The timestamp representing when the payment was validated and
    written into the Jingtum ledger
  :var destination_tag: A string representing an unsigned 32-bit integer most
    commonly used to refer to a receiver's hosted account at a Jingtum gateway
  :var destination_account:
  :var source_tag: A string representing an unsigned 32-bit integer most 
    commonly used to refer to a sender's hosted account at a Jingtum gateway
  :var result: The code indicating the success or failure type of the
    payment. The code "tesSUCCESS" indicates that the payment was successfully
    validated and written into the Jingtum Ledger. All other codes will begin
  ...
  :var source_balance_changes: Parsed from the validated transaction metadata,
    ...
    Jingtum Network fee and, if the source_amount was not XRP, one amount
  ...
  :var state: The state of the payment from the perspective of the Jingtum
    Ledger. Possible values are "validated" and "failed" and "new" if the
    payment has not been submitted yet
  :var paths: A "stringified" version of the Jingtum PathSet structure that
    users should treat as opaque
  :var no_direct_jingtum: A boolean that can be set to true if paths are
    specified and the sender would like the Jingtum Network to disregard any
  ...
  :var ledger: The string representation of the index number of the ledger
    ...
    written into the Jingtum Ledger if they fail after submission to a
    Jingtum Network fee is claimed
  :var direction: The direction of the payment, from the perspective of the
    ...
    "passthrough"
  :var source_account: The Jingtum account address of the Payment sender
  :var fee: The Jingtum Network transaction fee, represented in whole XRP
  ...
  def __init__(self, source_account, destination_account, destination_amount,
    **kwargs):
    self.update(kwargs)
    self['source_account'] = JingtumAddress(source_account)
    self['destination_account'] = JingtumAddress(destination_account)
    self['destination_amount'] = Amount(**destination_amount)

class JingtumAddress(str):
  """A Jingtum account address
  """
  pass
...
class Trustline(dict):
  ...
  :var hash: If this object was returned by a historical query this value will
    ...
    transaction hash is used throughout the Jingtum Protocol to uniquely
  ...
  def __init__(self, account, counterparty, limit, currency, **kwargs):
    self.update(kwargs)
    self['account'] = JingtumAddress(account)
    self['counterparty'] = JingtumAddress(counterparty)
