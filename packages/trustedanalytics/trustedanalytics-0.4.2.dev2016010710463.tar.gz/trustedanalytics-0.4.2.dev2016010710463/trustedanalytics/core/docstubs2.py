...
# Auto-generated file for API static documentation stubs (2016-01-07T03:53:19.495778)
#
# **DO NOT EDIT**
...
__all__ = ["CollaborativeFilteringModel", "DaalLinearRegressionModel", "GiraphCollaborativeFilteringModel", "KMeansModel", "LdaModel", "LibsvmModel", "LinearRegressionModel", "LogisticRegressionModel", "NaiveBayesModel", "PowerIterationClusteringModel", "PrincipalComponentsModel", "RandomForestClassifierModel", "RandomForestRegressorModel", "SvmModel", "drop", "drop_frames", "drop_graphs", "drop_models", "get_frame", "get_frame_names", "get_graph", "get_graph_names", "get_model", "get_model_names"]
...
class CollaborativeFilteringModel(object):
    ...
    @doc_stub
    def predict(self, graph, user_column_name='user', product_column_name='product', rating_column_name='rating'):
        """
        ...
        :param graph: 
        :type graph: Graph
        :param user_column_name: (default=user)  A user column name for the output frame
        :type user_column_name: unicode
        :param product_column_name: (default=product)  A product  column name for the output frame
        :type product_column_name: unicode
        :param rating_column_name: (default=rating)  A rating column name for the output frame
        :type rating_column_name: unicode
    ...
    @doc_stub
    def train(self, graph, weight_column_name, max_steps=10, regularization=0.5, alpha=0.5, num_factors=3, use_implicit=False, num_user_blocks=2, num_item_block=3, target_rmse=0.05):
        """
...
@doc_stub
class GiraphCollaborativeFilteringModel(object):
    """
    Auto-generated to contain doc stubs for static program analysis
    """
    ...
    def __init__(self, name=None):
        ...
        :returns: 
        :rtype: GiraphCollaborativeFilteringModel
        """
        raise DocStubCalledError("model:giraph_collaborative_filtering/new")
...
class LdaModel(object):
    ...
    @doc_stub
    def train(self, frame, document_column_name, word_column_name, word_count_column_name, max_iterations=20, alpha=1.10000002384, beta=1.10000002384, num_topics=10, random_seed=None):
        """
        Creates Latent Dirichlet Allocation model
        ...
        :param max_iterations: (default=20)  The maximum number of iterations that the algorithm will execute.
            ...
            Default is 20.
        :type max_iterations: int32
        :param alpha: (default=1.10000002384)  The hyperparameter for document-specific distribution over topics.
...
class RandomForestClassifierModel(object):
    ...
    @doc_stub
    def train(self, frame, label_column, observation_columns, num_classes=2, num_trees=1, impurity='gini', max_depth=4, max_bins=100, seed=-1723274104, categorical_features_info=None, feature_subset_category=None):
        """
        ...
        :type max_bins: int32
        :param seed: (default=-1723274104)  Random seed for bootstrapping and choosing feature subsets. Default is a randomly chosen seed.
        :type seed: int32
...
class RandomForestRegressorModel(object):
    ...
    @doc_stub
    def train(self, frame, label_column, observation_columns, num_trees=1, impurity='variance', max_depth=4, max_bins=100, seed=-762251771, categorical_features_info=None, feature_subset_category=None):
        """
        ...
        :param max_bins: (default=100)  Maximum number of bins used for splitting features. Default is 100.
        :type max_bins: int32
        :param seed: (default=-762251771)  Random seed for bootstrapping and choosing feature subsets. Default is a randomly chosen seed.
        :type seed: int32
        :param categorical_features_info: (default=None)  
        :type categorical_features_info: None
        :param feature_subset_category: (default=None)  Number of features to consider for splits at each node. Supported values "auto", "all", "sqrt","log2", "onethird".
