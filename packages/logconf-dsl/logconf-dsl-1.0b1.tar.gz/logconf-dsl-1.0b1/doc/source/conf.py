...
# -*- coding: utf-8 -*-
#
# logconf-dsl documentation build configuration file, created by
...
def get_version():
    version_module = _load_version_module()

    return '{0[0]}.{0[1]}'.format(version_module['VERSION'][0:2])
...
htmlhelp_basename = 'logconf-dsldoc'
...
latex_documents = [
    (master_doc, 'logconf-dsl.tex', 'logconf-dsl Documentation',
...
man_pages = [
    (master_doc, 'logconf-dsl', 'logconf-dsl Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'logconf-dsl', 'logconf-dsl Documentation',
     author, 'logconf-dsl', 'One line description of project.',
     'Miscellaneous'),
]
