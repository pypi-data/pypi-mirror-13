...
class TestBundle(helpers.BundleFileTestsMixin, unittest.TestCase):
    ...
    def test_attributes(self):
        # The bundle data, the optional reference and the default version are
        # stored as attributes.
        self.assertEqual(self.bundle_data, self.bundle.data)
        self.assertEqual(self.reference, self.bundle.reference)
        self.assertEqual(4, self.bundle.version)

    def test_version_and_no_reference(self):
        # The bundle syntax version can be provided as an argument. The bundle
...
class TestFromSource(
    ...
    def test_charmworld_bundle(self):
        ...
        self.assertEqual(4, bundle.version)
    ...
    def test_jujucharms_bundle_invalid_url(self):
        ...
        # not valid.
        expected_error = 'invalid charm or bundle URL: u/no/such/bundle/!'
        with self.assert_value_error(expected_error):
