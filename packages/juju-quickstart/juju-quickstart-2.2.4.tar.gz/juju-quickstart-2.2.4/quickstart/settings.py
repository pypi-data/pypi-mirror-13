...
DEFAULT_CHARM_URLS = collections.OrderedDict((
    ('precise', 'cs:precise/juju-gui-121'),
    ('trusty', 'cs:trusty/juju-gui-38'),
))
...
# The minimum Juju GUI charm revision supporting bundle syntax version 4.
# Assume not listed series to always support v4 syntax.
MINIMUM_REVISIONS_FOR_V4_BUNDLES = collections.defaultdict(
    lambda: 0, {'precise': 121, 'trusty': 38})
