...
NOTE: this module is deprecated and still here for API compatibility only.
Do not import this module on quickstart code. External programs using this
module should move to more reliable ways to retrieve information on already
bootstrapped environments. For instance, see "quickstart.models.apiinfo".
"""
...
logging.warn('using deprecated module "quickstart.models.jenv"')
