...
def get_env_type_db():
    ...
    image_stream_field = fields.SuggestionsStringField(
        'image-stream', label='image stream', required=False,
        help='A simplestreams stream to select OS images from. For example '
             'daily or released images (or any other stream available on '
             'simplestreams).',
        suggestions=['released', 'daily'])
    # Define data structures used as part of the metadata below.

    # The up-to-date list of EC2 regions can be found at:
    ...
    # https://community.hpcloud.com/article/
    #    command-line-interface-cli-tool-installation-instructions
    hp_regions = ('region-a.geo-1', 'region-b.geo-1')

    # The Azure locations are listed at:
    ...
    env_type_db = collections.OrderedDict({
        '__fallback__': {
            'description': (
                ...
                'See https://jujucharms.com/docs/stable/getting-started for '
    ...
    env_type_db['ec2'] = {
        ...
        'description': (
            ...
            'See https://jujucharms.com/docs/stable/config-aws for more '
    ...
    env_type_db['openstack'] = {
        ...
        'description': (
            ...
            'https://jujucharms.com/docs/stable/config-openstack and '
            'https://jujucharms.com/docs/stable/config-hpcloud for more '
        ...
        'fields': (
            ...
            # Optional fields.
            fields.BoolField(
                'use-floating-ip', label='use floating IP', allow_mixed=True,
                required=False,
            ...
            fields.BoolField(
                'use-default-secgroup', label='use default security group',
                allow_mixed=True, required=False,
                help='Specifies whether new machine instances should have the '
                     '"default" OpenStack security group assigned. It '
                     'defaults to false.'),
            fields.StringField(
                'tenant-name', label='tenant name', required=False,
            ...
            fields.StringField(
                'tools-metadata-url', label='tools metadata URL',
                required=False,
                help='The location of the Juju tools and metadata. It '
                     'defaults to the global public tools metadata location '
                     'https://streams.canonical.com/tools'),
            fields.StringField(
                'image-metadata-url', label='image metadata URL',
                required=False,
                help='The location of Ubuntu cloud image metadata. It '
                     'defaults to the global public image metadata location '
    ...
    env_type_db['azure'] = {
        ...
        'description': (
            ...
            'https://jujucharms.com/docs/stable/config-azure for more '
    ...
    env_type_db['joyent'] = {
        ...
        'description': (
            ...
            'https://jujucharms.com/docs/stable/config-joyent for more '
            'details on the joyent provider configuration.'
        ),
        'fields': (
            provider_field,
            name_field,
    ...
    env_type_db['gce'] = {
        ...
        'description': (
            'The gce provider enables you to run Juju on Google '
            'Compute Engine. '
            'This process requires you to have a Google account '
            'and a pre-existing project.  Visit '
            'https://console.developers.google.com/project '
            'to set up your project and download credentials '
            'before continuing.'),
        'fields': (
            provider_field,
            name_field,
            ...
            fields.StringField(
                ...
                label='project id',
                help='the pre-existing GCE project id. '),
            fields.FilePathField(
                'auth-file', required=True,
                label='authorization file',
                help=(
                    'the path to the GCE project authorization '
                    'JSON file from creating a new client id: '
                    'https://console.developers.google.com/project/'
                    '<project-id>/apiui/credential'),
            ),
            fields.ChoiceField(
                'region', choices=gce_regions, label='region',
                required=False, default=gce_regions[0],
                help='the GCE region to use'),
            fields.ChoiceField(
                'image-endpoint', choices=gce_image_endpoints,
                label='image endpoint',
                required=False, default=gce_image_endpoints[0],
                help=(
                    'the GCE image endpoint where Juju will look '
                    'for disk images when provisioning a '
                    'new instance on GCE'),
            ),
            default_series_field,
            is_default_field,
    ...
    env_type_db['maas'] = {
        ...
        'description': (
            ...
            'metal via Juju. '
            'See https://jujucharms.com/docs/stable/config-maas and '
        ...
        'fields': (
            ...
            fields.BoolField(
                ...
                label='disable Juju network management',
                allow_mixed=True, required=False,
                help='Enable this when MAAS is managing the bridge and '
                     'bringing networks up and down. This tells Juju not to '
                     'create a network bridge or to bring eth0 up and down '
                     'during the cloud-init install phase. Juju will not make '
                     'changes to the network configuration when its agents '
                     'start.'),
            fields.FilePathField(
    ...
    env_type_db['manual'] = {
        ...
        'description': (
            ...
            'See https://jujucharms.com/docs/stable/config-manual for more '
    ...
    env_type_db['local'] = {
        ...
        'description': (
            ...
            'See https://jujucharms.com/docs/stable/config-LXC for more '
