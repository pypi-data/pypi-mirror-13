...
# List intended to be incorporated into the UserData portion of a EC2 or ASG cloud formation
# template.
def get_value(params):

	boot_script_list=[]

	exclusions = get_variable(params, 'exclusions', [])
	servicefile_path = get_variable(params,"servicefile-path")
	includes_efs = 'efs' not in exclusions
