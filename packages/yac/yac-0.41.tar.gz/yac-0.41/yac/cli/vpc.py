...
def main():
    ...
    parser.add_argument('--set', help='set the vpc definitions to use when building stacks (arg is key from the registry)')
    ...
    parser.add_argument('--register', help='register a new (or update an existing) naming vpc definition (arg is key for the registry)')
