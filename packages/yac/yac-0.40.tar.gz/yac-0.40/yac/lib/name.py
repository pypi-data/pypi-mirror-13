...
def get_cname(app, env, suffix=""):
	...
	if os.environ.get('YAC_NAMER'):
		...
		return guest_namer.get_cname(app, env, suffix)

	else:

		return yac.lib.name_std.get_cname(app, env, suffix)
...
def get_resource_name(app, env, resource, suffix=""):
	...
	if os.environ.get('YAC_NAMER'):
		...
		return guest_namer.get_resource_name(app, env, resource, suffix)

	else:

		return yac.lib.name_std.get_resource_name(app, env, resource, suffix)
...
def get_sg_name(app, env, resource, suffix=""):
	...
	if os.environ.get('YAC_NAMER'):
		...
		return guest_namer.get_sg_name(app, env, resource, suffix)

	else:

		return yac.lib.name_std.get_sg_name(app, env, resource, suffix)				
...
def get_host_name(app, env, suffix="" ):
	...
	if os.environ.get('YAC_NAMER'):
		...
		return guest_namer.get_host_name(app, env, suffix)

	else:

		return yac.lib.name_std.get_host_name(app, env, suffix)
...
def get_naming_std():
	...
	if os.environ.get('YAC_NAMER'):
		...
		return yac.lib.name_std.get_naming_std()
