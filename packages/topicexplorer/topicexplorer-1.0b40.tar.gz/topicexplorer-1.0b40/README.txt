...
3. Open a terminal and run
   ``pip install -e --src . git+https://github.com/inpho/topic-explorer#egg=topicexplorer``
...
Straightforward instructions are provided for Anaconda for both end
users and developers. If you want to roll your own install, some notes
on dependencies are included below.

-  **Anaconda**

1. If using Miniconda, the necessary packages are:
