...
_cgatools.CGATOOLS_UTIL_MD5_HPP__swigconstant(_cgatools)
...
_cgatools.CGATOOLS_REFERENCE_RANGE_HPP__swigconstant(_cgatools)
CGATOOLS_REFERENCE_RANGE_HPP_ = _cgatools.CGATOOLS_REFERENCE_RANGE_HPP_
class Location(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr

    def __init__(self, chromosome, offset):
...
class Range(object):
    ...
    def __init__(self, chromosome, begin, end):
...
_cgatools.CGATOOLS_REFERENCE_COMPACTDNASEQUENCE_HPP__swigconstant(_cgatools)
...
class AmbiguousRegion(object):
    ...
    def __init__(self, code, pos, length):
...
class CompactDnaSequence(object):
    ...
    def __init__(self, name, circular, packedData, md5, length, amb):
...
_cgatools.CGATOOLS_REFERENCE_CRRFILE_HPP__swigconstant(_cgatools)
...
def left_trim(alleles, pos1, left_trimmed):
    return _cgatools.left_trim(alleles, pos1, left_trimmed)
left_trim = _cgatools.left_trim

def normalize_variant(crr, rec, chr_idx, pos_idx, ref_idx, alt_idx):
