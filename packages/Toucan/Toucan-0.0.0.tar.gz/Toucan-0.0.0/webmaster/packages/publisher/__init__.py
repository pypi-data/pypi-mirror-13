...
It doesn't do user management itself. This is left to Webmaster User package.
"""
import os
import datetime
import json
...
from webmaster import (View, redirect, request, url_for, session, abort, flash,
                       flash_data, get_flashed_data, register_package, init_app)
from webmaster.decorators import (menu, route, template, plugin,
...
from webmaster import utils, markdown_ext
...
def page(view, **kwargs):
    ...
    templates_dir = kwargs.get("template_dir", "Webmaster/Package/Publisher/Page")
...
def admin(view, **kwargs):
    ...
    template_dir = kwargs.get("template_dir", "Webmaster/Package/Publisher/Admin")
