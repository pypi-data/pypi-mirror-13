...
setup(name='DecisionTree',
      ...
      url='https://engineering.purdue.edu/kak/distDT/DecisionTree-3.3.2.html',
      download_url='https://engineering.purdue.edu/kak/distDT/DecisionTree-3.3.2.tar.gz#md5=ac2c9c475e04bdff1f12ff365b5e617f',
