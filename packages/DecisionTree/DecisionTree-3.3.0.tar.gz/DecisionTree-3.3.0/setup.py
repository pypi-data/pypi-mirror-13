...
setup(name='DecisionTree',
      ...
      url='https://engineering.purdue.edu/kak/distDT/DecisionTree-3.3.0.html',
      download_url='https://engineering.purdue.edu/kak/distDT/DecisionTree-3.3.0.tar.gz#md5=0dd4d0d3c9fcb9306b2e4ff35b62c87a',
