...
/* #########################################################################
 * [2015-12-23 16:20:39.324000] THIS FILE IS AUTOGENERATED - DO NOT EDIT!
 * ######################################################################### */
#ifndef ___PULSE_COUNTER_RPC__COMMAND_PROCESSOR___
#define ___PULSE_COUNTER_RPC__COMMAND_PROCESSOR___
...
public:
  ...
  UInt8Array process_command(UInt8Array request_arr, UInt8Array buffer) {
    ...
    switch (command) {
        ...
        case CMD_ON_CONFIG_MUX_CHANNEL_A_PIN_CHANGED:
          {
            /* Cast buffer as request. */
    
            OnConfigMuxChannelAPinChangedRequest &request = *(reinterpret_cast
                                          <OnConfigMuxChannelAPinChangedRequest *>
                                          (&request_arr.data[2]));
    
    
            OnConfigMuxChannelAPinChangedResponse response;

            response.result =
            obj_.on_config_mux_channel_a_pin_changed(request.mux_channel_a_pin);
    
            /* Copy result to output buffer. */
            /* Cast start of buffer as reference of result type and assign result. */
            OnConfigMuxChannelAPinChangedResponse &output = *(reinterpret_cast
        ...
        case CMD_ON_CONFIG_MUX_CHANNEL_B_PIN_CHANGED:
          {
            /* Cast buffer as request. */
    
            OnConfigMuxChannelBPinChangedRequest &request = *(reinterpret_cast
                                          <OnConfigMuxChannelBPinChangedRequest *>
                                          (&request_arr.data[2]));
    
    
            OnConfigMuxChannelBPinChangedResponse response;

            response.result =
            obj_.on_config_mux_channel_b_pin_changed(request.mux_channel_b_pin);
    
            /* Copy result to output buffer. */
            /* Cast start of buffer as reference of result type and assign result. */
            OnConfigMuxChannelBPinChangedResponse &output = *(reinterpret_cast
        ...
        case CMD_ON_STATE_PULSE_PIN_CHANGED:
          {
            /* Cast buffer as request. */
    
            OnStatePulsePinChangedRequest &request = *(reinterpret_cast
                                          <OnStatePulsePinChangedRequest *>
                                          (&request_arr.data[2]));
    
    
            OnStatePulsePinChangedResponse response;

            response.result =
            obj_.on_state_pulse_pin_changed(request.old_pulse_pin, request.pulse_pin);
    
            /* Copy result to output buffer. */
            /* Cast start of buffer as reference of result type and assign result. */
            OnStatePulsePinChangedResponse &output = *(reinterpret_cast
        ...
        case CMD_ON_STATE_PULSE_DIRECTION_CHANGED:
          {
            /* Cast buffer as request. */
    
    
            OnStatePulseDirectionChangedResponse response;

            response.result =
            obj_.on_state_pulse_direction_changed();
    
            /* Copy result to output buffer. */
            /* Cast start of buffer as reference of result type and assign result. */
            OnStatePulseDirectionChangedResponse &output = *(reinterpret_cast
        ...
        case CMD_ON_STATE_PULSE_CHANNEL_CHANGED:
          {
            /* Cast buffer as request. */
    
            OnStatePulseChannelChangedRequest &request = *(reinterpret_cast
                                          <OnStatePulseChannelChangedRequest *>
                                          (&request_arr.data[2]));
    
    
            OnStatePulseChannelChangedResponse response;

            response.result =
            obj_.on_state_pulse_channel_changed(request.pulse_channel);
    
            /* Copy result to output buffer. */
            /* Cast start of buffer as reference of result type and assign result. */
            OnStatePulseChannelChangedResponse &output = *(reinterpret_cast
        ...
        case CMD_SET_PULSE_PIN:
          {
            /* Cast buffer as request. */
    
            SetPulsePinRequest &request = *(reinterpret_cast
                                          <SetPulsePinRequest *>
                                          (&request_arr.data[2]));
    
    
            obj_.set_pulse_pin(request.pulse_pin);
        ...
        case CMD_COUNT_PULSES:
          {
            /* Cast buffer as request. */
    
            CountPulsesRequest &request = *(reinterpret_cast
                                          <CountPulsesRequest *>
                                          (&request_arr.data[2]));
    
    
            CountPulsesResponse response;

            response.result =
            obj_.count_pulses(request.duration_ms);
    
            /* Copy result to output buffer. */
            /* Cast start of buffer as reference of result type and assign result. */
            CountPulsesResponse &output = *(reinterpret_cast
                                                 <CountPulsesResponse *>
                                                 (&buffer.data[0]));
            output = response;
            result.data = buffer.data;
        ...
        case CMD_START_PULSE_COUNT:
          {
            /* Cast buffer as request. */
    
    
            obj_.start_pulse_count();
        ...
        case CMD_STOP_PULSE_COUNT:
          {
            /* Cast buffer as request. */
    
    
            StopPulseCountResponse response;

            response.result =
            obj_.stop_pulse_count();
    
            /* Copy result to output buffer. */
            /* Cast start of buffer as reference of result type and assign result. */
            StopPulseCountResponse &output = *(reinterpret_cast
