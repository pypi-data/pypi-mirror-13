...
install_purelib = '/'
install_platlib = '/patool-1.11.data/platlib'
install_lib = '/'
install_headers = '/patool-1.11.data/headers'
install_scripts = '/patool-1.11.data/scripts'
config_dir = '/patool-1.11.data/data/share/patool'
install_data = '/patool-1.11.data/data'
name = 'patool'
version = '1.11'
