...
from .settings import IMAGE_CONTENT_TYPES, MEDIA_ROOT, MEDIA_URL, STORAGE
...
class File(common.models.DateTimeModelMixin):
    ...
    file = models.FileField(storage=Storage(location=MEDIA_ROOT,
                                            base_url=MEDIA_URL))
    file_original_name = models.CharField(max_length=255)
    ...
    def preview(self):
        ...
        if self.pk:
            ...
            html += '<a href="{}" class="icon icon-popup"></a>'.format(url)
