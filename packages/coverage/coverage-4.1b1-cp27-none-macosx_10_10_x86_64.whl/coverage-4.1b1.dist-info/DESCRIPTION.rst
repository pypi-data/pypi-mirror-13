...
Documentation is on `Read the Docs <https://coverage.readthedocs.org/en/coverage-4.1b1>`_.
...
See the `quick start <https://coverage.readthedocs.org/en/coverage-4.1b1/#quick-start>`_
section of the docs.
...
.. |docs| image:: https://readthedocs.org/projects/coverage/badge/?version=latest&style=flat
    :target: https://coverage.readthedocs.org/en/coverage-4.1b1
    :alt: Documentation
