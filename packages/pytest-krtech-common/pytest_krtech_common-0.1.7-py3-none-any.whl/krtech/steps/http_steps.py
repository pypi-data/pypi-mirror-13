    ...
    class HttpSession:
        ...
        def submit(self):
            if self._method == 'post':
                self._response = self._session.post(self._url, data=self._params, allow_redirects=self._allow_redirects)
            else:
                self._response = self._session.get(self._url, params=self._params,
