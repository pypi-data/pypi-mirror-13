var $, HasParent, ImagePool, PlotWidget, TileRenderer, TileRendererView, _, logger, properties, wmts,
...
TileRenderer = (function(superClass) {
  ...
  TileRenderer.prototype.display_defaults = function() {
    return _.extend({}, TileRenderer.__super__.display_defaults.call(this), {
      level: 'underlay'
    });
  };
