...
class Connection:
    ...
    def do_get_request(self, url, allowable_response_status_codes=frozenset([200, 404]), **kwargs):
        assert url is not None
    ...
    def get_pipe_url(self, pipe_id):
        return self.pipes_url + "/" + urllib.parse.quote(pipe_id, safe="")
    ...
    def get_log_url(self, log_id):
        return self.logs_url + "/" + urllib.parse.quote(log_id, safe="")
    ...
    def get_system_url(self, system_id):
        return self.systems_url + "/" + urllib.parse.quote(system_id, safe="")
    ...
    def get_dataset_url(self, dataset_id):
        return self.datasets_url + "/" + urllib.parse.quote(dataset_id, safe="")
    ...
    def get_systems(self):
        ...
        response = self.do_get_request(self.systems_url)
    ...
    def get_stats(self):
        ...
        """
        stats_response = self.do_get_request(self.stats_url)
    ...
    def get_datasets(self):
        datasets = []
        response = self.do_get_request(self.datasets_url)
        parsed_response = json.loads(response.text)
    ...
    def get_logs(self):
        ...
        # TODO: wrap in a utility-method and add error-detection
        response = self.do_get_request(self.logs_url)
        parsed_response = json.loads(response.text)
