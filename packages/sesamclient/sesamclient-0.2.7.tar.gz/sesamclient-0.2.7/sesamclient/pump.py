...
class Pump(EntityBase):
    ...
    def disable(self):
        ...
        return self._set_disabled_state(True)

    def enable(self):
        """Enable this pump."""
        return self._set_disabled_state(False)
    ...
    def start(self, allow_already_running_pump=True):
        """
        Starts the pump.

        :param allow_already_running_pump: If this  flag is set to False, this method will fail if the task was already
                                           running. If the allow_already_running_task flag is set to True, the already
                                           running task will be returned.
        """
