...
class Table(BaseObject):
    ...
    def get_html(self, html, indent):
        ...
        html.render(u'    ', self.head, indent)
        html.append(u'    <tbody>')
        html.render(u'    ', self.rows, indent)
        html.append(u'    </tbody>')
        html.append(u'</table>')
...
class TableHead(BaseObject):
    ...
    def get_html(self, html, indent):
        ...
        html.render(u'    ', self.columns, indent)
    ...
    if data:
        ...
        for row in data:
            ...
            for field_name in field_names:
                ...
                elif field_name.lower() in dir(row):
                    value = row.__getattribute__(field_name.lower())
