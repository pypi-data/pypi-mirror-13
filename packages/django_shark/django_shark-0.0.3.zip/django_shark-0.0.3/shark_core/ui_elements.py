from shark_core.layout import Panel
...
class Video(BaseObject):
    ...
    """
    def __init__(self, urls=Default, **kwargs):
        self.init(kwargs)
        self.urls = self.param(urls, 'list', 'List of urls of different versions of the video', [])

    def get_html(self, html, indent):
        html.append("<video" + self.base_attributes + " width='100%' controls autoplay>")
