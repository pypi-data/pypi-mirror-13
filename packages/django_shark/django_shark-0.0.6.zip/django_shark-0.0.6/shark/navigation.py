...
class NavBar(BaseObject):
    ...
    def get_html(self, html, indent):
        ...
        html.render(u'            ', self.brand, indent)
        html.append(u'        </div>')
        html.append(u'')
        ...
        if self.items:
            ...
            html.render(u'                ', self.items, indent)
            html.append(u'            </ul>')
        html.render(u'            ', self.search, indent)
        if self.right_items:
            html.append(u'            <ul class="nav navbar-nav navbar-right">')
            html.render(u'                ', self.right_items, indent)
            html.append(u'            </ul>')
        html.append(u'        </div>')
        html.append(u'    </div>')
...
class NavSearch(BaseObject):
    ...
    def get_html(self, html, indent):
        ...
        html.append('    </div>')
        html.append('    <button type="submit" class="btn btn-default">' + self.button_name.render() + '</button>')
        html.append('</form>')
