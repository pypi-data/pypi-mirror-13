...
class BasePageHandler(BaseHandler):
    ...
    def output_html(self):
        ...
        css = self.css
        if self.modals:
            modals_html = '    ' + self.modals.render('    ')
    ...
    def render(self, request, *args, **kwargs):
        ...
        if request.method == 'GET':
            ...
            keep_variables = json.loads(self.get_argument('keep_variables', '{}'))
            ...
            for argument in self.request.arguments:
                if argument == 'identifier':
                    self.__setattr__(argument, self.get_argument(argument))
                elif argument not in ['action', 'keep_variables']:
                    arguments[argument] = self.get_argument(argument)
