...
Usage:
    ...
    dsms_cli export [--ignore_ssl_errs] [--query=profile:phishing]
                    [--template=<s>] [--template_dir=mytemplates]
    dsms_cli export --list_templates [--template_dir=/home/tom/mytemplates]
    dsms_cli list (profiles|severities|schedules)
    dsms_cli add (location|file) --profile=<profile_id> --schedule=<schedule_id>
                 [--severity=<severity_id>] [--monitor_until=<monitor_until>]
                 [--tags=<tags>] <location_or_file_path>
