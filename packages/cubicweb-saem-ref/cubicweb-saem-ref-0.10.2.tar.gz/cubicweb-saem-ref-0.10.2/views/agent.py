...
from cubicweb.web.views import calendar, tabs, uicfg, ajaxcontroller, urlpublishing
...
abaa.tag_subject_of(('Mandate', 'has_citation', '*'), False)
afs.tag_subject_of(('Mandate', 'has_citation', '*'), 'main', 'inlined')
...
abaa.tag_subject_of(('Occupation', 'has_citation', '*'), False)
afs.tag_subject_of(('Occupation', 'has_citation', '*'), 'main', 'inlined')
...
class WithCitationAsConceptEntityView(AsConceptEntityView):
    """Extend entity_as_concept view when entity has related citations."""

    __select__ = AsConceptEntityView.__select__ & has_related_entities('has_citation')

    def entity_call(self, entity, *args, **kwargs):
        super(WithCitationAsConceptEntityView, self).entity_call(entity, *args, **kwargs)
