...
# XXX Waiting for integration in a more standard place
...
class EACImportService(Service):
    ...
    def call(self, stream, import_log, **kwargs):
        ...
        importer = ExtEntitiesImporter(self._cw, store,
        ...
        try:
            created, updated = importer.import_entities(extentities, use_extid_as_cwuri=False,
                                                        skip_known_external_uris=True)
        ...
        if extimporter.agent is not None:
            ...
            agent_eid = None
        return created, updated, agent_eid
