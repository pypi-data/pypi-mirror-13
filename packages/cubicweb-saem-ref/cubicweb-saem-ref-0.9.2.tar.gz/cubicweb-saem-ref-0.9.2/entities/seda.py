...
class TransferringAgentOAISetSpec(oai.OAISetSpec):
...
class XSDAttr(dict):
    ...
    * `value`, optional value for the 'fixed' attribute of the xsd:attribute
    """
    def __init__(self, name, type, cardinality=None, value=None):
        ...
        if cardinality is None:
            ...
            use = 'optional'
        super(XSDAttr, self).__init__(name=name, type=type, use=use)
...
class SEDA1XSDExport(EntityAdapter):
    ...
    def dump(self):
        ...
        root = etree.Element('{%s}schema' % self.namespaces['xsd'], self.root_attributes,
    ...
    def xsd_attributes_scheme(self, scheme=None):
    ...
    def xsd_element(self, parent, name, type=None, value=None, cardinality='1', annotation=None,
                    xsd_attributes=()):
        ...
        * `type`, optional value for the 'type' attribute of the xsd:element
        ...
        * `xsd_attributes`, list of :class:`XSDAttr` defining xsd:attributes children of the
        ...
        element = self.element(parent, 'xsd:element', attributes)
        if annotation:
            self.element(element, 'xsd:annotation').text = annotation
        for xsd_attr in xsd_attributes:
            self.element(element, 'xsd:attribute', xsd_attr)
        return element

    def element(self, parent, name, attribs=None):
        """Namespace aware etree node building method"""
        prefix, name = name.split(':', 1)
        ns = '{%s}' % self.namespaces[prefix]
        return etree.SubElement(parent, ns + name, attribs)
...
class SEDA02XSDExport(SEDA1XSDExport):
    ...
    namespaces = {
        None: 'fr:gouv:ae:archive:draft:standard_echange_v0.2',
        'xsd': 'http://www.w3.org/2001/XMLSchema',
        'qdt': 'fr:gouv:ae:archive:draft:standard_echange_v0.2:QualifiedDataType:1',
