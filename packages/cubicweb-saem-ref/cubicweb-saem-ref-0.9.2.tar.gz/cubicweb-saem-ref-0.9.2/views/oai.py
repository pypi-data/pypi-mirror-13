...
"""cubicweb-saem-ref views for OAI-PMH export
...
- The second level of hierarchy refers to a filtering criterion on selected
  ...
  For instance:
      ...
      <baseurl>/oai?verb=ListIdentifiers&set=agent:role:archival

  would return the identifiers of entities of type Agent with role 'archival'.
...
class OAIResponse(object):
    ...
    def to_xml(self, content=None, errors=()):
        ...
        RootE = ElementMaker(nsmap=nsmap)
        attributes = {
        ...
        return RootE('OAI-PMH', date, request, *body_elems, **attributes)
