...
Lav_ERROR_MEMORY = 5
Lav_ERROR_INVALID_HANDLE = 6
Lav_ERROR_RANGE = 7
Lav_ERROR_CANNOT_INIT_AUDIO = 8
Lav_ERROR_FILE = 9
Lav_ERROR_FILE_NOT_FOUND = 10
Lav_ERROR_HRTF_INVALID = 11
Lav_ERROR_CANNOT_CROSS_SIMULATIONS = 12
Lav_ERROR_CAUSES_CYCLE = 13
Lav_ERROR_PROPERTY_IS_READ_ONLY = 14
Lav_ERROR_OVERLAPPING_AUTOMATORS = 15
Lav_ERROR_CANNOT_CONNECT_TO_PROPERTY = 16
Lav_ERROR_BUFFER_IN_USE = 17
...
Lav_OBJTYPE_PANNER_BANK_NODE = 34
Lav_OBJTYPE_CROSSFADER_NODE = 35
Lav_OBJTYPE_ONE_POLE_FILTER_NODE = 36
Lav_OBJTYPE_FIRST_ORDER_FILTER_NODE = 37
Lav_OBJTYPE_ALLPASS_NODE = 38
Lav_OBJTYPE_NESTED_ALLPASS_NETWORK_NODE = 39
Lav_OBJTYPE_FDN_REVERB_NODE = 40
Lav_OBJTYPE_BLIT_NODE = 41
Lav_OBJTYPE_DC_BLOCKER_NODE = 42
Lav_OBJTYPE_LEAKY_INTEGRATOR_NODE = 43
Lav_OBJTYPE_FILE_STREAMER_NODE = 44
...
LavBlockCallback = ctypes.CFUNCTYPE(None, LavHandle, ctypes.c_double, ctypes.c_void_p)
...
Lav_simulationSetBlockCallback = ctypes.CFUNCTYPE(LavError, LavHandle, LavBlockCallback, ctypes.c_void_p)(('Lav_simulationSetBlockCallback', libaudioverse_module))
...
Lav_createPannerBankNode = ctypes.CFUNCTYPE(LavError, LavHandle, ctypes.c_int, ctypes.c_char_p, ctypes.POINTER(LavHandle))(('Lav_createPannerBankNode', libaudioverse_module))
