...
class EditorWidget(QtGui.QWidget):
    ...
    def load_tmp_ommatidial_map_file(self):
        ...
        f=path+"__tmp_ommatidial_map.txt"
...
class PopupOmmatidialMap(QtGui.QWidget):
    ...
    def do_create(self):
        ...
        from MotionDetectorModel.OmmatidialMap import read_droso
        import os
        import numpy as np
        ...
        f=open(path+"__tmp_ommatidial_map.txt",'w')
        f.write(s)
        f.close()

        self.parent_EditorWidget.load_tmp_ommatidial_map_file()

        os.system("rm "+path+"__tmp_ommatidial_map.txt")
