...
accp_angle=io.loadmat(path+"src/OmmatidialMap/accpAngle.mat")['accpAngle']

# gauss fit to that data?
#d_accpAngleGaussFit=io.loadmat(path+"/OmmatidialMap/accpAngleGaussFit.mat")
gauss_coeffs=io.loadmat(path+"src/OmmatidialMap/accpAngleGaussFit.mat")['Dcoeff']
...
sphere_coords=io.loadmat(path+"src/OmmatidialMap/SphereCoord.mat")["SphereCoord"]
