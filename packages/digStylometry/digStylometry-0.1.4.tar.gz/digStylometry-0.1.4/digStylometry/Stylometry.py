...
class ComputeSignature:
    def __init__(self,**options):
        ...
        self.maxLines = options.get("maxLines",20)
    ...
    def parse_values(self, data):
        """The field value might be array or single values jq.jq will return always a list of those values.
        The list has multiple values if the field is array or else single value.
    """
        this = []
        for column_path in self.fields.itervalues():
            try:
