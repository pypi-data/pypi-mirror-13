...
USAGE: This program can be run from the command line by using:
             python createXMLFromJson.py -log Iesha.log -user_name John -chatbot_name Iesha
...
def fntCreateXMLFromLogs(chatbot_name='Iesha', user_name='John', logfile_name='Iesha.log'):

    if logfile_name is None: logfile_name = 'Iesha.log'
    if chatbot_name is None: chatbot_name = 'Iesha'
...
if __name__ == '__main__':
    ...
    parser.add_argument('-log', '--log', default='Iesha.log', help='Specify the log '
                                                                     'file to convert. Default=Iesha.log')
    parser.add_argument('-chatbot', '--chatbot', default='Iesha', help='Specify the name of the chatbot. Default=Iesha')
