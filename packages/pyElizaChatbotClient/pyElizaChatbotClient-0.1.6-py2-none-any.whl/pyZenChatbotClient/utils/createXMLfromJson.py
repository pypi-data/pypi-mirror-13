...
USAGE: This program can be run from the command line by using:
             python createXMLFromJson.py -log ZenMaster.log -user_name John -chatbot_name ZenMaster
...
def fntCreateXMLFromLogs(chatbot_name='ZenMaster', user_name='John', logfile_name='ZenMaster.log'):

    if logfile_name is None: logfile_name = 'ZenMaster.log'
    if chatbot_name is None: chatbot_name = 'ZenMaster'
...
if __name__ == '__main__':
    ...
    parser.add_argument('-log', '--log', default='ZenMaster.log', help='Specify the log '
                                                                     'file to convert. Default=ZenMaster.log')
    parser.add_argument('-chatbot', '--chatbot', default='ZenMaster', help='Specify the name of the chatbot. Default=ZenMaster')
