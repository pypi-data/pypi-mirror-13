...
def on_exit():
    ...
    createXMLfromJson.fntCreateXMLFromLogs(name_chatbot=_name_chatbot,
                                           name_user=_name_user,
                                           name_logfile=_name_logfile)
...
class pyElizaChatbot():
    ...
    def fntGetUserName(self, txt):
        ...
        userName = ' '.join(words)
        userName = userName.translate(table, string.punctuation)  # Remove punctuation
