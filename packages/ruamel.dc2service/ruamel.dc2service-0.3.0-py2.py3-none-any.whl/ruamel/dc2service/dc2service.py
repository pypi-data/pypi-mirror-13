...
class DC2Service(object):
    ...
    def print_rebuild(self):
        print("You can 'docker-control< build' a new image, which will be used after the")
        print("next restart (or reboot). If no new images is there the container is not"
              "recreated")
