...
def expand_tweet(str):
    ...
    str = re.sub(urlsHTTPsRegexp, '<a href="\g<1>">\g<1></a>', str)
...
class Renderer(base.Renderer):
    ...
    def gettweets(self):
        ...
        if username and not searchterms:
        ...
        if searchterms:
            ...
            filtered_results = [tweet for tweet in searchresults if not tweet in tweets]
