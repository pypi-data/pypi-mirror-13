...
struct NodeObject {
  PyObject_HEAD
  struct __pyx_vtabstruct_4axon_8_objects_Node *__pyx_vtab;
  PyObject *name;
  struct OrderedDictObject *attrs;
  PyObject *vals;
};

/* "axon/_objects.pxd":315
 * cdef dict tz_dict = {}
 * 
...
__PYX_EXTERN_C DL_IMPORT(struct KeyValObject) *__pyx_f_4axon_8_objects_c_new_keyval(PyObject *, PyObject *);
