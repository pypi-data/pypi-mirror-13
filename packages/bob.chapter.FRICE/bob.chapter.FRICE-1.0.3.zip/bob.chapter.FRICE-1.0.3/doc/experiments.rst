...
1. Pre-processing: geometrical alignment and photometric enhancement of the source images.
...
Obviously, the times that you will obtain will differ from the ones that we report in `the book chapter`_, as they depend on the machine that you are running on.
