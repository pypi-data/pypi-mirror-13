...
from .tools import ALGORITHM, AVAILABLE_ALGORITHMS, preprocessor, grid
...
def command_line_arguments():
  ...
  parser.add_argument('-a', '--algorithms', choices = ['Graphs', 'LGBPHS', 'ISV', 'LDA-IR', 'COTS'], default = AVAILABLE_ALGORITHMS, nargs = '+', help = "Select one (or more) algorithms that you want to execute")
