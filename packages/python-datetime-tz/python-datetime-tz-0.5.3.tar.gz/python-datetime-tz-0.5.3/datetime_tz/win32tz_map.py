'''Map between Windows and Olson timezones taken from http://www.unicode.org/repos/cldr/trunk/common/supplemental/windowsZones.xml
Generated automatically from datetime_tz.py'''
source_hash = '86108132fbca17b431ddbf85ae9347f5' # md5 sum of xml source data
win32timezones = {
  ...
  ('Central Pacific Standard Time', 'NF'): 'Pacific/Norfolk', # 
  ...
  'Ekaterinburg Standard Time': 'Asia/Yekaterinburg', # (UTC+05:00) Ekaterinburg (RTZ 4)
  ...
  'GMT Standard Time': 'Europe/London', # (UTC) Dublin, Edinburgh, Lisbon, London
  ...
  'Greenwich Standard Time': 'Atlantic/Reykjavik', # (UTC) Monrovia, Reykjavik
  ...
  'Kaliningrad Standard Time': 'Europe/Kaliningrad', # (UTC+02:00) Kaliningrad (RTZ 1)
  ...
  'Magadan Standard Time': 'Asia/Magadan', # (UTC+10:00) Magadan
  ...
  'Morocco Standard Time': 'Africa/Casablanca', # (UTC) Casablanca
  ...
  'N. Central Asia Standard Time': 'Asia/Novosibirsk', # (UTC+06:00) Novosibirsk (RTZ 5)
  ('N. Central Asia Standard Time', 'RU'): 'Asia/Novosibirsk', # 
  'Namibia Standard Time': 'Africa/Windhoek', # (UTC+01:00) Windhoek
  ...
  'North Asia East Standard Time': 'Asia/Irkutsk', # (UTC+08:00) Irkutsk (RTZ 7)
  ('North Asia East Standard Time', 'RU'): 'Asia/Irkutsk', # 
  'North Asia Standard Time': 'Asia/Krasnoyarsk', # (UTC+07:00) Krasnoyarsk (RTZ 6)
  ('North Asia Standard Time', 'RU'): 'Asia/Krasnoyarsk', # 
  'Pacific SA Standard Time': 'America/Santiago', # (UTC-03:00) Santiago
  ...
  'Pacific Standard Time (Mexico)': 'America/Santa_Isabel', # (UTC-08:00) Baja California
  ...
  'Russia Time Zone 10': 'Asia/Srednekolymsk', # (UTC+11:00) Chokurdakh (RTZ 10)
  ('Russia Time Zone 10', 'RU'): 'Asia/Srednekolymsk', # 
  'Russia Time Zone 11': 'Asia/Kamchatka', # (UTC+12:00) Anadyr, Petropavlovsk-Kamchatsky (RTZ 11)
  ('Russia Time Zone 11', 'RU'): 'Asia/Kamchatka', # 
  'Russia Time Zone 3': 'Europe/Samara', # (UTC+04:00) Izhevsk, Samara (RTZ 3)
  ('Russia Time Zone 3', 'RU'): 'Europe/Samara', # 
  'Russian Standard Time': 'Europe/Moscow', # (UTC+03:00) Moscow, St. Petersburg, Volgograd (RTZ 2)
  ...
  'Turkey Standard Time': 'Europe/Istanbul', # (UTC+02:00) Istanbul
  ...
  'Venezuela Standard Time': 'America/Caracas', # (UTC-04:30) Caracas
  ('Venezuela Standard Time', 'VE'): 'America/Caracas', # 
  'Vladivostok Standard Time': 'Asia/Vladivostok', # (UTC+10:00) Vladivostok, Magadan (RTZ 9)
  ...
  'Yakutsk Standard Time': 'Asia/Yakutsk', # (UTC+09:00) Yakutsk (RTZ 8)
