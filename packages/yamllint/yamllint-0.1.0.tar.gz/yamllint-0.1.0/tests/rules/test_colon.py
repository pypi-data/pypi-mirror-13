...
class ColonTestCase(RuleTestCase):
    ...
    def test_before_enabled(self):
        conf = 'colon: {max-spaces-before: 0, max-spaces-after: -1}'
        self.check('---\n'
                   'object:\n'
                   '  k1:\n'
                   '    - a\n'
    ...
    def test_before_max(self):
        conf = 'colon: {max-spaces-before: 3, max-spaces-after: -1}'
        self.check('---\n'
                   'object :\n'
                   '  k1   :\n'
                   '    - a\n'
    ...
    def test_after_enabled(self):
        conf = 'colon: {max-spaces-before: -1, max-spaces-after: 1}'
        self.check('---\n'
                   'key: value\n', conf)
        self.check('---\n'
                   'key:  value\n', conf, problem=(2, 6))
    ...
    def test_after_max(self):
        conf = 'colon: {max-spaces-before: -1, max-spaces-after: 3}'
        self.check('---\n'
                   'object:\n'
                   '  k1:  [a, b]\n', conf)
        self.check('---\n'
