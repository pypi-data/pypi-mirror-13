...
class JobTestCase(GirlFriendTestCase):
    ...
    def test_execute(self):
        ...
        ctx = Context({}, {"test_job": (-1, -2, -3)}, plugin_mgr)
        self.assertEquals(job.execute(ctx), -6)
        ...
        ctx = Context({}, {"test_job": {"a": -1}}, plugin_mgr)
        ...
        ctx = Context({}, {"test_job": ("a", "b", "c")}, plugin_mgr)
        ...
        ctx = Context({}, {"hehe": (5, 2, 3)}, plugin_mgr)
