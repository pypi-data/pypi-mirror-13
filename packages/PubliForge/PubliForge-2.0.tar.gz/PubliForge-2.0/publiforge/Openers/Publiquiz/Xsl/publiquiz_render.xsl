...
<!-- $Id: publiquiz_render.xsl fc380cb75e4c 2016/01/20 15:26:12 Coraline $ -->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:variable name="mip" select="1"/>
  <xsl:variable name="blanks_char" select="1"/>
  <xsl:variable name="mode_choices_check">check</xsl:variable>
  <xsl:variable name="mode_blanks_select">combobox</xsl:variable>
