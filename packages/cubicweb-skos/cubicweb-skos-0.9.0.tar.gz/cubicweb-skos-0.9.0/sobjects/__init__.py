...
if POST_321:
    ...
    from cubes.skos.sobjects.post321 import HTMLImportLog, ExtEntity, store_skos_extentities
else:
    from cubes.skos.sobjects.pre321 import HTMLImportLog, ExtEntity, store_skos_extentities
