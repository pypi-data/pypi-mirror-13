...
from cubicweb.dataimport.importer import (ExtEntity, ExtEntitiesImporter, HTMLImportLog, cwuri2eid,
                                          use_extid_as_cwuri, RelationMapping)
...
def _skos_import_lcsv(cnx, stream, import_log, scheme_uri, delimiter,
    ...
    return _skos_import(cnx, entities, import_log, extid_as_cwuri=False, **kwargs)
