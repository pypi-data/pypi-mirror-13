...
if __name__ == "__main__":
    ...
    # myLinkbot.plot()
    initTime = myLinkbot.encoderTimes[0]/1000.0
    index = 0
    for t,p in zip(myLinkbot.encoderTimes, myLinkbot.encoderData):
        myLinkbot.driveJointTo(1, p)
        time.sleep(myLinkbot.encoderTimes[index]/1000.0 - initTime)
        initTime = myLinkbot.encoderTimes[index]/1000.0
