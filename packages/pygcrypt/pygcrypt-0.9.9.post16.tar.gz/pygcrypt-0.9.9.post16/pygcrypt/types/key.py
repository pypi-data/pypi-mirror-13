...
class Key(object):
    ...
    def encrypt(self, data, padding=b'pkcs1'):
        """
        ...
        print(data)
        data_sexp = SExpression(b"(data (flags %s)(value %m))", padding, data)
    ...
    def decrypt(self, encrypted, padding=b'pkcs1'):
        """
        ...
        sexp_encr = SExpression(u'(enc-val (flags {})({} {}))'.format(padding.decode(), self.algo, sexp_algo).encode())
