# -*- coding: utf-8 -*-
#
# Two Cents documentation build configuration file, created by
...
version = two_cents.__version__
# The full version, including alpha/beta/rc tags.
release = two_cents.__version__
...
man_pages = [
    ('index', 'cookiecutterproject_name', u'Two Cents Documentation',
     [u'Kale Kundert'], 1)
]
