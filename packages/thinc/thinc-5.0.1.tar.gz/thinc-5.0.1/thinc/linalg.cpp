...
struct __pyx_vtabstruct_5thinc_6linalg_Vec {
  int (*has_nan)(__pyx_t_5thinc_6linalg_weight_t const *, int);
...
static CYTHON_INLINE int __pyx_f_5thinc_6linalg_3Vec_has_nan(__pyx_t_5thinc_6linalg_weight_t const *, int);
...
static CYTHON_INLINE int __pyx_f_5thinc_6linalg_3Vec_has_nan(__pyx_t_5thinc_6linalg_weight_t const *__pyx_v_weights, int __pyx_v_n); /* proto*/
...
static CYTHON_INLINE int __pyx_f_5thinc_6linalg_3Vec_has_nan(__pyx_t_5thinc_6linalg_weight_t const *__pyx_v_weights, int __pyx_v_n) {
  int __pyx_v_i;
  int __pyx_r;
  int __pyx_t_1;
  int __pyx_t_2;
 ...
 *         else:
 */
    __pyx_t_3 = (isnan((__pyx_v_weights[__pyx_v_i])) != 0);
    if (__pyx_t_3) {
...
#endif
{
  ...
  /*--- Type init code ---*/
  if (PyType_Ready(&__pyx_type_5thinc_6linalg_Matrix) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 58; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_type_5thinc_6linalg_Matrix.tp_print = 0;
  if (PyObject_SetAttrString(__pyx_m, "Matrix", (PyObject *)&__pyx_type_5thinc_6linalg_Matrix) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 58; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_vtable_5thinc_6linalg_Vec.has_nan = (int (*)(__pyx_t_5thinc_6linalg_weight_t const *, int))__pyx_f_5thinc_6linalg_3Vec_has_nan;
  ...
  if (PyType_Ready(&__pyx_type_5thinc_6linalg_Vec) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 65; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_type_5thinc_6linalg_Vec.tp_print = 0;
  if (__Pyx_SetVtable(__pyx_type_5thinc_6linalg_Vec.tp_dict, __pyx_vtabptr_5thinc_6linalg_Vec) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 65; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (PyObject_SetAttrString(__pyx_m, "Vec", (PyObject *)&__pyx_type_5thinc_6linalg_Vec) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 65; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  if (PyType_Ready(&__pyx_type_5thinc_6linalg_VecVec) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 176; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_type_5thinc_6linalg_VecVec.tp_print = 0;
  if (__Pyx_SetVtable(__pyx_type_5thinc_6linalg_VecVec.tp_dict, __pyx_vtabptr_5thinc_6linalg_VecVec) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 176; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (PyObject_SetAttrString(__pyx_m, "VecVec", (PyObject *)&__pyx_type_5thinc_6linalg_VecVec) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 176; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  if (PyType_Ready(&__pyx_type_5thinc_6linalg_MatVec) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 260; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_type_5thinc_6linalg_MatVec.tp_print = 0;
  if (__Pyx_SetVtable(__pyx_type_5thinc_6linalg_MatVec.tp_dict, __pyx_vtabptr_5thinc_6linalg_MatVec) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 260; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (PyObject_SetAttrString(__pyx_m, "MatVec", (PyObject *)&__pyx_type_5thinc_6linalg_MatVec) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 260; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  if (PyType_Ready(&__pyx_type_5thinc_6linalg_MatMat) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 335; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_type_5thinc_6linalg_MatMat.tp_print = 0;
  if (__Pyx_SetVtable(__pyx_type_5thinc_6linalg_MatMat.tp_dict, __pyx_vtabptr_5thinc_6linalg_MatMat) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 335; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (PyObject_SetAttrString(__pyx_m, "MatMat", (PyObject *)&__pyx_type_5thinc_6linalg_MatMat) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 335; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
