 ...
 *             for i in range(nr):
 */
  cblas_sscal(__pyx_v_nr, __pyx_v_scal, __pyx_v_vec, 1);
 ...
 *             for i in range(nr):
 */
  cblas_saxpy(__pyx_v_nr, __pyx_v_scale, __pyx_v_y, 1, __pyx_v_x, 1);
 ...
 *                 CblasNoTrans,
 */
  cblas_sgemv(CblasRowMajor, CblasNoTrans, __pyx_v_nr_row, __pyx_v_nr_col, 1.0, __pyx_v_mat, __pyx_v_nr_col, __pyx_v_vec, 1, 0.0, __pyx_v_output, 1);
 ...
 *                 CblasTrans,
 */
  cblas_sgemv(CblasRowMajor, CblasTrans, __pyx_v_nr_row, __pyx_v_nr_col, 1.0, __pyx_v_mat, __pyx_v_nr_col, __pyx_v_vec, 1, 0.0, __pyx_v_output, 1);
