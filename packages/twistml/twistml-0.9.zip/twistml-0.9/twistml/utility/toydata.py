...
def create_toy_data(targets, outdir, keywords, tweets_per_target=1000,
    ...
    sigma : float, optional
        The sigma of the gaussian distribution of timestamps for the
        generated tweetsexpressed in days. (default is 1.0, which
        implies 68% of sampled dates will be within one day of
