...
class Doc2VecTransformer(FeatureTransformer):
    ...
    def __init__(self, iterations=None, **kwargs):
        ...
        can be given and will be passed along.

        Parameters
        ----------
        iterations : int or None, optional
            Number of iterations for Doc2Vec Training with fixed alphas
            per iteration (see references).
            If None, one iteration with decreasing alpha is used.


        References
        ----------
        The use of iterations for training of Doc2Vec is explained in
        Radih Rehurek's tutorial_.

        .. _tutorial: http://rare-technologies.com/doc2vec-tutorial/
    ...
    def transform(self, filepaths):
        ...
        if self.iter is None:
            ...
            for epoch in range(self.iter):
                ...
                model.alpha -= 0.02 / float(self.iter)
