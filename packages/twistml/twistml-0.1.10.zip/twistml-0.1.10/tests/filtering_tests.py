...
def test_filter_tweets_by_language():
    ...
    # setup
    test_tweets = [{'text':'i am an english tweet.'},
                   {'text':'je ne suis pas une pomme de terre.'},
                   {'text':'ich bin ein kleiner grüner kaktus.'},
                   {'text':'én egy magyar mondat sok beszéddel.'},
                   {'text':'asdfgh jkl qwertzuiop yxcv bnm.'}]
