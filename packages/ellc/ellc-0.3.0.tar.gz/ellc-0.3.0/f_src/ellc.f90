...
double precision :: u1,v1,w1,u2,v2,w2,qfac1, qfac2,didt
...
double precision :: dx,dy,avflux,fnorm, df, frac(2), wt,ecl_rv_1,ecl_rv_2
...
! Add reflection effect parameters to fpar1/fpar2
...
do iobs=0,n_obs
  ...
  if (iobs > 0) then
    ...
    if (dorvflux) then
      if (verbose >= v_debug) then
        print *,'flux_1,rv1,ecl_rv_1', flux_1,rv1,ecl_rv_1
        print *,'flux_2,rv2,ecl_rv_2', flux_2,rv2,ecl_rv_2
      end if
    ...
    ! Doppler boosting
    if (verbose >= v_debug) then
      print *,'flux_1, rv1, kboost_1 =', flux_1,rv1,binary_pars(26)
      print *,'flux_2, rv2, kboost_2 =', flux_2,rv2,binary_pars(27)
    end if
    ...
    flux_rv_flag(iobs,1) = (flux_1+flux_2+flux_3)/fnorm
    flux_rv_flag(iobs,2) = flux_1
    flux_rv_flag(iobs,3) = flux_2
    flux_rv_flag(iobs,4) = rv1
    flux_rv_flag(iobs,5) = rv2
    flux_rv_flag(iobs,6) = return_flags
  else 
    fnorm = flux_1 + flux_2 + flux_3
  endif
