...
202086225.in   - Example input to ellc_emcee.py - light curve of EPIC 202086225
202086225.lc   - Kepler K2 light curve for EPIC 202086225
ellc_emcee.log - Log of ./ellc_emcee.py --grid_size very_sparse < 202086225.in
chain.csv      - Output emcee chain from same command
model.csv      - Output model light curve from same command
plot_chain.py  - Plot correlation diagrams for selected parameters
