...
def fluxes(t_obs, radius_1, radius_2, sbratio, incl, 
  ...
  heat_1 : {None, 3-tuple of floats}, optional
      Parameters of heating+reflection model for star 1, [H_0, H_1, u_H]
      H_0 is the coefficient, H_1 is the exponent and u_H is the linear
      limb-darkening coefficient.
      Default is None.
  
  heat_2 : {None, 3-tuple of floats}, optional
      Parameters of heating+reflection model for star 1, [H_0, H_1, u_H]
      H_0 is the coefficient, H_1 is the exponent and u_H is the linear
      limb-darkening coefficient.
      Default is None.
  ...
  if heat_1 is not None : par[27:30] = heat_1

  if heat_2 is not None : par[30:33] = heat_2
