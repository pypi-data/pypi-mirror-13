...
analysis of functional (GO and other) terms. Note that this package provides a
command-line tool, originally developed for inclusion into Galaxy `[6] <https://usegalaxy.org/>`_
workflows; you may also wish to consider the third-party package `[7] <https://pypi.python.org/pypi/gprofiler>`_ if you
need to integrate g:Profiler analysis into a Python application.
...
* [7] https://pypi.python.org/pypi/gprofiler
