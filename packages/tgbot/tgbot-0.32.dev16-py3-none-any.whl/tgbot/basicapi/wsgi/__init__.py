...
class TGBotWSGI:
    ...
    def __init__(self,commandclasses,inlineclasses=None,redis_limitserver=0,redis_convserver=1,configfile="basicconfig.ini",configpath="tgbot.resources.config",wartungsmodus=False,database:Database=None,dbuser="",dbpassword="",dbhost="127.0.0.1",dbport=3306):
