...
class TGBotWSGI:
    ...
    def __init__(self,files,commandclasses,inlineclasses=None,redis_limitserver=0,redis_convserver=1,redis_fileserver=2,configfile="basicconfig.ini",configpath="tgbot.resources.config",wartungsmodus=False):
