#!/usr/bin/env python3
 # -*- coding: utf-8 -*-
################################################################################
#    Eupompos Copyright (C) 2012 Suizokukan
...
from eupompos.settings import __projectname__, __version__, __author__, __email__, \
...
setup(
    ...
    url='https://github.com/suizokukan/eupompos',
    ...
    description="GPLv3/Python3/CLI very naive [Python|C++]Qt parser to get informations " \
                "about Qt signals",
    ...
    entry_points={
        'console_scripts': ['eupompos=eupompos.main:main',],
    },
)
