...
class Forager(object):
    ...
    def find_xmlrpc(self, url, soup_meta_filters=None):
        ...
        try:
            if self._is_xmlrpc(url):
                return self._find_apis(url, soup_meta_filters)
        ...
        return set(itertools.chain(
                *(self._find_apis(rsd_url, soup_meta_filters) for rsd_url in rsd_urls)
        ))
    ...
    def _is_xmlrpc(self, url):
        ...
        url = "{}://{}{}?rsd".format(url_parts.scheme, url_parts.netloc, url_parts.path)
