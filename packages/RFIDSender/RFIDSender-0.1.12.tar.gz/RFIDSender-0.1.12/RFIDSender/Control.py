...
def Start():
	"""
	Main function called from the application.
    ...
    if tag_num[0]:
        DataAccessor.WriteValues(dbconn, tag_num[1], GenerateTimeStamp(), GetSerialNumber(), "0001", sensor_acroynm, sensor_description)
