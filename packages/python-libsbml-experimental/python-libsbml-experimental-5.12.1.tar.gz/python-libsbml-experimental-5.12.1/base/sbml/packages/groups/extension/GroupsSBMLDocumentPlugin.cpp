                                           ...
                                           expectedAttributes)
{
  ...
  if (assigned == false)
  {
      ...
      log->contains(XMLAttributeTypeMismatch))
    {
      ...
      log->logPackageError("groups", GroupsAttributeRequiredMustBeBoolean, getPackageVersion(),
        getLevel(), getVersion());
    }
    else
    {
      log->logPackageError("groups", GroupsAttributeRequiredMissing, getPackageVersion(),
        getLevel(), getVersion());
    }
  }
  else
  {
    ...
    if (mRequired == true)
    {
      getErrorLog()->logPackageError("fbc", GroupsAttributeRequiredMustHaveValue,
