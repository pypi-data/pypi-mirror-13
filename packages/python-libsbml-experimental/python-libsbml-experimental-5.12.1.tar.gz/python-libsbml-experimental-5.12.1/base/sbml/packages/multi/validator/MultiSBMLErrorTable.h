...
static const packageErrorTableEntry multiErrorTable[] = 
{
  ...
  { MultiDupClaId,
    ...
    { "L3V1 Multi V1.0.5 Section 3.27"
    }
  },
  ...
  { MultiUnqId_SptIns,
    ...
    { "L3V1 Multi V1.0.5 Section 3.11.1 and Section 3.27"
    }
  },
  ...
  { MultiUnqId_SptCpoInd,
    ...
    "direct parent SpeciesType object in which it is located. ",
    { "L3V1 Multi V1.0.5 Section 3.12.1 and Section 3.27"
    }
  },
  ...
  { MultiUnqId_InSptBnd,
    ...
    { "L3V1 Multi V1.0.5 Section 3.13.1 and Section 3.27"
    }
  },
  ...
  { MultiUnqId_Sft,
    ...
    { "L3V1 Multi V1.0.5 Section 3.9.1 and Section 3.27"
    }
  },

//  // 7010405 // removed at v1.0.5
...
//    "it is located. ",
//    { "L3V1 Multi V1.0.5 Section 3.10.1 and Section 3.28"
//    }
//  },
  ...
  { MultiUnqId_SpeFtr,
    ...
    { "L3V1 Multi V1.0.5 Section 3.17.1 and Section 3.27"
    }
  },
  ...
  { MultiUnqId_SpeFtrChg,
    ...
    { "L3V1 Multi V1.0.5 Section 3.24.1 and Section 3.27"
    }
  },
  ...
  { MultiUnqId_CpaRef,
    ...
    "which it is located.",
    { "L3V1 Multi V1.0.5 Section 3.6.1 and Section 3.27"
    }
  },
  ...
  { MultiInvSIdRefSyn_Spt_CpaAtt,
    ...
    { "L3V1 Multi V1.0.5 Section 3.8.2"
    }
  },
  ...
  { MultiInvSIdRefSyn_PslSpeFtrVal_NumAtt,
    ...
    "syntax of the SBML data type SIdRef. ",
    { "L3V1 Multi V1.0.5 Section 3.10.2"
    }
  },
  ...
  { MultiInvSIdRefSyn_SptIns_SptAtt,
    ...
    "syntax of the SBML data type SIdRef. ",
    { "L3V1 Multi V1.0.5 Section 3.11.2"
    }
  },
  ...
  { MultiInvSIdRefSyn_SptIns_CpaRefAtt,
    ...
    "syntax of the SBML data type SIdRef. ",
    { "L3V1 Multi V1.0.5 Section 3.11.3"
    }
  },
  ...
  { MultiInvSIdRefSyn_SptCpoInd_CpoAtt,
    ...
    "syntax of the SBML data type SIdRef. ",
    { "L3V1 Multi V1.0.5 Section 3.12.2"
    }
  },
  ...
  { MultiInvSIdRefSyn_SptCpoInd_ParAtt,
    ...
    "syntax of the SBML data type SIdRef. ",
    { "L3V1 Multi V1.0.5 Section 3.12.3"
    }
  },
...
//    "syntax of the SBML data type SIdRef. ",
//    { "L3V1 Multi V1.0.5 Section 3.13.1"
//    }
//  },
  ...
  { MultiInvSIdRefSyn_InSptBnd_Bst1Att,
    ...
    "syntax of the SBML data type SIdRef. ",
    { "L3V1 Multi V1.0.5 Section 3.13.2"
    }
  },
  ...
  { MultiInvSIdRefSyn_Spe_SptAtt,
    ...
    "syntax of the SBML data type SIdRef. ",
    { "L3V1 Multi V1.0.5 Section 3.15.1"
    }
  },
  ...
  { MultiInvSIdRefSyn_OutBst_CpoAtt,
    ...
    "syntax of the SBML data type SIdRef. ",
    { "L3V1 Multi V1.0.5 Section 3.16.2"
    }
  },
  ...
  { MultiInvSIdRefSyn_SpeFtr_SpeFtrTypAtt,
    ...
    "syntax of the SBML data type SIdRef. ",
    { "L3V1 Multi V1.0.5 Section 3.17.2"
    }
  },
  ...
  { MultiInvSIdRefSyn_SpeFtr_CpoAtt,
    ...
    "syntax of the SBML data type SIdRef. ",
    { "L3V1 Multi V1.0.5 Section 3.17.4"
    }
  },
  ...
  { MultiInvSIdRefSyn_SpeFtrVal_ValAtt,
    ...
    "syntax of the SBML data type SIdRef. ",
    { "L3V1 Multi V1.0.5 Section 3.17.6"
    }
  },
  ...
  { MultiInvSIdRefSyn_SplSpeRef_CompRefAtt,
    ...
    "syntax of the SBML data type SIdRef. ",
    { "L3V1 Multi V1.0.5 Section 3.21"
    }
  },
  ...
  { MultiInvSIdRefSyn_StpCpoMapInPro_RctAtt,
    ...
    "syntax of the SBML data type SIdRef. ",
    { "L3V1 Multi V1.0.5 Section 3.23.1"
    }
  },
  ...
  { MultiInvSIdRefSyn_StpCpoMapInPro_RctCpoAtt,
    ...
    "syntax of the SBML data type SIdRef. ",
    { "L3V1 Multi V1.0.5 Section 3.23.2"
    }
  },
  ...
  { MultiInvSIdRefSyn_StpCpoMapInPro_ProCpoAtt,
    ...
    "syntax of the SBML data type SIdRef. ",
    { "L3V1 Multi V1.0.5 Section 3.23.3"
    }
  },
  ...
  { MultiInvSIdRefSyn_SpeFtrChg_RctSpeFtrAtt,
    ...
    "syntax of the SBML data type SIdRef. ",
    { "L3V1 Multi V1.0.5 Section 3.24.2"
    }
  },
  ...
  { MultiInvSIdRefSyn_SpeFtrChg_ProSpeFtrAtt,
    ...
    "syntax of the SBML data type SIdRef. ",
    { "L3V1 Multi V1.0.5 Section 3.24.3"
    }
  },
  ...
  { MultiInvSIdRefSyn_Cpa_CpaTypAtt,
    ...
    "syntax of the SBML data type SIdRef. ",
    { "L3V1 Multi V1.0.5 Section 3.5.2"
    }
  },
  ...
  { MultiInvSIdRefSyn_CpaRef_CpaAtt,
    ...
    "syntax of the SBML data type SIdRef. ",
    { "L3V1 Multi V1.0.5 Section 3.6.2"
    }
  },
  ...
  { MultiLofStps_AllowedAtts,
    ...
    { "L3V1 Multi V1.0.5 Section 3.4.1"
    }
  },
  ...
  { MultiExCpa_IsTypeAtt_Invalid,
    ...
    { "L3V1 Multi V1.0.5 Section 3.5.1"
    }
  },
  ...
  { MultiLofCpaRefs_OnlyOne,
    ...
    { "L3V1 Multi V1.0.5 Section 3.5.3"
    }
  },
  ...
  { MultiCpaRef_IdRequiredOrOptional,
    ...
    { "L3V1 Multi V1.0.5 Section 3.6.1"
    }
  },
  ...
  { MultiLofSpeFtrTyps_Elts,
    ...
    { "L3V1 Multi V1.0.5 Section 3.8.3"
    }
  },
  ...
  { MultiLofSptInss_Elts,
    ...
    { "L3V1 Multi V1.0.5 Section 3.8.4"
    }
  },
  ...
  { MultiLofSptCpoInds_Elts,
    ...
    { "L3V1 Multi V1.0.5 Section 3.8.6"
    }
  },
  ...
  { MultiLofInSptBnds_Elts,
    ...
    { "L3V1 Multi V1.0.5 Section 3.8.5"
    }
  },
  ...
  { MultiBstSpt_Restrict,
    ...
    { "L3V1 Multi V1.0.5 Section 3.8.7"
    }
  },
  ...
  { MultiSpeFtrTyp_OccAtt_Ref,
    ...
    { "L3V1 Multi V1.0.5 Section 3.9.2"
    }
  },
  ...
  { MultiSpeFtrTyp_RestrictElt,
    ...
    { "L3V1 Multi V1.0.5 Section 3.9.3"
    }
  },
  ...
  { MultiPsbSpeFtrVal_AllowedCoreAtts,
    ...
    { "L3V1 Multi V1.0.5 Section 3.10"
    }
  },
  ...
  { MultiSptIns_AllowedCoreAtts,
    ...
    { "L3V1 Multi V1.0.5 Section 3.11"
    }
  },
...
//    { "L3V1 Multi V1.0.5 Section 3.11.4"
//    }
//  },
  ...
  { MultiSptCpoInd_AllowedCoreAtts,
    ...
    { "L3V1 Multi V1.0.5 Section 3.12"
    }
  },
...
//    "the SBML data type 'positiveInteger'.",
//    { "L3V1 Multi V1.0.5 Section 3.12.4"
//    }
//  },
//
//  // 7020909
...
//    "must not be empty.",
//    { "L3V1 Multi V1.0.5 Section 3.12.5"
//    }
//  },
//
//  // 7020910
...
//    { "L3V1 Multi V1.0.5 Section 3.13"
//    }
//  },
//
//  // 7021002
...
//  },
  ...
  { MultiExSpe_AllowedMultiAtts,
    ...
    { "L3V1 Multi V1.0.5 Section 3.15"
    }
  },
  ...
  { MultiLofOutBsts_AllowedAtts,
    ...
    { "L3V1 Multi V1.0.5 Section 3.15.2"
    }
  },
  ...
  { MultiLofSpeFtrs_AllowedCoreAtts,
    ...
    { "L3V1 Multi V1.0.5 Section 3.15.3"
    }
  },
  ...
  { MultiLofSpeFtrs_RelationAtt_Ref,
    ...
    { "L3V1 Multi V1.0.5 Section 3.16.3"
    }
  },
  ...
  { MultiOutBst_AllowedCoreAtts,
    ...
    { "L3V1 Multi V1.0.5 Section 3.16"
    }
  },
  ...
  { MultiOutBst_BdgStaAtt_Ref,
    ...
    { "L3V1 Multi V1.0.5 Section 3.16.1"
    }
  },
  ...
  { MultiSpeFtr_AllowedCoreElts,
    ...
    { "L3V1 Multi V1.0.5 Section 3.17"
    }
  },
  ...
  { MultiSpeFtr_OccAtt_Ref,
    ...
    { "L3V1 Multi V1.0.5 Section 3.17.3"
    }
  },
  ...
  { MultiSpeFtr_RestrictElts,
    ...
    { "L3V1 Multi V1.0.5 Section 3.17.5"
    }
  },
  ...
  { MultiIntSpeRec_AllowedAtts,
    ...
    { "L3V1 Multi V1.0.5 Section 3.20"
    }
  },
  ...
  { MultiLofSptCpoMapsInPro_NoEmpty,
    ...
    { "L3V1 Multi V1.0.5 Section 3.22.1"
    }
  },
  ...
  { MultiSptCpoMapInPro_AllowedCoreAtts,
    ...
    { "L3V1 Multi V1.0.5 Section 3.23"
    }
  },
  ...
  { MultiLofSpeFtrChgs_NoEmpty,
    ...
    "empty. ",
    { "L3V1 Multi V1.0.5 Section 3.23.4"
    }
  },
  ...
  { MultiSpeFtrChg_AllowedCoreAtts,
    ...
    { "L3V1 Multi V1.0.5 Section 3.24"
    }
  },
  ...
  { MultiMathCi_AllowedMultiAtts,
    ...
    { "L3V1 Multi V1.0.5 Section 3.26"
    }
  },
  ...
  { MultiMathCi_SpeRefAtt_Ref,
    ...
    { "L3V1 Multi V1.0.5 Section 3.26.1"
    }
  },
  ...
  { MultiMathCi_RepTypAtt_Ref,
    ...
    { "L3V1 Multi V1.0.5 Section 3.26.2"
    }
  },
