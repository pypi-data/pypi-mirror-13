...
htmlhelp_basename = 'bob_db_utfvp_doc'
...
man_pages = [
    ('index', 'bob', u'UTFVP Fingervein Database (Bob API) Documentation', [u'Idiap Research Institute'], 1)
]
