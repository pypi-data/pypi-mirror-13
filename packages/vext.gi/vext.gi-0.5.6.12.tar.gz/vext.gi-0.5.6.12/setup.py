...
class Install(install):
    def run(self):
        print("install -- pre_install")
        print("  >> pip install %s" % vext_version)
        call(["pip", "install", vext_version])
        self.do_egg_install()
        print("install -- run post_install")
        self.execute(_post_install, [self], msg="Install vext files:")

class InstallLib(install_lib):
    def run(self):
        print("install_lib -- pre_install")
        print("  >> pip install %s" % vext_version)
        call(["pip", "install", vext_version])
        install_lib.run(self)
        print("install lib -- run post_install")
        self.execute(_post_install, [self], msg="Install vext files:")
