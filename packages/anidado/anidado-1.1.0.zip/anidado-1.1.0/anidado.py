...
def print_lol(the_list,level):
        ...
        para validar la siguiente lista en caso de lo contrario imprime los ítems en pantalla, un segundo argunmento es requerido
        para dar un espacio (tabulador) a cada lista dependiedo de su nivel de anidación"""
