...
class Connection(object):
    ...
    def search(self, query='', date_start=None, date_finish=None, fields=None, size=0,
        ...
        :rtype: dict
        """
        data = self._shooju_api.search_series(query, date_start, date_finish, size,
    ...
    def register_job(self, description, notes="", batch_size=1, dry_run=False, reported_group=None, reported_at=None):
        """
        ...
        if not dry_run:
            data = self._shooju_api.register_job(description, notes, self.job_source, reported_group, reported_at)
            return RemoteJob(self, data['job_id'], batch_size=batch_size)
        else:
            return DryRunJob(self, None, batch_size=batch_size)
    ...
    def create_uploader_session(self):
        ...
        """
        data = self._shooju_api.create_uploader_session()
...
class ShoojuApi(object):
    ...
    def delete_series_by_query(self, query, force=False):
        ...
        return self.client.delete(self.API_SERIES_DELETE_BY_QUERY,
                                  data_json={'query': query, 'force': force})['deleted']
