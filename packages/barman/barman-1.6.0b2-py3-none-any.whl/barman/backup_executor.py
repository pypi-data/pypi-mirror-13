...
class BackupExecutor(RemoteStatusMixin, metaclass=ABCMeta):
    """
...
class SshBackupExecutor(BackupExecutor, metaclass=ABCMeta):
    """
...
class BackupStrategy(object, metaclass=ABCMeta):
    """
