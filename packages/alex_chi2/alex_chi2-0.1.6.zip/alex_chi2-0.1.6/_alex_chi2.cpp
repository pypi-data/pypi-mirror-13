...
static PyObject *alex_chi2_chi2(PyObject *self, PyObject *args);

static PyMethodDef module_methods[] = {
    {"chi2", alex_chi2_chi2, METH_VARARGS, chi2_docstring},
    {NULL, NULL, 0, NULL}
};

PyMODINIT_FUNC init_alex_chi2(void)
{
    PyObject *m = Py_InitModule3("_alex_chi2", module_methods, module_docstring);
    if (m == NULL)
        return;
