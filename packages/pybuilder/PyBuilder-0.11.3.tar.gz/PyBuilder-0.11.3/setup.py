...
''',
        author = "Alexander Metzner, Maximilien Riehl, Michael Gruber, Udo Juettner, Marcel Wolf, Arcadiy Ivanov",
        author_email = "alexander.metzner@gmail.com, max@riehl.io, aelgru@gmail.com, udo.juettner@gmail.com, marcel.wolf@me.com, arcadiy@ivanov.biz",
        ...
        entry_points = {'console_scripts': ['pyb_ = pybuilder.cli:main']},
        data_files = [],
        package_data = {},
        install_requires = [
            'pip>=7.0',
