...
from BatchlyApi.Models.Status import Status

class RunModel(object):

    """Implementation of the 'RunModel' model.
        ...
        Args:
            **kwargs: Keyword Arguments in order to initialise the
                ...
                that can be supplied and their types are as follows::
                    ...
                    Status -- Status -- Sets the attribute status
                    StartTime -- string -- Sets the attribute start_time
