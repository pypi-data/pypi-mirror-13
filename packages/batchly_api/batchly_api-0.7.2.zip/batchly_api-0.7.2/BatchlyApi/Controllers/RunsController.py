...
"""
   BatchlyApi.Controllers.RunsController
...
from BatchlyApi.Models.RunModel import RunModel
from BatchlyApi.Models.RunModel import RunModel
...
class RunsController(object):
    ...
    def list_runs(self):
        """Does a GET request to /api/Runs.

        TODO: type endpoint description here.

        Returns:
            list of RunModel: Response from the API. OK
    ...
    def get_describe_run(self,
                         id):
        """Does a GET request to /api/Runs/{id}.
        ...
        Returns:
            RunModel: Response from the API. OK
    ...
    def update_stop_run(self,
                        id):
        """Does a PUT request to /api/Runs/{id}.
    ...
    def delete_run(self,
                   id):
        """Does a DELETE request to /api/Runs/{id}.
