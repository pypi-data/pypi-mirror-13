...
"""
   BatchlyApi.Controllers.ProjectsController
...
class ProjectsController(object):
    ...
    def add_project(self,
        ...
        Args:
            request (CreateProjectRequest): TODO: type description here.

        Returns:
            ProjectModel: Response from the API. Created
        ...
        if isinstance(response.body, dict):
            ...
            try:
                return ProjectModel(**response.body)
            except TypeError:
                raise APIException("Invalid JSON returned", response.code, response.body)
    ...
    def get_describe_project(self,
                             id):
        """Does a GET request to /api/Projects/{id}.
        ...
        Returns:
            ProjectModel: Response from the API. OK
    ...
    def update_project(self,
                       id,
                       request):
        """Does a PUT request to /api/Projects/{id}.

        TODO: type endpoint description here.

        Args:
            id (string): TODO: type description here.
            request (UpdateProjectRequest): TODO: type description here.
        ...
        #append custom auth authorization
        CustomAuthUtility.appendCustomAuthParams(query_url, 'PUT', headers)

        # Prepare and invoke the API call request to fetch the response
        response = unirest.put(query_url, headers=headers,  params=APIHelper.json_serialize(request))
    ...
    def delete_project(self,
                       id):
        """Does a DELETE request to /api/Projects/{id}.
