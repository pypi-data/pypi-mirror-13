...
def _fetch_player(player_id, configuration):
    # TODO remove as soon as you can. Right now Riot uses different queue names for the leagues of the players and the matchlist
    game_queue = configuration['queue']
    if game_queue == Queue.RANKED_SOLO_5x5:
        game_queue = Queue.TEAM_BUILDER_DRAFT_RANKED_5x5.name
