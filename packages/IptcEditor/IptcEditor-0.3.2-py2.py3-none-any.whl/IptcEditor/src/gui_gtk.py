...
class NbLayout(Gtk.Window):
    ...
    def nb_page_2(self):
        ...
        old_tag_label.set_markup('<b>Keyphrase to replace</b>')
        old_tag_label.set_halign(Gtk.Align.START)
        new_tag_label.set_markup('<b>New keyphrase</b>')
        ...
        # # create buttons
        display_iptc_kw_button = Gtk.Button('Display Keyphrases')
        ...
        replace_button = Gtk.Button('Refresh Keyphrase(s)')
