...
class Standardizer(object):
    ...
    def parent(self, mol, tautomer=True, fragment=True, charge=True, isotope=True, stereo=True):
        """"""
        # TODO
        pass

    def enumerate(self, mol, resonance=True, tautomer=True, ringchain=True):
        """"""
        pass

    def canonicalize(self, mol, resonance=True, tautomer=True, ringchain=True):
        """"""
        # Allow pre-enumerated options to be passed in
        pass
...
# TODO: Move the following two functions to tautomer.py? (Removing the built-in standardization?)
