...
usb2600_wrapper = Extension("usb2600.wrapper",
		   ...
		   include_dirs = ['usb2600', '.', '..', numpy.get_include(),'/usr/lib64/python/site-packages/Cython/Includes', 'mcc-libhid', '/opt/mcc-libhid'],
...
setup(
    ...
    """,
    packages=find_packages(),#['mccdaq', 'mccdaq.usb2600'],
    package_dir={'mccdaq': '../mccdaq'},
    namespace_packages = ['mccdaq', 'mccdaq.usb2600'],
    cmdclass={'build_ext': build_ext},
    ext_modules = [usb2600_wrapper],
    #py_modules = ['mccdaq/usb2600/usb2600', 'mccdaq/waveform'],
    #py_modules = ['usb2600/usb2600', '__init__'], #, '/media/labdata/Brillouin/Python/utilities/waveform/waveform'],
    #data_files = ['usb2600/usb2600.pxd', 'usb2600/mccdaq-extra.h'],
        #requires=['waveform'],
    platforms=['linux'],
