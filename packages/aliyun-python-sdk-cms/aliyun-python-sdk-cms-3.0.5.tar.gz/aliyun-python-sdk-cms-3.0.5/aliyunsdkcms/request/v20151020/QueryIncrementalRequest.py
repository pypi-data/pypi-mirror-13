...
class QueryIncrementalRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Cms', '2015-10-20', 'QueryIncremental')
	...
	def get_TargetPeriod(self):
		return self.get_query_params().get('TargetPeriod')

	def set_TargetPeriod(self,TargetPeriod):
		self.add_query_param('TargetPeriod',TargetPeriod)
