/* =========================================================
 * ngkit-datepaginator based on bootstrap-datepaginator.js v1.1.0
 * =========================================================
...
;(function($, window, document, undefined) {
    ...
    DatePaginator.prototype = {
        ...
        _calendarSelect: function(event) {
            this._setSelectedDate(moment(event.target.value));
            this._render();
        },
        ...
        _render: function() {
            ...
            if (!this.initialized) {
                ...
                this.$rightNav = $(this._template.navItem)
                    ...
                    .addClass(this.options.squareEdges ? 'dp-nav-square-edges' : '')
                    .append($(this._template.icon)
                        .addClass('ng-icon-chevron-right')
                        .addClass('dp-nav-right'))
                    .width(this.options.navItemWidth);
            ...
            if (this.$calendar) {
                NGkit.datepicker(
                    ...
                    .on('change', $.proxy(this._calendarSelect, this));
        ...
        _template: {
            ...
            icon: '<i class="ng-icon"></i>',
            calendar: '<i id="dp-calendar" class="ng-icon-calendar"></i>'
        },
