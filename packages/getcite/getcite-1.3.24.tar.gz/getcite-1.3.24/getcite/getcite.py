...
#
#   BUGS
#       If you get the history for a U.S.C. statute, sometimes there are multiple
#       options in Westlaw. getcite can't handle this, it expects to go straight
#       to the statute. Add a try, and if there are two, click one of them
#
#
#
...
"""
def merge(number_of_files_to_merge):
    # Merges the number_of_files_to_merge most recently downloaded files 
    # in the Source folder.
    #
    # for now, use will need to put most recently downloaded file (ToC)
    # into the Source folder automatically

    # make sure the user specified at least two files
    if number_of_files_to_merge < 2:
        print("Merge requires at least two files.")
        return

    print("Merging the %s most recently merged files")
