...
try: # python 2 and 3 compatibility
  import Tkinter			# python 2 Tk interface
except:
  import tkinter as Tkinter		# python 3 Tk interface
...
def init(core):
  ...
  # get toolkit version
  core['avccd'].toolkit_version = Tkinter.TkVersion
