...
<div id="addShowPortal">
    <a href="${srRoot}/home/addShows/newShow/" id="btnNewShow" class="btn btn-large">
        ...
        <div class="buttontext">
            <h3>Add New Show</h3>
            <p>For shows that you haven't downloaded yet, this option finds a show on theTVDB.com, creates a directory for it's episodes, and adds it to sickrage.srCore.CONFIG.</p>
        </div>
    </a>

    <br><br>
    % if sickrage.srCore.CONFIG.USE_TRAKT == True:
    <a href="${srRoot}/home/addShows/trendingShows/" id="btnNewShow" class="btn btn-large">
        ...
        <div class="buttontext">
            ...
            <p>For shows that you haven't downloaded yet, this option lets you choose from a list of current trending shows with ratings to add, creates a directory for its episodes, and adds it to sickrage.srCore.CONFIG.</p>
        </div>
    </a>
    ...
    <a href="${srRoot}/home/addShows/recommendedShows/" id="btnNewShow" class="btn btn-large">
        ...
        <div class="buttontext">
            ...
            <p>For shows that you haven't downloaded yet, this option recommends shows to add based on your Trakt.tv show library, creates a directory for its episodes, and adds it to sickrage.srCore.CONFIG.</p>
        </div>
    </a>
