$(document).ready(function(){
    if (isMeta('sickrage.COMING_EPS_LAYOUT', ['list'])) {
        var sortCodes = {'date': 0, 'show': 2, 'network': 5};
        var sort = getMeta('sickrage.COMING_EPS_SORT');
        ...
        $('#showListTable:has(tbody tr)').tablesorter({
            ...
            widgetOptions: (function() {
                if (metaToBool('sickrage.FILTER_ROW')) {
                    return {
    ...
    if (isMeta('sickrage.COMING_EPS_LAYOUT', ['banner', 'poster'])) {
