    ...
    def run(self):
        ...
        try:
            ...
            sickrage.srCore.LOGGER.info(
                "Setting all current episodes to the specified default status: " + str(self.show.default_ep_status))
        ...
        sickrage.srCore.LOGGER.info(
            "Setting all future episodes to the specified default status: " + str(self.show.default_ep_status))
