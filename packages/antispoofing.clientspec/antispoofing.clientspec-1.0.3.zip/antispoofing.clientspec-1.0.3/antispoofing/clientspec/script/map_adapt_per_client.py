  ...
  if data_read == True:
    ...
    for featname, featdir in dir_assoc.items():
      ...
      for client in database.get_clients(args.group):
        ...
        trainer = bob.learn.em.MAP_GMMTrainer(gmm, relevance_factor=relevance_factor, update_means=True, update_variances=False, update_weights=False) #trainer = bob.trainer.MAP_GMMTrainer(relevance_factor, True, False, False)
