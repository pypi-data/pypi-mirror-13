...
File version 0.2 date 2016-02-24
...
version = 'StruthonConcretePanel ver.0.1.1'
...
def checkStatus():
    ...
    #----Raport buttons
    #----Calculate buttons
    myapp.ui.pushButton_calculate.setEnabled(isLoadData) 
    #----
...
def status_text():
    ...
    text += 'for mx:  ' + array_range_text(load.moment_mx, load.moment_unit) + '\n'  
    text += 'for my:  ' + array_range_text(load.moment_my, load.moment_unit) + '\n'    
    text += 'for nx:  ' + array_range_text(load.force_nx, load.force_unit) + '\n'  
    text += 'for ny:  ' + array_range_text(load.force_ny, load.force_unit) + '\n'
    return text
