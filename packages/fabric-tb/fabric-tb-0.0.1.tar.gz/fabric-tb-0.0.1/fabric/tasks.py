...
def _execute(task, host, my_env, args, kwargs, jobs, queue, multiprocessing):
    ...
    # Inventory host
    i_host_vars = state.env.inventory.get_host(local_env['host_string']).get_variables()
    from fabric.utils import _AttributeDict
    local_env['inventory_host'] = _AttributeDict(i_host_vars)
