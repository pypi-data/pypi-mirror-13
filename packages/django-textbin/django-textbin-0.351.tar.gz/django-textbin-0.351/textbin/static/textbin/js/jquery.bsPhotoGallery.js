  ...
  $.fn.bsPhotoGallery = function(options) {
      ...
      function showModal(){
          ...
          if ( window.gettext != undefined ) {
              var label_next = window.gettext('next');
              var label_prev = window.gettext('prev');
          }
          else {
              var label_next = 'next';
              var label_prev = 'prev';
          ...
          html += '<a class="controls next" data-bsp-id="'+clicked.ulId+'" href="'+ (clicked.nextImg) + '">'+label_next+' <i class="glyphicon glyphicon-chevron-right"></i></a>';
          html += '<a class="controls previous" data-bsp-id="'+clicked.ulId+'" href="' + (clicked.prevImg) + '"><i class="glyphicon glyphicon-chevron-left"></i> '+label_prev+'</a>';
          html += '</div>';
