    ...
    def form_valid(self, form):
        ...
        if is_form_filled \
            ...
            if not is_form_filled:
                context['error_no_content'] = \
                    "Введите текст сообщения и/или прикрепите ссылки"
