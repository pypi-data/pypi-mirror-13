...
class ApiTextCreate(APITestCase):
    ...
    def test_api_json_post(self):
        ...
        """
        url = "http://127.0.0.1:8000" + reverse("text_api_create")
        values = {"media": [r"https://upload.wikimedia.org/wikipedia/commons/9/92/Zenit-B_Helios-44-2_2012_G1.jpg",
